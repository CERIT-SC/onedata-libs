...
from onezone_client.api.share_api import ShareApi  # noqa: E501
...
class TestShareApi(unittest.TestCase):
    ...
    def test_get_public_share_details(self):
        """Test case for get_public_share_details
