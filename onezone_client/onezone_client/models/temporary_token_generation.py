...
class TemporaryTokenGeneration(object):
    ...
    def __init__(self, generation=None):  # noqa: E501
        """TemporaryTokenGeneration - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def generation(self):
        """Gets the generation of this TemporaryTokenGeneration.  # noqa: E501

        Current temporary token generation  # noqa: E501

        :return: The generation of this TemporaryTokenGeneration.  # noqa: E501
        :rtype: int
        """
    ...
    def generation(self, generation):
        """Sets the generation of this TemporaryTokenGeneration.

        Current temporary token generation  # noqa: E501

        :param generation: The generation of this TemporaryTokenGeneration.  # noqa: E501
        :type: int
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TemporaryTokenGeneration, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TemporaryTokenGeneration):
            return False
