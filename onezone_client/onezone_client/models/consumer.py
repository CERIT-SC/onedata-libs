...
class Consumer(Caveat):
    ...
    @property
    def type(self):
        """Gets the type of this Consumer.  # noqa: E501
        ...
        :return: The type of this Consumer.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this Consumer.

        Consumer caveat - limits the consumers that can use the token. [Consumer](https://onedata.org/#/home/documentation/doc/using_onedata/tokens[consumer].html) is the token bearer that utilizes the token - performs a request with an access token or attempts to consume an invite token. If the caveat is present, the consumer must prove their identity by sending their [identity token](https://onedata.org/#/home/documentation/doc/using_onedata/tokens[identity-tokens].html) in the `x-onedata-consumer-token header` along with the request. The consumers must be encoded using proper [consumer format](https://onedata.org/#/home/documentation/doc/using_onedata/tokens[consumer].html).  You can learn more about token caveats [here](https://onedata.org/#/home/documentation/doc/using_onedata/tokens[token-caveats].html).   # noqa: E501

        :param type: The type of this Consumer.  # noqa: E501
        :type: str
        """
    ...
    @property
    def whitelist(self):
        """Gets the whitelist of this Consumer.  # noqa: E501

        List of consumers that are allowed to utilize the token.  Example: ```json   {     \"type\": \"consumer\",     \"whitelist\": [       \"usr-d4f5876dbe7f1e7e8a511de6dd31144c\",       \"grp-0921135ee61fe53a3df449365228e9b4\",       \"prv-*\"     ]   } ```   # noqa: E501

        :return: The whitelist of this Consumer.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def whitelist(self, whitelist):
        """Sets the whitelist of this Consumer.

        List of consumers that are allowed to utilize the token.  Example: ```json   {     \"type\": \"consumer\",     \"whitelist\": [       \"usr-d4f5876dbe7f1e7e8a511de6dd31144c\",       \"grp-0921135ee61fe53a3df449365228e9b4\",       \"prv-*\"     ]   } ```   # noqa: E501

        :param whitelist: The whitelist of this Consumer.  # noqa: E501
        :type: list[str]
        """
