...
class Asn(Caveat):
    ...
    @property
    def whitelist(self):
        """Gets the whitelist of this Asn.  # noqa: E501

        List of ASNs from which the token can be utilized.  Example: ```json   {     \"type\": \"asn\",     \"whitelist\": [       631, 632, 1671     ]   } ```   # noqa: E501

        :return: The whitelist of this Asn.  # noqa: E501
        :rtype: list[int]
        """
    ...
    def whitelist(self, whitelist):
        """Sets the whitelist of this Asn.

        List of ASNs from which the token can be utilized.  Example: ```json   {     \"type\": \"asn\",     \"whitelist\": [       631, 632, 1671     ]   } ```   # noqa: E501

        :param whitelist: The whitelist of this Asn.  # noqa: E501
        :type: list[int]
        """
