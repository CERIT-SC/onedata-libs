...
class GroupCreateRequest(object):
    ...
    def __init__(self, name=None, type=None):  # noqa: E501
        """GroupCreateRequest - a model defined in Swagger"""  # noqa: E501
        self._name = None
        self._type = None
    ...
    @property
    def name(self):
        """Gets the name of this GroupCreateRequest.  # noqa: E501

        The name of the group.  # noqa: E501

        :return: The name of this GroupCreateRequest.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        ...
        :param name: The name of this GroupCreateRequest.  # noqa: E501
        :type: str
        """
        if name is None:
    ...
    @property
    def type(self):
        """Gets the type of this GroupCreateRequest.  # noqa: E501

        The type of the group. If not specified, `team` is assumed.  # noqa: E501

        :return: The type of this GroupCreateRequest.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this GroupCreateRequest.

        The type of the group. If not specified, `team` is assumed.  # noqa: E501

        :param type: The type of this GroupCreateRequest.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(GroupCreateRequest, dict):
