...
class Handles(object):
    ...
    def __init__(self, handles=None):  # noqa: E501
        """Handles - a model defined in Swagger"""  # noqa: E501
        self._handles = None
    ...
    @property
    def handles(self):
        """Gets the handles of this Handles.  # noqa: E501

        The list of handle Ids.  # noqa: E501

        :return: The handles of this Handles.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def handles(self, handles):
        """Sets the handles of this Handles.

        The list of handle Ids.  # noqa: E501

        :param handles: The handles of this Handles.  # noqa: E501
        :type: list[str]
        """
        if handles is None:
            raise ValueError("Invalid value for `handles`, must not be `None`")  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, Handles):
            return False
