...
class Api(Caveat):
    ...
    @property
    def whitelist(self):
        """Gets the whitelist of this Api.  # noqa: E501

        List of API matchspecs that narrow down allowed API calls.  Example: ```json   {     \"type\": \"api\",     \"whitelist\": [       \"ozw/all/user.*.*:*\",       \"all/get/space.*.*:*\"     ]   } ```   # noqa: E501

        :return: The whitelist of this Api.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def whitelist(self, whitelist):
        """Sets the whitelist of this Api.

        List of API matchspecs that narrow down allowed API calls.  Example: ```json   {     \"type\": \"api\",     \"whitelist\": [       \"ozw/all/user.*.*:*\",       \"all/get/space.*.*:*\"     ]   } ```   # noqa: E501

        :param whitelist: The whitelist of this Api.  # noqa: E501
        :type: list[str]
        """
