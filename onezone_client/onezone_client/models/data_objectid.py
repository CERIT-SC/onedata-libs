...
class DataObjectid(Caveat):
    ...
    def __init__(self, type=None, whitelist=None, *args, **kwargs):  # noqa: E501
        """DataObjectid - a model defined in Swagger"""  # noqa: E501
        self._type = None
    ...
    @property
    def type(self):
        """Gets the type of this DataObjectid.  # noqa: E501
        ...
        :return: The type of this DataObjectid.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this DataObjectid.

        Data objectid caveat - limits the object ids in which data can be accessed with the token. The object ids comply with the CDMI format and can be used in the Oneprovider's REST and CDMI APIs. If a directory object id is given, the token allows to access all nested files and directories starting from the specified directory.  This is a **data access caveat** - if added to a token, it greatly limits its power in the system APIs, to the minimum required for data access - [see more](https://onedata.org/#/home/documentation/doc/using_onedata/tokens[data-access-caveats].html).  You can learn more about token caveats [here](https://onedata.org/#/home/documentation/doc/using_onedata/tokens[token-caveats].html).   # noqa: E501

        :param type: The type of this DataObjectid.  # noqa: E501
        :type: str
        """
        allowed_values = ["data.objectid"]  # noqa: E501
    ...
    @property
    def whitelist(self):
        """Gets the whitelist of this DataObjectid.  # noqa: E501

        List of CDMI ObjectIds in which data can be accessed using the token.  Example: ```json   {     \"type\": \"data.objectid\",     \"whitelist\": [       \"000000000055D4E4836803640004677569646D000000167\",       \"39592D594E736C676D0000002B43592D347247454C535F6\"     ]   } ```   # noqa: E501

        :return: The whitelist of this DataObjectid.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def whitelist(self, whitelist):
        """Sets the whitelist of this DataObjectid.

        List of CDMI ObjectIds in which data can be accessed using the token.  Example: ```json   {     \"type\": \"data.objectid\",     \"whitelist\": [       \"000000000055D4E4836803640004677569646D000000167\",       \"39592D594E736C676D0000002B43592D347247454C535F6\"     ]   } ```   # noqa: E501

        :param whitelist: The whitelist of this DataObjectid.  # noqa: E501
        :type: list[str]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DataObjectid, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DataObjectid):
            return False
