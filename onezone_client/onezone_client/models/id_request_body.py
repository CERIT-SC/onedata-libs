...
class IdRequestBody(object):
    ...
    def __init__(self, contact_email=None, message=None):  # noqa: E501
        """IdRequestBody - a model defined in Swagger"""  # noqa: E501
    ...
    def contact_email(self):
        """Gets the contact_email of this IdRequestBody.  # noqa: E501

        Requester email address, which will be passed to the space maintainer for the purpose of processing the request and used for notifying about their decision. By providing the address, the user agrees to the above.   # noqa: E501

        :return: The contact_email of this IdRequestBody.  # noqa: E501
        :rtype: str
        """
    ...
    def contact_email(self, contact_email):
        """Sets the contact_email of this IdRequestBody.

        Requester email address, which will be passed to the space maintainer for the purpose of processing the request and used for notifying about their decision. By providing the address, the user agrees to the above.   # noqa: E501

        :param contact_email: The contact_email of this IdRequestBody.  # noqa: E501
        :type: str
        """
    ...
    @property
    def message(self):
        """Gets the message of this IdRequestBody.  # noqa: E501

        A message to the maintainer stating user's motivation to join the space and/or any information that may help in making the decision.   # noqa: E501

        :return: The message of this IdRequestBody.  # noqa: E501
        :rtype: str
        """
    ...
    def message(self, message):
        """Sets the message of this IdRequestBody.

        A message to the maintainer stating user's motivation to join the space and/or any information that may help in making the decision.   # noqa: E501

        :param message: The message of this IdRequestBody.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(IdRequestBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, IdRequestBody):
            return False
