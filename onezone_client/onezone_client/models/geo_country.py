...
import six
from onezone_client.models.caveat import Caveat  # noqa: F401,E501

class GeoCountry(Caveat):
    ...
    if hasattr(Caveat, "swagger_types"):
        swagger_types.update(Caveat.swagger_types)
    ...
    if hasattr(Caveat, "attribute_map"):
        attribute_map.update(Caveat.attribute_map)

    def __init__(self, type=None, filter=None, list=None, *args, **kwargs):  # noqa: E501
        """GeoCountry - a model defined in Swagger"""  # noqa: E501
        self._type = None
        self._filter = None
        self._list = None
        ...
        if list is not None:
            self.list = list
        Caveat.__init__(self, *args, **kwargs)

    @property
    def type(self):
        """Gets the type of this GeoCountry.  # noqa: E501

        GEO Country caveat - limits the countries from which the token can be utilized. The client's country is resolved based on client's IP and MaxMind's GeoLite database.  You can learn more about token caveats [here](https://onedata.org/#/home/documentation/doc/using_onedata/tokens[token-caveats].html).   # noqa: E501

        :return: The type of this GeoCountry.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this GeoCountry.

        GEO Country caveat - limits the countries from which the token can be utilized. The client's country is resolved based on client's IP and MaxMind's GeoLite database.  You can learn more about token caveats [here](https://onedata.org/#/home/documentation/doc/using_onedata/tokens[token-caveats].html).   # noqa: E501

        :param type: The type of this GeoCountry.  # noqa: E501
        :type: str
        """
        allowed_values = ["geo.country"]  # noqa: E501
    ...
    @property
    def filter(self):
        """Gets the filter of this GeoCountry.  # noqa: E501

        Filter type to be applied: * whitelist limits allowed countries to the ones on the list only * blacklist limits allowed countries to any region that is not on the list   # noqa: E501

        :return: The filter of this GeoCountry.  # noqa: E501
        :rtype: str
        """
        return self._filter
    ...
    def filter(self, filter):
        """Sets the filter of this GeoCountry.

        Filter type to be applied: * whitelist limits allowed countries to the ones on the list only * blacklist limits allowed countries to any region that is not on the list   # noqa: E501

        :param filter: The filter of this GeoCountry.  # noqa: E501
        :type: str
        """
    ...
    @property
    def list(self):
        """Gets the list of this GeoCountry.  # noqa: E501

        List of countries (ISO3166 2 letter codes) from which the token can be utilized.  Example: ```json   {     \"type\": \"geo.country\",     \"filter\": \"whitelist\",     \"list\": [       \"PL\", \"UK\", \"DE\", \"NL\"     ]   } ```   # noqa: E501

        :return: The list of this GeoCountry.  # noqa: E501
        :rtype: list[str]
        """
        return self._list
    ...
    @list.setter
    def list(self, list):
        """Sets the list of this GeoCountry.

        List of countries (ISO3166 2 letter codes) from which the token can be utilized.  Example: ```json   {     \"type\": \"geo.country\",     \"filter\": \"whitelist\",     \"list\": [       \"PL\", \"UK\", \"DE\", \"NL\"     ]   } ```   # noqa: E501

        :param list: The list of this GeoCountry.  # noqa: E501
        :type: list[str]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GeoCountry):
            return False
