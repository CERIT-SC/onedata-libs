...
class Interface(Caveat):
    ...
    def __init__(self, type=None, interface=None, *args, **kwargs):  # noqa: E501
    ...
    def type(self, type):
        ...
        :type: str
        """
        allowed_values = ["interface"]  # noqa: E501
    ...
    @property
    def interface(self):
        """Gets the interface of this Interface.  # noqa: E501

        The interface on which this token will be exclusively accepted.  Example: ```json   {     \"type\": \"interface\",     \"interface\": \"rest\"   } ```   # noqa: E501
