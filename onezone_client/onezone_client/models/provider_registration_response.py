...
class ProviderRegistrationResponse(object):
    ...
    swagger_types = {
        'provider_id': 'str',
        'provider_root_token': 'str',
        'admin_user_id': 'str'
    }

    attribute_map = {
        'provider_id': 'providerId',
        'provider_root_token': 'providerRootToken',
        'admin_user_id': 'adminUserId'
    }

    def __init__(self, provider_id=None, provider_root_token=None, admin_user_id=None):  # noqa: E501
        """ProviderRegistrationResponse - a model defined in Swagger"""  # noqa: E501
        self._provider_id = None
        self._provider_root_token = None
        self._admin_user_id = None
        self.discriminator = None
        if provider_id is not None:
            self.provider_id = provider_id
        if provider_root_token is not None:
            self.provider_root_token = provider_root_token
        if admin_user_id is not None:
            self.admin_user_id = admin_user_id

    @property
    def provider_id(self):
        """Gets the provider_id of this ProviderRegistrationResponse.  # noqa: E501

        The Id of the newly registered provider.  # noqa: E501

        :return: The provider_id of this ProviderRegistrationResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def provider_id(self, provider_id):
        """Sets the provider_id of this ProviderRegistrationResponse.

        The Id of the newly registered provider.  # noqa: E501

        :param provider_id: The provider_id of this ProviderRegistrationResponse.  # noqa: E501
        :type: str
        """
    ...
    @property
    def provider_root_token(self):
        """Gets the provider_root_token of this ProviderRegistrationResponse.  # noqa: E501

        The Oneprovider root token - bearing its identity and full authorization.  # noqa: E501

        :return: The provider_root_token of this ProviderRegistrationResponse.  # noqa: E501
        :rtype: str
        """
        return self._provider_root_token

    @provider_root_token.setter
    def provider_root_token(self, provider_root_token):
        """Sets the provider_root_token of this ProviderRegistrationResponse.

        The Oneprovider root token - bearing its identity and full authorization.  # noqa: E501

        :param provider_root_token: The provider_root_token of this ProviderRegistrationResponse.  # noqa: E501
        :type: str
        """

        self._provider_root_token = provider_root_token

    @property
    def admin_user_id(self):
        """Gets the admin_user_id of this ProviderRegistrationResponse.  # noqa: E501

        The Id of the Onezone user that is linked to the Oneprovider panel admin account.  # noqa: E501

        :return: The admin_user_id of this ProviderRegistrationResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def admin_user_id(self, admin_user_id):
        """Sets the admin_user_id of this ProviderRegistrationResponse.

        The Id of the Onezone user that is linked to the Oneprovider panel admin account.  # noqa: E501

        :param admin_user_id: The admin_user_id of this ProviderRegistrationResponse.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ProviderRegistrationResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ProviderRegistrationResponse):
            return False
