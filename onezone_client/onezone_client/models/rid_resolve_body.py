...
class RidResolveBody(object):
    ...
    def __init__(self, decision=None):  # noqa: E501
        """RidResolveBody - a model defined in Swagger"""  # noqa: E501
        self._decision = None
    ...
    @property
    def decision(self):
        """Gets the decision of this RidResolveBody.  # noqa: E501

        Decision whether to grant or reject request.  # noqa: E501

        :return: The decision of this RidResolveBody.  # noqa: E501
        :rtype: str
        """
    ...
    def decision(self, decision):
        """Sets the decision of this RidResolveBody.

        Decision whether to grant or reject request.  # noqa: E501

        :param decision: The decision of this RidResolveBody.  # noqa: E501
        :type: str
        """
        if decision is None:
            raise ValueError("Invalid value for `decision`, must not be `None`")  # noqa: E501
        allowed_values = ["grant", "reject"]  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(RidResolveBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RidResolveBody):
            return False
