...
class HarvesterIndex(object):
    ...
    def __init__(self, index_id=None, name=None, schema=None, gui_plugin_name=None, include_metadata=None, include_file_details=None, include_rejection_reason=None, retry_on_rejection=None):  # noqa: E501
        """HarvesterIndex - a model defined in Swagger"""  # noqa: E501
        self._index_id = None
        self._name = None
        self._schema = None
    ...
    @property
    def index_id(self):
        """Gets the index_id of this HarvesterIndex.  # noqa: E501

        Unique Id of the index.  # noqa: E501

        :return: The index_id of this HarvesterIndex.  # noqa: E501
        :rtype: str
        """
    ...
    def index_id(self, index_id):
        """Sets the index_id of this HarvesterIndex.

        Unique Id of the index.  # noqa: E501

        :param index_id: The index_id of this HarvesterIndex.  # noqa: E501
        :type: str
        """
        if index_id is None:
    ...
    @property
    def name(self):
        """Gets the name of this HarvesterIndex.  # noqa: E501

        The name of the index.  # noqa: E501

        :return: The name of this HarvesterIndex.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this HarvesterIndex.

        The name of the index.  # noqa: E501

        :param name: The name of this HarvesterIndex.  # noqa: E501
        :type: str
        """
        if name is None:
    ...
    @property
    def schema(self):
        """Gets the schema of this HarvesterIndex.  # noqa: E501

        Schema of the index provided as string (e.g. encoded JSON).  # noqa: E501

        :return: The schema of this HarvesterIndex.  # noqa: E501
        :rtype: str
        """
        return self._schema
    ...
    def schema(self, schema):
        """Sets the schema of this HarvesterIndex.

        Schema of the index provided as string (e.g. encoded JSON).  # noqa: E501

        :param schema: The schema of this HarvesterIndex.  # noqa: E501
        :type: str
        """
        if schema is None:
    ...
    def gui_plugin_name(self):
        """Gets the gui_plugin_name of this HarvesterIndex.  # noqa: E501
        ...
        :return: The gui_plugin_name of this HarvesterIndex.  # noqa: E501
        :rtype: str
        """
    ...
    def gui_plugin_name(self, gui_plugin_name):
        """Sets the gui_plugin_name of this HarvesterIndex.

        Mapping of index name to one recognized by gui plugin. Allows to specify this index to be used by GUI plugin to produce search results. Recognized gui index names are listed in gui plugin manifest.  # noqa: E501

        :param gui_plugin_name: The gui_plugin_name of this HarvesterIndex.  # noqa: E501
        :type: str
        """
        if gui_plugin_name is None:
            raise ValueError("Invalid value for `gui_plugin_name`, must not be `None`")  # noqa: E501

        self._gui_plugin_name = gui_plugin_name

    @property
    def include_metadata(self):
        """Gets the include_metadata of this HarvesterIndex.  # noqa: E501

        Specifies what types of file metadata should be harvested in this index. At least one type must be given.  # noqa: E501

        :return: The include_metadata of this HarvesterIndex.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def include_metadata(self, include_metadata):
        """Sets the include_metadata of this HarvesterIndex.

        Specifies what types of file metadata should be harvested in this index. At least one type must be given.  # noqa: E501

        :param include_metadata: The include_metadata of this HarvesterIndex.  # noqa: E501
        :type: list[str]
        """
        if include_metadata is None:
            raise ValueError("Invalid value for `include_metadata`, must not be `None`")  # noqa: E501
    ...
    def include_file_details(self):
        """Gets the include_file_details of this HarvesterIndex.  # noqa: E501
        ...
        :return: The include_file_details of this HarvesterIndex.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def include_file_details(self, include_file_details):
        """Sets the include_file_details of this HarvesterIndex.

        Specifies what file details should be harvested alongside the metadata. Enabling `metadataExistenceFlags` will add boolean flags saying whether the file has any metadata of certain type. The `fileName` field may be utilized by the GUI plugin to improve the browsing experience.  # noqa: E501

        :param include_file_details: The include_file_details of this HarvesterIndex.  # noqa: E501
        :type: list[str]
        """
        if include_file_details is None:
            raise ValueError("Invalid value for `include_file_details`, must not be `None`")  # noqa: E501
    ...
    def include_rejection_reason(self):
        """Gets the include_rejection_reason of this HarvesterIndex.  # noqa: E501
        ...
        :return: The include_rejection_reason of this HarvesterIndex.  # noqa: E501
        :rtype: bool
        """
    ...
    def include_rejection_reason(self, include_rejection_reason):
        """Sets the include_rejection_reason of this HarvesterIndex.

        If enabled, all harvesting errors (e.g. when the index rejects a payload due to non-matching schema) are stored as text in the index, which may be useful for later analysis.  # noqa: E501

        :param include_rejection_reason: The include_rejection_reason of this HarvesterIndex.  # noqa: E501
        :type: bool
        """
        if include_rejection_reason is None:
            raise ValueError("Invalid value for `include_rejection_reason`, must not be `None`")  # noqa: E501

        self._include_rejection_reason = include_rejection_reason

    @property
    def retry_on_rejection(self):
        """Gets the retry_on_rejection of this HarvesterIndex.  # noqa: E501
        ...
        :return: The retry_on_rejection of this HarvesterIndex.  # noqa: E501
        :rtype: bool
        """
    ...
    def retry_on_rejection(self, retry_on_rejection):
        """Sets the retry_on_rejection of this HarvesterIndex.

        If enabled, all payloads rejected by the harvesting backend will be automatically analysed for offending data (e.g. fields that do not match the schema), pruned and submitted again. This might slow down the harvesting process and cause nonconformant metadata to be lost.  # noqa: E501

        :param retry_on_rejection: The retry_on_rejection of this HarvesterIndex.  # noqa: E501
        :type: bool
        """
        if retry_on_rejection is None:
            raise ValueError("Invalid value for `retry_on_rejection`, must not be `None`")  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(HarvesterIndex, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, HarvesterIndex):
            return False
