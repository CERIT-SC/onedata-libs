...
class ClusterUpdateRequest(object):
    ...
    def proxy(self, proxy):
        """Sets the proxy of this ClusterUpdateRequest.

        Is onepanel proxy enabled - if so, onepanel GUI is served on cluster's domain at port 443 (rather than 9443).   # noqa: E501

        :param proxy: The proxy of this ClusterUpdateRequest.  # noqa: E501
        :type: bool
        """
