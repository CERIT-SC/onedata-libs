...
class HandleServiceProperties(object):
    ...
    discriminator_value_class_map = {
          'PIDServiceProperties': 'PIDServiceProperties',
'DOIServiceProperties': 'DOIServiceProperties'    }

    def __init__(self, type=None):  # noqa: E501
        """HandleServiceProperties - a model defined in Swagger"""  # noqa: E501
        self._type = None
    ...
    @property
    def type(self):
        """Gets the type of this HandleServiceProperties.  # noqa: E501

        The type of handle service.  # noqa: E501

        :return: The type of this HandleServiceProperties.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this HandleServiceProperties.

        The type of handle service.  # noqa: E501

        :param type: The type of this HandleServiceProperties.  # noqa: E501
        :type: str
        """
        if type is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(HandleServiceProperties, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, HandleServiceProperties):
            return False
