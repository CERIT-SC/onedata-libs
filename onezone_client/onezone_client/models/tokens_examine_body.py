...
class TokensExamineBody(object):
    ...
    def __init__(self, token=None):  # noqa: E501
        """TokensExamineBody - a model defined in Swagger"""  # noqa: E501
        self._token = None
    ...
    @property
    def token(self):
        """Gets the token of this TokensExamineBody.  # noqa: E501


        :return: The token of this TokensExamineBody.  # noqa: E501
    ...
    def token(self, token):
        """Sets the token of this TokensExamineBody.


        :param token: The token of this TokensExamineBody.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TokensExamineBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TokensExamineBody):
            return False
