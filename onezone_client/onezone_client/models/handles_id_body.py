...
class HandlesIdBody(object):
    ...
    def __init__(self, metadata=None):  # noqa: E501
        """HandlesIdBody - a model defined in Swagger"""  # noqa: E501
        self._metadata = None
    ...
    @property
    def metadata(self):
        """Gets the metadata of this HandlesIdBody.  # noqa: E501

        Dublin Core metadata in XML for the handle.  # noqa: E501

        :return: The metadata of this HandlesIdBody.  # noqa: E501
        :rtype: str
        """
    ...
    def metadata(self, metadata):
        """Sets the metadata of this HandlesIdBody.

        Dublin Core metadata in XML for the handle.  # noqa: E501

        :param metadata: The metadata of this HandlesIdBody.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(HandlesIdBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, HandlesIdBody):
            return False
