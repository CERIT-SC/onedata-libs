...
class ClientTokens(object):
    ...
    def __init__(self, tokens=None):  # noqa: E501
        """ClientTokens - a model defined in Swagger"""  # noqa: E501
        self._tokens = None
    ...
    @property
    def tokens(self):
        """Gets the tokens of this ClientTokens.  # noqa: E501

        The list of client tokens.  # noqa: E501

        :return: The tokens of this ClientTokens.  # noqa: E501
        :rtype: list[str]
        """
        return self._tokens
    ...
    def tokens(self, tokens):
        """Sets the tokens of this ClientTokens.

        The list of client tokens.  # noqa: E501

        :param tokens: The tokens of this ClientTokens.  # noqa: E501
        :type: list[str]
        """
        if tokens is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ClientTokens, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ClientTokens):
            return False
