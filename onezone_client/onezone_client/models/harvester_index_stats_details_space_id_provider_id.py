...
class HarvesterIndexStatsDetailsSpaceIdProviderId(object):
    ...
    def __init__(self, current_seq=None, max_seq=None, error=None, last_update=None, archival=None):  # noqa: E501
        """HarvesterIndexStatsDetailsSpaceIdProviderId - a model defined in Swagger"""  # noqa: E501
    ...
    def current_seq(self):
        """Gets the current_seq of this HarvesterIndexStatsDetailsSpaceIdProviderId.  # noqa: E501

        Highest sequence number in given space in given provider already harvested in this index  # noqa: E501

        :return: The current_seq of this HarvesterIndexStatsDetailsSpaceIdProviderId.  # noqa: E501
        :rtype: int
        """
        return self._current_seq

    @current_seq.setter
    def current_seq(self, current_seq):
        """Sets the current_seq of this HarvesterIndexStatsDetailsSpaceIdProviderId.

        Highest sequence number in given space in given provider already harvested in this index  # noqa: E501

        :param current_seq: The current_seq of this HarvesterIndexStatsDetailsSpaceIdProviderId.  # noqa: E501
        :type: int
        """
    ...
    @property
    def max_seq(self):
        """Gets the max_seq of this HarvesterIndexStatsDetailsSpaceIdProviderId.  # noqa: E501

        Highest known sequence in given space in given provider  # noqa: E501

        :return: The max_seq of this HarvesterIndexStatsDetailsSpaceIdProviderId.  # noqa: E501
        :rtype: int
        """
        return self._max_seq

    @max_seq.setter
    def max_seq(self, max_seq):
        """Sets the max_seq of this HarvesterIndexStatsDetailsSpaceIdProviderId.

        Highest known sequence in given space in given provider  # noqa: E501

        :param max_seq: The max_seq of this HarvesterIndexStatsDetailsSpaceIdProviderId.  # noqa: E501
        :type: int
        """
        if max_seq is None:
            raise ValueError("Invalid value for `max_seq`, must not be `None`")  # noqa: E501

        self._max_seq = max_seq

    @property
    def error(self):
        """Gets the error of this HarvesterIndexStatsDetailsSpaceIdProviderId.  # noqa: E501

        Short description of encountered error if last harvesting failed  # noqa: E501

        :return: The error of this HarvesterIndexStatsDetailsSpaceIdProviderId.  # noqa: E501
        :rtype: str
        """
        return self._error
    ...
    def error(self, error):
        """Sets the error of this HarvesterIndexStatsDetailsSpaceIdProviderId.

        Short description of encountered error if last harvesting failed  # noqa: E501

        :param error: The error of this HarvesterIndexStatsDetailsSpaceIdProviderId.  # noqa: E501
        :type: str
        """
        if error is None:
    ...
    def last_update(self):
        """Gets the last_update of this HarvesterIndexStatsDetailsSpaceIdProviderId.  # noqa: E501


        :return: The last_update of this HarvesterIndexStatsDetailsSpaceIdProviderId.  # noqa: E501
        :rtype: Timestamp
        """
    ...
    def last_update(self, last_update):
        """Sets the last_update of this HarvesterIndexStatsDetailsSpaceIdProviderId.


        :param last_update: The last_update of this HarvesterIndexStatsDetailsSpaceIdProviderId.  # noqa: E501
        :type: Timestamp
        """
    ...
    @property
    def archival(self):
        """Gets the archival of this HarvesterIndexStatsDetailsSpaceIdProviderId.  # noqa: E501

        Stats are marked archival when it is no longer possible to harvest metadata in given space in given provider (e.g space was removed from harvester)  # noqa: E501

        :return: The archival of this HarvesterIndexStatsDetailsSpaceIdProviderId.  # noqa: E501
        :rtype: bool
        """
    ...
    def archival(self, archival):
        """Sets the archival of this HarvesterIndexStatsDetailsSpaceIdProviderId.

        Stats are marked archival when it is no longer possible to harvest metadata in given space in given provider (e.g space was removed from harvester)  # noqa: E501

        :param archival: The archival of this HarvesterIndexStatsDetailsSpaceIdProviderId.  # noqa: E501
        :type: bool
        """
        if archival is None:
            raise ValueError("Invalid value for `archival`, must not be `None`")  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(HarvesterIndexStatsDetailsSpaceIdProviderId, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, HarvesterIndexStatsDetailsSpaceIdProviderId):
            return False
