...
class DOIServiceProperties(HandleServiceProperties):
    ...
    def __init__(self, host=None, doi_endpoint=None, metadata_endpoint=None, media_endpoint=None, prefix=None, username=None, password=None, identifier_template=None, allow_template_override=None, *args, **kwargs):  # noqa: E501
        """DOIServiceProperties - a model defined in Swagger"""  # noqa: E501
        self._host = None
    ...
    @property
    def host(self):
        """Gets the host of this DOIServiceProperties.  # noqa: E501

        The service host, including the protocol.   # noqa: E501

        :return: The host of this DOIServiceProperties.  # noqa: E501
        :rtype: str
        """
        return self._host
    ...
    @host.setter
    def host(self, host):
        """Sets the host of this DOIServiceProperties.

        The service host, including the protocol.   # noqa: E501

        :param host: The host of this DOIServiceProperties.  # noqa: E501
        :type: str
        """
        if host is None:
    ...
    def doi_endpoint(self):
        """Gets the doi_endpoint of this DOIServiceProperties.  # noqa: E501

        DOI registration API endpoint relative to the host.   # noqa: E501

        :return: The doi_endpoint of this DOIServiceProperties.  # noqa: E501
        :rtype: str
        """
    ...
    def doi_endpoint(self, doi_endpoint):
        """Sets the doi_endpoint of this DOIServiceProperties.

        DOI registration API endpoint relative to the host.   # noqa: E501

        :param doi_endpoint: The doi_endpoint of this DOIServiceProperties.  # noqa: E501
        :type: str
        """
        if doi_endpoint is None:
            raise ValueError("Invalid value for `doi_endpoint`, must not be `None`")  # noqa: E501

        self._doi_endpoint = doi_endpoint

    @property
    def metadata_endpoint(self):
        """Gets the metadata_endpoint of this DOIServiceProperties.  # noqa: E501

        Metadata registration API endpoint relative to the host.   # noqa: E501

        :return: The metadata_endpoint of this DOIServiceProperties.  # noqa: E501
        :rtype: str
        """
    ...
    def metadata_endpoint(self, metadata_endpoint):
        """Sets the metadata_endpoint of this DOIServiceProperties.

        Metadata registration API endpoint relative to the host.   # noqa: E501

        :param metadata_endpoint: The metadata_endpoint of this DOIServiceProperties.  # noqa: E501
        :type: str
        """
        if metadata_endpoint is None:
            raise ValueError("Invalid value for `metadata_endpoint`, must not be `None`")  # noqa: E501

        self._metadata_endpoint = metadata_endpoint

    @property
    def media_endpoint(self):
        """Gets the media_endpoint of this DOIServiceProperties.  # noqa: E501

        Media registration API endpoint relative to the host.   # noqa: E501

        :return: The media_endpoint of this DOIServiceProperties.  # noqa: E501
        :rtype: str
        """
    ...
    def media_endpoint(self, media_endpoint):
        """Sets the media_endpoint of this DOIServiceProperties.

        Media registration API endpoint relative to the host.   # noqa: E501

        :param media_endpoint: The media_endpoint of this DOIServiceProperties.  # noqa: E501
        :type: str
        """
        if media_endpoint is None:
            raise ValueError("Invalid value for `media_endpoint`, must not be `None`")  # noqa: E501

        self._media_endpoint = media_endpoint

    @property
    def prefix(self):
        """Gets the prefix of this DOIServiceProperties.  # noqa: E501

        The DOI prefix under which new DOI's can be minted using this account.   # noqa: E501

        :return: The prefix of this DOIServiceProperties.  # noqa: E501
        :rtype: str
        """
        return self._prefix
    ...
    def prefix(self, prefix):
        """Sets the prefix of this DOIServiceProperties.

        The DOI prefix under which new DOI's can be minted using this account.   # noqa: E501

        :param prefix: The prefix of this DOIServiceProperties.  # noqa: E501
        :type: str
        """
        if prefix is None:
    ...
    @property
    def username(self):
        """Gets the username of this DOIServiceProperties.  # noqa: E501

        The username for login to the DOI service.   # noqa: E501

        :return: The username of this DOIServiceProperties.  # noqa: E501
        :rtype: str
        """
    ...
    def username(self, username):
        """Sets the username of this DOIServiceProperties.

        The username for login to the DOI service.   # noqa: E501

        :param username: The username of this DOIServiceProperties.  # noqa: E501
        :type: str
        """
        if username is None:
    ...
    @property
    def password(self):
        """Gets the password of this DOIServiceProperties.  # noqa: E501

        The password for login to the DOI service.   # noqa: E501

        :return: The password of this DOIServiceProperties.  # noqa: E501
        :rtype: str
        """
    ...
    def password(self, password):
        """Sets the password of this DOIServiceProperties.

        The password for login to the DOI service.   # noqa: E501

        :param password: The password of this DOIServiceProperties.  # noqa: E501
        :type: str
        """
        if password is None:
    ...
    def identifier_template(self):
        """Gets the identifier_template of this DOIServiceProperties.  # noqa: E501

        The template for generation of new DOI's using this account.   # noqa: E501

        :return: The identifier_template of this DOIServiceProperties.  # noqa: E501
        :rtype: str
        """
    ...
    def identifier_template(self, identifier_template):
        """Sets the identifier_template of this DOIServiceProperties.

        The template for generation of new DOI's using this account.   # noqa: E501

        :param identifier_template: The identifier_template of this DOIServiceProperties.  # noqa: E501
        :type: str
        """
    ...
    def allow_template_override(self):
        """Gets the allow_template_override of this DOIServiceProperties.  # noqa: E501

        Specifies whether users can override the DOI suffix template for this account during registration of new DOI's.   # noqa: E501

        :return: The allow_template_override of this DOIServiceProperties.  # noqa: E501
        :rtype: bool
        """
    ...
    def allow_template_override(self, allow_template_override):
        """Sets the allow_template_override of this DOIServiceProperties.

        Specifies whether users can override the DOI suffix template for this account during registration of new DOI's.   # noqa: E501

        :param allow_template_override: The allow_template_override of this DOIServiceProperties.  # noqa: E501
        :type: bool
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DOIServiceProperties, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DOIServiceProperties):
            return False
