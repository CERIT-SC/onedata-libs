...
class HarvesterInviteToken(object):
    ...
    def __init__(self, token=None):  # noqa: E501
        """HarvesterInviteToken - a model defined in Swagger"""  # noqa: E501
        self._token = None
    ...
    @property
    def token(self):
        """Gets the token of this HarvesterInviteToken.  # noqa: E501

        The token for joining a harvester.  # noqa: E501

        :return: The token of this HarvesterInviteToken.  # noqa: E501
        :rtype: str
        """
        return self._token
    ...
    def token(self, token):
        """Sets the token of this HarvesterInviteToken.

        The token for joining a harvester.  # noqa: E501

        :param token: The token of this HarvesterInviteToken.  # noqa: E501
        :type: str
        """
        if token is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(HarvesterInviteToken, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, HarvesterInviteToken):
            return False
