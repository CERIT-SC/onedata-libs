...
class SupportParameters(object):
    ...
    def __init__(self, accounting_enabled=None, dir_stats_service_enabled=None, dir_stats_service_status=None):  # noqa: E501
        """SupportParameters - a model defined in Swagger"""  # noqa: E501
        ...
        if dir_stats_service_status is not None:
            self.dir_stats_service_status = dir_stats_service_status

    @property
    def accounting_enabled(self):
        """Gets the accounting_enabled of this SupportParameters.  # noqa: E501

        Indicates if accounting is enabled. The accounting mechanism utilizes directory statistics to keep track of quota usage within a space for the corresponding supporting provider.<br/> It can be toggled by an administrator of the provider with `cluster_update` privilege or by an administrator of the zone with `oz_spaces_update` privilege.   # noqa: E501

        :return: The accounting_enabled of this SupportParameters.  # noqa: E501
        :rtype: bool
        """
    ...
    def accounting_enabled(self, accounting_enabled):
        """Sets the accounting_enabled of this SupportParameters.

        Indicates if accounting is enabled. The accounting mechanism utilizes directory statistics to keep track of quota usage within a space for the corresponding supporting provider.<br/> It can be toggled by an administrator of the provider with `cluster_update` privilege or by an administrator of the zone with `oz_spaces_update` privilege.   # noqa: E501

        :param accounting_enabled: The accounting_enabled of this SupportParameters.  # noqa: E501
        :type: bool
        """
    ...
    def dir_stats_service_enabled(self, dir_stats_service_enabled):
        """Sets the dir_stats_service_enabled of this SupportParameters.

        Indicates if the directory statistics service should be enabled. The service gathers statistics concerning logical and physical directory size, file count and update times.<br/> It can be toggled by a space member with `space_update` privilege, by an administrator of the provider with `cluster_update` privilege or by an administrator of the zone with `oz_spaces_update` privilege.<br/> **NOTE**: Directory statistics are required for accounting and cannot be disabled independently.<br/> **NOTE**: Statistics collection causes an additional load on the provider and has a slight negative impact on file operation performance.<br/> **NOTE**: Applying a new setting may take some time, depending on the space size and current state of the directory statistics service. This process is reflected by the `initializing` and `stopping` intermediate statuses.   # noqa: E501

        :param dir_stats_service_enabled: The dir_stats_service_enabled of this SupportParameters.  # noqa: E501
        :type: bool
        """
    ...
    def dir_stats_service_status(self, dir_stats_service_status):
        """Sets the dir_stats_service_status of this SupportParameters.

        The current status of the directory statistics service, as reported by the supporting provider. It cannot be modified by a user. May be different from the `dirStatsServiceEnabled` setting if the service is in one of the intermediate states or the provider has not yet acknowledged a change in the parameters.   # noqa: E501

        :param dir_stats_service_status: The dir_stats_service_status of this SupportParameters.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SupportParameters, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SupportParameters):
            return False
