...
'api': 'Api'    }
    ...
    def __init__(self, type=None):  # noqa: E501
        """Caveat - a model defined in Swagger"""  # noqa: E501
        self._type = None
    ...
    @property
    def type(self):
        """Gets the type of this Caveat.  # noqa: E501


        :return: The type of this Caveat.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this Caveat.


        :param type: The type of this Caveat.  # noqa: E501
        :type: str
        """
        if type is None:
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, Caveat):
            return False
