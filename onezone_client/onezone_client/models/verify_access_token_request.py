...
class VerifyAccessTokenRequest(object):
    ...
    swagger_types = {
        ...
        'peer_ip': 'str',
        'service_token': 'SerializedToken',
        'consumer_token': 'SerializedToken',
        'interface': 'str',
        'allow_data_access_caveats': 'bool'
    }
    ...
    def __init__(self, token=None, peer_ip=None, service_token=None, consumer_token=None, interface=None, allow_data_access_caveats=False):  # noqa: E501
        """VerifyAccessTokenRequest - a model defined in Swagger"""  # noqa: E501
        self._token = None
        self._peer_ip = None
        self._service_token = None
        self._consumer_token = None
        self._interface = None
        self._allow_data_access_caveats = None
        ...
        if allow_data_access_caveats is not None:
            self.allow_data_access_caveats = allow_data_access_caveats

    @property
    def token(self):
        """Gets the token of this VerifyAccessTokenRequest.  # noqa: E501


        :return: The token of this VerifyAccessTokenRequest.  # noqa: E501
    ...
    def token(self, token):
        """Sets the token of this VerifyAccessTokenRequest.


        :param token: The token of this VerifyAccessTokenRequest.  # noqa: E501
    ...
    @property
    def peer_ip(self):
        """Gets the peer_ip of this VerifyAccessTokenRequest.  # noqa: E501

        The IP address of the token bearer.  # noqa: E501

        :return: The peer_ip of this VerifyAccessTokenRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def peer_ip(self, peer_ip):
        """Sets the peer_ip of this VerifyAccessTokenRequest.

        The IP address of the token bearer.  # noqa: E501

        :param peer_ip: The peer_ip of this VerifyAccessTokenRequest.  # noqa: E501
        :type: str
        """
    ...
    def service_token(self):
        """Gets the service_token of this VerifyAccessTokenRequest.  # noqa: E501


        :return: The service_token of this VerifyAccessTokenRequest.  # noqa: E501
        :rtype: SerializedToken
        """
    ...
    def service_token(self, service_token):
        """Sets the service_token of this VerifyAccessTokenRequest.


        :param service_token: The service_token of this VerifyAccessTokenRequest.  # noqa: E501
        :type: SerializedToken
        """
    ...
    def consumer_token(self):
        """Gets the consumer_token of this VerifyAccessTokenRequest.  # noqa: E501


        :return: The consumer_token of this VerifyAccessTokenRequest.  # noqa: E501
        :rtype: SerializedToken
        """
    ...
    def consumer_token(self, consumer_token):
        """Sets the consumer_token of this VerifyAccessTokenRequest.


        :param consumer_token: The consumer_token of this VerifyAccessTokenRequest.  # noqa: E501
        :type: SerializedToken
        """
    ...
    @property
    def interface(self):
        """Gets the interface of this VerifyAccessTokenRequest.  # noqa: E501

        The interface to which the token bearer has connected as seen by the verifying party.  # noqa: E501

        :return: The interface of this VerifyAccessTokenRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def interface(self, interface):
        """Sets the interface of this VerifyAccessTokenRequest.

        The interface to which the token bearer has connected as seen by the verifying party.  # noqa: E501

        :param interface: The interface of this VerifyAccessTokenRequest.  # noqa: E501
        :type: str
        """
        allowed_values = ["rest", "oneclient", "graphsync"]  # noqa: E501
    ...
    @property
    def allow_data_access_caveats(self):
        """Gets the allow_data_access_caveats of this VerifyAccessTokenRequest.  # noqa: E501

        Indication if verifying party allows data access caveats in the token.  # noqa: E501

        :return: The allow_data_access_caveats of this VerifyAccessTokenRequest.  # noqa: E501
        :rtype: bool
        """
        return self._allow_data_access_caveats

    @allow_data_access_caveats.setter
    def allow_data_access_caveats(self, allow_data_access_caveats):
        """Sets the allow_data_access_caveats of this VerifyAccessTokenRequest.

        Indication if verifying party allows data access caveats in the token.  # noqa: E501

        :param allow_data_access_caveats: The allow_data_access_caveats of this VerifyAccessTokenRequest.  # noqa: E501
        :type: bool
        """

        self._allow_data_access_caveats = allow_data_access_caveats
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(VerifyAccessTokenRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VerifyAccessTokenRequest):
            return False
