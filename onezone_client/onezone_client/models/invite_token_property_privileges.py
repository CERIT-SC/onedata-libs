...
class InviteTokenPropertyPrivileges(object):
    ...
    def __init__(self):  # noqa: E501
        """InviteTokenPropertyPrivileges - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(InviteTokenPropertyPrivileges, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, InviteTokenPropertyPrivileges):
            return False
