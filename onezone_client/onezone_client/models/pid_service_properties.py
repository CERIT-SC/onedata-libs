...
import six
from onezone_client.models.handle_service_properties import HandleServiceProperties  # noqa: F401,E501

class PIDServiceProperties(HandleServiceProperties):
    ...
    if hasattr(HandleServiceProperties, "swagger_types"):
        swagger_types.update(HandleServiceProperties.swagger_types)
    ...
    if hasattr(HandleServiceProperties, "attribute_map"):
        attribute_map.update(HandleServiceProperties.attribute_map)
    ...
    def __init__(self, endpoint=None, prefix=None, username=None, password=None, auto_suffix_generation=None, suffix_prefix=None, suffix_suffix=None, identifier_template=None, allow_template_override=None, *args, **kwargs):  # noqa: E501
        """PIDServiceProperties - a model defined in Swagger"""  # noqa: E501
        self._endpoint = None
        self._prefix = None
        self._username = None
        self._password = None
        ...
        HandleServiceProperties.__init__(self, *args, **kwargs)

    @property
    def endpoint(self):
        """Gets the endpoint of this PIDServiceProperties.  # noqa: E501

        The HTTP endpoint for handle registration.   # noqa: E501

        :return: The endpoint of this PIDServiceProperties.  # noqa: E501
        :rtype: str
        """
    ...
    def endpoint(self, endpoint):
        """Sets the endpoint of this PIDServiceProperties.

        The HTTP endpoint for handle registration.   # noqa: E501

        :param endpoint: The endpoint of this PIDServiceProperties.  # noqa: E501
        :type: str
        """
        if endpoint is None:
    ...
    @property
    def prefix(self):
        """Gets the prefix of this PIDServiceProperties.  # noqa: E501

        The PID prefix under which new PIDs can be minted using this account.   # noqa: E501

        :return: The prefix of this PIDServiceProperties.  # noqa: E501
        :rtype: str
        """
        return self._prefix
    ...
    def prefix(self, prefix):
        """Sets the prefix of this PIDServiceProperties.

        The PID prefix under which new PIDs can be minted using this account.   # noqa: E501

        :param prefix: The prefix of this PIDServiceProperties.  # noqa: E501
        :type: str
        """
        if prefix is None:
    ...
    @property
    def username(self):
        """Gets the username of this PIDServiceProperties.  # noqa: E501

        The username for login to the PID service.   # noqa: E501

        :return: The username of this PIDServiceProperties.  # noqa: E501
        :rtype: str
        """
    ...
    def username(self, username):
        """Sets the username of this PIDServiceProperties.

        The username for login to the PID service.   # noqa: E501

        :param username: The username of this PIDServiceProperties.  # noqa: E501
        :type: str
        """
        if username is None:
    ...
    @property
    def password(self):
        """Gets the password of this PIDServiceProperties.  # noqa: E501

        The password for login to the PID service.   # noqa: E501

        :return: The password of this PIDServiceProperties.  # noqa: E501
        :rtype: str
        """
    ...
    def password(self, password):
        """Sets the password of this PIDServiceProperties.

        The password for login to the PID service.   # noqa: E501

        :param password: The password of this PIDServiceProperties.  # noqa: E501
        :type: str
        """
        if password is None:
    ...
    def auto_suffix_generation(self):
        """Gets the auto_suffix_generation of this PIDServiceProperties.  # noqa: E501

        When set to true, the suffixes will be generated automatically by the registration service.   # noqa: E501

        :return: The auto_suffix_generation of this PIDServiceProperties.  # noqa: E501
        :rtype: bool
        """
    ...
    def auto_suffix_generation(self, auto_suffix_generation):
        """Sets the auto_suffix_generation of this PIDServiceProperties.

        When set to true, the suffixes will be generated automatically by the registration service.   # noqa: E501

        :param auto_suffix_generation: The auto_suffix_generation of this PIDServiceProperties.  # noqa: E501
        :type: bool
        """
        if auto_suffix_generation is None:
            raise ValueError("Invalid value for `auto_suffix_generation`, must not be `None`")  # noqa: E501

        self._auto_suffix_generation = auto_suffix_generation

    @property
    def suffix_prefix(self):
        """Gets the suffix_prefix of this PIDServiceProperties.  # noqa: E501

        Auto generated PID suffixes have a format PREFIX-UUID-SUFFIX, UUID is generated by the registration service.   # noqa: E501

        :return: The suffix_prefix of this PIDServiceProperties.  # noqa: E501
        :rtype: str
        """
    ...
    def suffix_prefix(self, suffix_prefix):
        """Sets the suffix_prefix of this PIDServiceProperties.

        Auto generated PID suffixes have a format PREFIX-UUID-SUFFIX, UUID is generated by the registration service.   # noqa: E501

        :param suffix_prefix: The suffix_prefix of this PIDServiceProperties.  # noqa: E501
        :type: str
        """
        if suffix_prefix is None:
            raise ValueError("Invalid value for `suffix_prefix`, must not be `None`")  # noqa: E501

        self._suffix_prefix = suffix_prefix

    @property
    def suffix_suffix(self):
        """Gets the suffix_suffix of this PIDServiceProperties.  # noqa: E501

        Auto generated PID suffixes have a format PREFIX-UUID-SUFFIX, UUID is generated by the registration service.   # noqa: E501

        :return: The suffix_suffix of this PIDServiceProperties.  # noqa: E501
        :rtype: str
        """
    ...
    def suffix_suffix(self, suffix_suffix):
        """Sets the suffix_suffix of this PIDServiceProperties.

        Auto generated PID suffixes have a format PREFIX-UUID-SUFFIX, UUID is generated by the registration service.   # noqa: E501

        :param suffix_suffix: The suffix_suffix of this PIDServiceProperties.  # noqa: E501
        :type: str
        """
        if suffix_suffix is None:
            raise ValueError("Invalid value for `suffix_suffix`, must not be `None`")  # noqa: E501

        self._suffix_suffix = suffix_suffix

    @property
    def identifier_template(self):
        """Gets the identifier_template of this PIDServiceProperties.  # noqa: E501
        ...
        :return: The identifier_template of this PIDServiceProperties.  # noqa: E501
        :rtype: str
        """
    ...
    def identifier_template(self, identifier_template):
        """Sets the identifier_template of this PIDServiceProperties.

        Template for generating PIDs based Onedata properties (e.g. space UUID). If set to `true` the `autoSuffixGeneration` must be `false`.   # noqa: E501

        :param identifier_template: The identifier_template of this PIDServiceProperties.  # noqa: E501
        :type: str
        """
    ...
    def allow_template_override(self):
        """Gets the allow_template_override of this PIDServiceProperties.  # noqa: E501

        Allow users to create custom identifiers regardless of the specified template.   # noqa: E501

        :return: The allow_template_override of this PIDServiceProperties.  # noqa: E501
        :rtype: str
        """
    ...
    def allow_template_override(self, allow_template_override):
        """Sets the allow_template_override of this PIDServiceProperties.

        Allow users to create custom identifiers regardless of the specified template.   # noqa: E501

        :param allow_template_override: The allow_template_override of this PIDServiceProperties.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PIDServiceProperties, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PIDServiceProperties):
            return False
