...
class DataReadonly(Caveat):
    ...
    def __init__(self, type=None, *args, **kwargs):  # noqa: E501
        """DataReadonly - a model defined in Swagger"""  # noqa: E501
        self._type = None
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this DataReadonly.

        Data readonly caveat - allows only read access to user files.  This is a **data access caveat** - if added to a token, it greatly limits its power in the system APIs, to the minimum required for data access - [see more](https://onedata.org/#/home/documentation/doc/using_onedata/tokens[data-access-caveats].html).  You can learn more about token caveats [here](https://onedata.org/#/home/documentation/doc/using_onedata/tokens[token-caveats].html).  Example: ```json   {     \"type\": \"data.readonly\"   } ```   # noqa: E501

        :param type: The type of this DataReadonly.  # noqa: E501
        :type: str
        """
        allowed_values = ["data.readonly"]  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DataReadonly, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DataReadonly):
            return False
