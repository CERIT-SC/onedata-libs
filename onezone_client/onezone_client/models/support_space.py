...
import six
from onezone_client.models.invite_token import InviteToken  # noqa: F401,E501

class SupportSpace(InviteToken):
    ...
    if hasattr(InviteToken, "swagger_types"):
        swagger_types.update(InviteToken.swagger_types)
    ...
    if hasattr(InviteToken, "attribute_map"):
        attribute_map.update(InviteToken.attribute_map)

    def __init__(self, invite_type=None, space_id=None, parameters=None, *args, **kwargs):  # noqa: E501
        """SupportSpace - a model defined in Swagger"""  # noqa: E501
        ...
        InviteToken.__init__(self, *args, **kwargs)

    @property
    def invite_type(self):
        """Gets the invite_type of this SupportSpace.  # noqa: E501

        Invite token type - invitation for a provider to support a space.  # noqa: E501

        :return: The invite_type of this SupportSpace.  # noqa: E501
        :rtype: str
        """
    ...
    def invite_type(self, invite_type):
        """Sets the invite_type of this SupportSpace.

        Invite token type - invitation for a provider to support a space.  # noqa: E501

        :param invite_type: The invite_type of this SupportSpace.  # noqa: E501
        :type: str
        """
        allowed_values = ["supportSpace"]  # noqa: E501
    ...
    @property
    def space_id(self):
        """Gets the space_id of this SupportSpace.  # noqa: E501

        Id of the space to be supported  # noqa: E501

        :return: The space_id of this SupportSpace.  # noqa: E501
        :rtype: str
        """
    ...
    def space_id(self, space_id):
        """Sets the space_id of this SupportSpace.

        Id of the space to be supported  # noqa: E501

        :param space_id: The space_id of this SupportSpace.  # noqa: E501
        :type: str
        """
    ...
    @property
    def parameters(self):
        """Gets the parameters of this SupportSpace.  # noqa: E501


        :return: The parameters of this SupportSpace.  # noqa: E501
        :rtype: SupportParameters
        """
        return self._parameters

    @parameters.setter
    def parameters(self, parameters):
        """Sets the parameters of this SupportSpace.


        :param parameters: The parameters of this SupportSpace.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SupportSpace, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SupportSpace):
            return False
