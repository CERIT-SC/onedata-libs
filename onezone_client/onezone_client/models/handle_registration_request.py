...
class HandleRegistrationRequest(object):
    ...
    def __init__(self, handle_service_id=None, resource_type=None, resource_id=None, metadata=None):  # noqa: E501
        """HandleRegistrationRequest - a model defined in Swagger"""  # noqa: E501
    ...
    def handle_service_id(self):
        """Gets the handle_service_id of this HandleRegistrationRequest.  # noqa: E501

        The Onedata GUID of the handle service registered.  # noqa: E501

        :return: The handle_service_id of this HandleRegistrationRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def handle_service_id(self, handle_service_id):
        """Sets the handle_service_id of this HandleRegistrationRequest.

        The Onedata GUID of the handle service registered.  # noqa: E501

        :param handle_service_id: The handle_service_id of this HandleRegistrationRequest.  # noqa: E501
        :type: str
        """
    ...
    def resource_type(self):
        """Gets the resource_type of this HandleRegistrationRequest.  # noqa: E501

        The type of resource to be registered.  # noqa: E501

        :return: The resource_type of this HandleRegistrationRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def resource_type(self, resource_type):
        """Sets the resource_type of this HandleRegistrationRequest.

        The type of resource to be registered.  # noqa: E501

        :param resource_type: The resource_type of this HandleRegistrationRequest.  # noqa: E501
        :type: str
        """
    ...
    def resource_id(self):
        """Gets the resource_id of this HandleRegistrationRequest.  # noqa: E501

        The Id of the resource to be assigned a handle identifier.  # noqa: E501

        :return: The resource_id of this HandleRegistrationRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def resource_id(self, resource_id):
        """Sets the resource_id of this HandleRegistrationRequest.

        The Id of the resource to be assigned a handle identifier.  # noqa: E501

        :param resource_id: The resource_id of this HandleRegistrationRequest.  # noqa: E501
        :type: str
        """
    ...
    @property
    def metadata(self):
        """Gets the metadata of this HandleRegistrationRequest.  # noqa: E501

        Dublin Core metadata for the resource encoded in XML.  # noqa: E501

        :return: The metadata of this HandleRegistrationRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def metadata(self, metadata):
        """Sets the metadata of this HandleRegistrationRequest.

        Dublin Core metadata for the resource encoded in XML.  # noqa: E501

        :param metadata: The metadata of this HandleRegistrationRequest.  # noqa: E501
        :type: str
        """
        if metadata is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(HandleRegistrationRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, HandleRegistrationRequest):
            return False
