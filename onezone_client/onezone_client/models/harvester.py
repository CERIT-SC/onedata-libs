...
class Harvester(object):
    ...
    swagger_types = {
        ...
        'name': 'str',
        'public': 'bool',
        'harvesting_backend_type': 'str',
        'harvesting_backend_endpoint': 'str',
        'creator': 'Subject',
    ...
    attribute_map = {
        ...
        'name': 'name',
        'public': 'public',
        'harvesting_backend_type': 'harvestingBackendType',
        'harvesting_backend_endpoint': 'harvestingBackendEndpoint',
        'creator': 'creator',
        'creation_time': 'creationTime'
    }

    def __init__(self, harvester_id=None, name=None, public=None, harvesting_backend_type=None, harvesting_backend_endpoint=None, creator=None, creation_time=None):  # noqa: E501
        """Harvester - a model defined in Swagger"""  # noqa: E501
        self._harvester_id = None
        self._name = None
        self._public = None
        self._harvesting_backend_type = None
        self._harvesting_backend_endpoint = None
        self._creator = None
        ...
        self.name = name
        self.public = public
        self.harvesting_backend_type = harvesting_backend_type
        self.harvesting_backend_endpoint = harvesting_backend_endpoint
        self.creator = creator
        self.creation_time = creation_time

    @property
    def harvester_id(self):
        """Gets the harvester_id of this Harvester.  # noqa: E501

        Unique harvester Id.  # noqa: E501

        :return: The harvester_id of this Harvester.  # noqa: E501
        :rtype: str
        """
        return self._harvester_id

    @harvester_id.setter
    def harvester_id(self, harvester_id):
        """Sets the harvester_id of this Harvester.

        Unique harvester Id.  # noqa: E501

        :param harvester_id: The harvester_id of this Harvester.  # noqa: E501
        :type: str
        """
        if harvester_id is None:
            raise ValueError("Invalid value for `harvester_id`, must not be `None`")  # noqa: E501

        self._harvester_id = harvester_id

    @property
    def name(self):
        """Gets the name of this Harvester.  # noqa: E501

        The name of the harvester.  # noqa: E501

        :return: The name of this Harvester.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this Harvester.

        The name of the harvester.  # noqa: E501

        :param name: The name of this Harvester.  # noqa: E501
        :type: str
        """
        if name is None:
    ...
    @property
    def public(self):
        """Gets the public of this Harvester.  # noqa: E501

        Whether given harvester is public.  More on public harvesters: [Query harvester index](#operation/query_harvester_index)     # noqa: E501

        :return: The public of this Harvester.  # noqa: E501
        :rtype: bool
        """
        return self._public
    ...
    def public(self, public):
        """Sets the public of this Harvester.

        Whether given harvester is public.  More on public harvesters: [Query harvester index](#operation/query_harvester_index)     # noqa: E501

        :param public: The public of this Harvester.  # noqa: E501
        :type: bool
        """
        if public is None:
    ...
    @property
    def harvesting_backend_type(self):
        """Gets the harvesting_backend_type of this Harvester.  # noqa: E501

        Type of external harvesting backend that will provide persistence and analytics for harvested metadata. Can be chosen from predefined backends and optionally custom ones configured by Onezone admins. Can be omitted if default harvester backend is set up in Onezone.  # noqa: E501

        :return: The harvesting_backend_type of this Harvester.  # noqa: E501
        :rtype: str
        """
        return self._harvesting_backend_type

    @harvesting_backend_type.setter
    def harvesting_backend_type(self, harvesting_backend_type):
        """Sets the harvesting_backend_type of this Harvester.

        Type of external harvesting backend that will provide persistence and analytics for harvested metadata. Can be chosen from predefined backends and optionally custom ones configured by Onezone admins. Can be omitted if default harvester backend is set up in Onezone.  # noqa: E501

        :param harvesting_backend_type: The harvesting_backend_type of this Harvester.  # noqa: E501
        :type: str
        """
        if harvesting_backend_type is None:
            raise ValueError("Invalid value for `harvesting_backend_type`, must not be `None`")  # noqa: E501

        self._harvesting_backend_type = harvesting_backend_type

    @property
    def harvesting_backend_endpoint(self):
        """Gets the harvesting_backend_endpoint of this Harvester.  # noqa: E501

        Endpoint where the specified harvesting backend can be reached by Onezone to feed incoming metadata and perform queries. Can be omitted if default harvester backend is set up in Onezone.  # noqa: E501

        :return: The harvesting_backend_endpoint of this Harvester.  # noqa: E501
        :rtype: str
        """
        return self._harvesting_backend_endpoint

    @harvesting_backend_endpoint.setter
    def harvesting_backend_endpoint(self, harvesting_backend_endpoint):
        """Sets the harvesting_backend_endpoint of this Harvester.

        Endpoint where the specified harvesting backend can be reached by Onezone to feed incoming metadata and perform queries. Can be omitted if default harvester backend is set up in Onezone.  # noqa: E501

        :param harvesting_backend_endpoint: The harvesting_backend_endpoint of this Harvester.  # noqa: E501
        :type: str
        """
        if harvesting_backend_endpoint is None:
            raise ValueError("Invalid value for `harvesting_backend_endpoint`, must not be `None`")  # noqa: E501

        self._harvesting_backend_endpoint = harvesting_backend_endpoint

    @property
    def creator(self):
        """Gets the creator of this Harvester.  # noqa: E501


        :return: The creator of this Harvester.  # noqa: E501
        :rtype: Subject
        """
    ...
    def creator(self, creator):
        """Sets the creator of this Harvester.


        :param creator: The creator of this Harvester.  # noqa: E501
        :type: Subject
        """
        if creator is None:
    ...
    def creation_time(self):
        """Gets the creation_time of this Harvester.  # noqa: E501


        :return: The creation_time of this Harvester.  # noqa: E501
        :rtype: Timestamp
        """
    ...
    def creation_time(self, creation_time):
        """Sets the creation_time of this Harvester.


        :param creation_time: The creation_time of this Harvester.  # noqa: E501
        :type: Timestamp
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, Harvester):
            return False
