...
class Service(Caveat):
    ...
    @property
    def whitelist(self):
        """Gets the whitelist of this Service.  # noqa: E501

        List of services that are allowed to utilize the token.  Example: ```json   {     \"type\": \"service\",     \"whitelist\": [       \"ozw-onezone\",       \"ozp-onezone\",       \"opp-*\",       \"opw-01c4455bef059353c9dfb35ba93a24f3\"     ]   } ```   # noqa: E501

        :return: The whitelist of this Service.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def whitelist(self, whitelist):
        """Sets the whitelist of this Service.

        List of services that are allowed to utilize the token.  Example: ```json   {     \"type\": \"service\",     \"whitelist\": [       \"ozw-onezone\",       \"ozp-onezone\",       \"opp-*\",       \"opw-01c4455bef059353c9dfb35ba93a24f3\"     ]   } ```   # noqa: E501

        :param whitelist: The whitelist of this Service.  # noqa: E501
        :type: list[str]
        """
