...
class IndicesIdxBody(object):
    ...
    def __init__(self, name=None, gui_plugin_name=None):  # noqa: E501
        """IndicesIdxBody - a model defined in Swagger"""  # noqa: E501
        self._name = None
    ...
    @property
    def name(self):
        """Gets the name of this IndicesIdxBody.  # noqa: E501

        The new name of the index.  # noqa: E501

        :return: The name of this IndicesIdxBody.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this IndicesIdxBody.

        The new name of the index.  # noqa: E501

        :param name: The name of this IndicesIdxBody.  # noqa: E501
        :type: str
        """
    ...
    def gui_plugin_name(self):
        """Gets the gui_plugin_name of this IndicesIdxBody.  # noqa: E501

        The new gui plugin name of the index.  # noqa: E501

        :return: The gui_plugin_name of this IndicesIdxBody.  # noqa: E501
        :rtype: str
        """
    ...
    def gui_plugin_name(self, gui_plugin_name):
        """Sets the gui_plugin_name of this IndicesIdxBody.

        The new gui plugin name of the index.  # noqa: E501

        :param gui_plugin_name: The gui_plugin_name of this IndicesIdxBody.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(IndicesIdxBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, IndicesIdxBody):
            return False
