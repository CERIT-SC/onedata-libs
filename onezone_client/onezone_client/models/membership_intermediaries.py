...
class MembershipIntermediaries(object):
    ...
    """
    swagger_types = {
        'intermediaries': 'list[MembershipIntermediariesIntermediaries]'
    }
    ...
    def __init__(self, intermediaries=None):  # noqa: E501
        """MembershipIntermediaries - a model defined in Swagger"""  # noqa: E501
    ...
    def intermediaries(self):
        """Gets the intermediaries of this MembershipIntermediaries.  # noqa: E501


        :return: The intermediaries of this MembershipIntermediaries.  # noqa: E501
        :rtype: list[MembershipIntermediariesIntermediaries]
        """
        return self._intermediaries

    @intermediaries.setter
    def intermediaries(self, intermediaries):
        """Sets the intermediaries of this MembershipIntermediaries.


        :param intermediaries: The intermediaries of this MembershipIntermediaries.  # noqa: E501
        :type: list[MembershipIntermediariesIntermediaries]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(MembershipIntermediaries, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MembershipIntermediaries):
            return False
