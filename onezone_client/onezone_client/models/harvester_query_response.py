...
class HarvesterQueryResponse(object):
    ...
    def __init__(self, headers=None, code=None, body=None):  # noqa: E501
        """HarvesterQueryResponse - a model defined in Swagger"""  # noqa: E501
        self._headers = None
        self._code = None
        self._body = None
    ...
    @property
    def headers(self):
        """Gets the headers of this HarvesterQueryResponse.  # noqa: E501

        Headers of the Elasticseach response.  # noqa: E501

        :return: The headers of this HarvesterQueryResponse.  # noqa: E501
        :rtype: object
        """
    ...
    def headers(self, headers):
        """Sets the headers of this HarvesterQueryResponse.

        Headers of the Elasticseach response.  # noqa: E501

        :param headers: The headers of this HarvesterQueryResponse.  # noqa: E501
        :type: object
        """
        if headers is None:
    ...
    @property
    def code(self):
        """Gets the code of this HarvesterQueryResponse.  # noqa: E501

        Status code of the Elasticsearch response.  # noqa: E501

        :return: The code of this HarvesterQueryResponse.  # noqa: E501
        :rtype: int
        """
        return self._code
    ...
    @code.setter
    def code(self, code):
        """Sets the code of this HarvesterQueryResponse.

        Status code of the Elasticsearch response.  # noqa: E501

        :param code: The code of this HarvesterQueryResponse.  # noqa: E501
        :type: int
        """
        if code is None:
    ...
    @property
    def body(self):
        """Gets the body of this HarvesterQueryResponse.  # noqa: E501

        Body of the Elasticsearch response.  # noqa: E501

        :return: The body of this HarvesterQueryResponse.  # noqa: E501
        :rtype: str
        """
        return self._body
    ...
    @body.setter
    def body(self, body):
        """Sets the body of this HarvesterQueryResponse.

        Body of the Elasticsearch response.  # noqa: E501

        :param body: The body of this HarvesterQueryResponse.  # noqa: E501
        :type: str
        """
        if body is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(HarvesterQueryResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, HarvesterQueryResponse):
            return False
