...
class HandleService(object):
    ...
    swagger_types = {
        ...
        'name': 'str',
        'proxy_endpoint': 'str',
        'service_properties': 'HandleServiceProperties',
        'creator': 'Subject',
    ...
    def __init__(self, handle_service_id=None, name=None, proxy_endpoint=None, service_properties=None, creator=None, creation_time=None):  # noqa: E501
        """HandleService - a model defined in Swagger"""  # noqa: E501
    ...
    def handle_service_id(self):
        """Gets the handle_service_id of this HandleService.  # noqa: E501

        Handle service Id.  # noqa: E501

        :return: The handle_service_id of this HandleService.  # noqa: E501
        :rtype: str
        """
    ...
    def handle_service_id(self, handle_service_id):
        """Sets the handle_service_id of this HandleService.

        Handle service Id.  # noqa: E501

        :param handle_service_id: The handle_service_id of this HandleService.  # noqa: E501
        :type: str
        """
        if handle_service_id is None:
            raise ValueError("Invalid value for `handle_service_id`, must not be `None`")  # noqa: E501

        self._handle_service_id = handle_service_id

    @property
    def name(self):
        """Gets the name of this HandleService.  # noqa: E501

        The user defined name of the service.   # noqa: E501

        :return: The name of this HandleService.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this HandleService.

        The user defined name of the service.   # noqa: E501

        :param name: The name of this HandleService.  # noqa: E501
        :type: str
        """
        if name is None:
    ...
    def proxy_endpoint(self):
        """Gets the proxy_endpoint of this HandleService.  # noqa: E501

        The endpoint of the Handle service proxy, i.e. a service which implements logic specific for particular Handle service.   # noqa: E501

        :return: The proxy_endpoint of this HandleService.  # noqa: E501
        :rtype: str
        """
    ...
    def proxy_endpoint(self, proxy_endpoint):
        """Sets the proxy_endpoint of this HandleService.

        The endpoint of the Handle service proxy, i.e. a service which implements logic specific for particular Handle service.   # noqa: E501

        :param proxy_endpoint: The proxy_endpoint of this HandleService.  # noqa: E501
        :type: str
        """
        if proxy_endpoint is None:
            raise ValueError("Invalid value for `proxy_endpoint`, must not be `None`")  # noqa: E501

        self._proxy_endpoint = proxy_endpoint

    @property
    def service_properties(self):
        """Gets the service_properties of this HandleService.  # noqa: E501


        :return: The service_properties of this HandleService.  # noqa: E501
        :rtype: HandleServiceProperties
        """
        return self._service_properties

    @service_properties.setter
    def service_properties(self, service_properties):
        """Sets the service_properties of this HandleService.


        :param service_properties: The service_properties of this HandleService.  # noqa: E501
        :type: HandleServiceProperties
        """
    ...
    @property
    def creator(self):
        """Gets the creator of this HandleService.  # noqa: E501


        :return: The creator of this HandleService.  # noqa: E501
        :rtype: Subject
        """
    ...
    def creator(self, creator):
        """Sets the creator of this HandleService.


        :param creator: The creator of this HandleService.  # noqa: E501
        :type: Subject
        """
        if creator is None:
    ...
    def creation_time(self):
        """Gets the creation_time of this HandleService.  # noqa: E501


        :return: The creation_time of this HandleService.  # noqa: E501
        :rtype: Timestamp
        """
    ...
    def creation_time(self, creation_time):
        """Sets the creation_time of this HandleService.


        :param creation_time: The creation_time of this HandleService.  # noqa: E501
        :type: Timestamp
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(HandleService, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, HandleService):
            return False
