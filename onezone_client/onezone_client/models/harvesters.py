...
class Harvesters(object):
    ...
    def __init__(self, harvesters=None):  # noqa: E501
        """Harvesters - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def harvesters(self):
        """Gets the harvesters of this Harvesters.  # noqa: E501

        The list of harvester Ids.  # noqa: E501

        :return: The harvesters of this Harvesters.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def harvesters(self, harvesters):
        """Sets the harvesters of this Harvesters.

        The list of harvester Ids.  # noqa: E501

        :param harvesters: The harvesters of this Harvesters.  # noqa: E501
        :type: list[str]
        """
        if harvesters is None:
            raise ValueError("Invalid value for `harvesters`, must not be `None`")  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, Harvesters):
            return False
