...
class SpaceStats(object):
    ...
    """
    swagger_types = {
        'sync_progress_per_provider': 'dict(str, ProviderSyncProgress)'
    }
    ...
    def __init__(self, sync_progress_per_provider=None):  # noqa: E501
        """SpaceStats - a model defined in Swagger"""  # noqa: E501
        self._sync_progress_per_provider = None
        self.discriminator = None
        self.sync_progress_per_provider = sync_progress_per_provider

    @property
    def sync_progress_per_provider(self):
        """Gets the sync_progress_per_provider of this SpaceStats.  # noqa: E501

        The map of provider Ids supporting this space and corresponding sync progress of the provider.   # noqa: E501

        :return: The sync_progress_per_provider of this SpaceStats.  # noqa: E501
        :rtype: dict(str, ProviderSyncProgress)
        """
        return self._sync_progress_per_provider

    @sync_progress_per_provider.setter
    def sync_progress_per_provider(self, sync_progress_per_provider):
        """Sets the sync_progress_per_provider of this SpaceStats.

        The map of provider Ids supporting this space and corresponding sync progress of the provider.   # noqa: E501

        :param sync_progress_per_provider: The sync_progress_per_provider of this SpaceStats.  # noqa: E501
        :type: dict(str, ProviderSyncProgress)
        """
        if sync_progress_per_provider is None:
            raise ValueError("Invalid value for `sync_progress_per_provider`, must not be `None`")  # noqa: E501

        self._sync_progress_per_provider = sync_progress_per_provider
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SpaceStats):
            return False
