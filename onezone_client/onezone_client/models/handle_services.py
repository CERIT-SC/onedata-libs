...
class HandleServices(object):
    ...
    def __init__(self, handle_services=None):  # noqa: E501
        """HandleServices - a model defined in Swagger"""  # noqa: E501
        self._handle_services = None
        self.discriminator = None
        self.handle_services = handle_services

    @property
    def handle_services(self):
        """Gets the handle_services of this HandleServices.  # noqa: E501

        The list of handle services Ids.  # noqa: E501

        :return: The handle_services of this HandleServices.  # noqa: E501
        :rtype: list[str]
        """
        return self._handle_services

    @handle_services.setter
    def handle_services(self, handle_services):
        """Sets the handle_services of this HandleServices.

        The list of handle services Ids.  # noqa: E501

        :param handle_services: The handle_services of this HandleServices.  # noqa: E501
        :type: list[str]
        """
        if handle_services is None:
            raise ValueError("Invalid value for `handle_services`, must not be `None`")  # noqa: E501

        self._handle_services = handle_services
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(HandleServices, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, HandleServices):
            return False
