...
class SpaceMembershipRequests(object):
    ...
    """
    swagger_types = {
        'pending': 'dict(str, SpaceMembershipRequest)',
        'rejected': 'dict(str, SpaceMembershipRequest)'
    }
    ...
    def __init__(self, pending=None, rejected=None):  # noqa: E501
        """SpaceMembershipRequests - a model defined in Swagger"""  # noqa: E501
        self._pending = None
        self._rejected = None
    ...
    @property
    def pending(self):
        """Gets the pending of this SpaceMembershipRequests.  # noqa: E501

        A map of space Ids and corresponding pending (not resolved) membership requests.   # noqa: E501

        :return: The pending of this SpaceMembershipRequests.  # noqa: E501
        :rtype: dict(str, SpaceMembershipRequest)
        """
        return self._pending

    @pending.setter
    def pending(self, pending):
        """Sets the pending of this SpaceMembershipRequests.

        A map of space Ids and corresponding pending (not resolved) membership requests.   # noqa: E501

        :param pending: The pending of this SpaceMembershipRequests.  # noqa: E501
        :type: dict(str, SpaceMembershipRequest)
        """
        if pending is None:
    ...
    @property
    def rejected(self):
        """Gets the rejected of this SpaceMembershipRequests.  # noqa: E501

        A map of space Ids and corresponding rejected membership requests.   # noqa: E501

        :return: The rejected of this SpaceMembershipRequests.  # noqa: E501
        :rtype: dict(str, SpaceMembershipRequest)
        """
    ...
    def rejected(self, rejected):
        """Sets the rejected of this SpaceMembershipRequests.

        A map of space Ids and corresponding rejected membership requests.   # noqa: E501

        :param rejected: The rejected of this SpaceMembershipRequests.  # noqa: E501
        :type: dict(str, SpaceMembershipRequest)
        """
        if rejected is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SpaceMembershipRequests, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SpaceMembershipRequests):
            return False
