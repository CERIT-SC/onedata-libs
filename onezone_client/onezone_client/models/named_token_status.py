...
class NamedTokenStatus(object):
    ...
    def __init__(self, revoked=None):  # noqa: E501
        """NamedTokenStatus - a model defined in Swagger"""  # noqa: E501
        self._revoked = None
    ...
    @property
    def revoked(self):
        """Gets the revoked of this NamedTokenStatus.  # noqa: E501


        :return: The revoked of this NamedTokenStatus.  # noqa: E501
    ...
    def revoked(self, revoked):
        """Sets the revoked of this NamedTokenStatus.


        :param revoked: The revoked of this NamedTokenStatus.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(NamedTokenStatus, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, NamedTokenStatus):
            return False
