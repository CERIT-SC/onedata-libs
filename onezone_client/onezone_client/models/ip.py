...
class Ip(Caveat):
    ...
    def type(self):
        ...
        IP caveat - limits the allowed client IPs to a certain whitelist (masks are supported).  You can learn more about token caveats [here](https://onedata.org/#/home/documentation/doc/using_onedata/tokens[token-caveats].html).   # noqa: E501
    ...
    @property
    def whitelist(self):
        """Gets the whitelist of this Ip.  # noqa: E501

        List of IPs or masks that are allowed to utilize the token.  Example: ```json   {     \"type\": \"ip\",     \"whitelist\": [       \"189.34.15.0/24\",       \"127.0.0.0/8\",       \"167.73.12.17\"     ]   } ```   # noqa: E501

        :return: The whitelist of this Ip.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def whitelist(self, whitelist):
        """Sets the whitelist of this Ip.

        List of IPs or masks that are allowed to utilize the token.  Example: ```json   {     \"type\": \"ip\",     \"whitelist\": [       \"189.34.15.0/24\",       \"127.0.0.0/8\",       \"167.73.12.17\"     ]   } ```   # noqa: E501

        :param whitelist: The whitelist of this Ip.  # noqa: E501
        :type: list[str]
        """
