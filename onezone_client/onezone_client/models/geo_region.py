...
class GeoRegion(Caveat):
    ...
    def __init__(self, type=None, filter=None, list=None, *args, **kwargs):  # noqa: E501
        """GeoRegion - a model defined in Swagger"""  # noqa: E501
        self._type = None
        self._filter = None
        self._list = None
    ...
    def type(self, type):
        ...
        :param type: The type of this GeoRegion.  # noqa: E501
        :type: str
        """
        allowed_values = ["geo.region"]  # noqa: E501
    ...
    @property
    def filter(self):
        """Gets the filter of this GeoRegion.  # noqa: E501

        Filter type to be applied: * whitelist limits allowed regions to the ones on the list only * blacklist limits allowed regions to any region that is not on the list   # noqa: E501

        :return: The filter of this GeoRegion.  # noqa: E501
        :rtype: str
        """
        return self._filter
    ...
    def filter(self, filter):
        """Sets the filter of this GeoRegion.

        Filter type to be applied: * whitelist limits allowed regions to the ones on the list only * blacklist limits allowed regions to any region that is not on the list   # noqa: E501

        :param filter: The filter of this GeoRegion.  # noqa: E501
        :type: str
        """
    ...
    @property
    def list(self):
        """Gets the list of this GeoRegion.  # noqa: E501

        List of regions from which the token can be utilized.  Example: ```json   {     \"type\": \"geo.region\",     \"filter\": \"blacklist\",     \"list\": [       \"Asia\",       \"NorthAmerica\",       \"Oceania\"     ]   } ```   # noqa: E501

        :return: The list of this GeoRegion.  # noqa: E501
        :rtype: list[str]
        """
        return self._list
    ...
    @list.setter
    def list(self, list):
        """Sets the list of this GeoRegion.

        List of regions from which the token can be utilized.  Example: ```json   {     \"type\": \"geo.region\",     \"filter\": \"blacklist\",     \"list\": [       \"Asia\",       \"NorthAmerica\",       \"Oceania\"     ]   } ```   # noqa: E501

        :param list: The list of this GeoRegion.  # noqa: E501
        :type: list[str]
        """
        allowed_values = ["Africa", "Antarctica", "Asia", "Europe", "EU", "NorthAmerica", "Oceania", "SouthAmerica"]  # noqa: E501
        if not set(list).issubset(set(allowed_values)):
            raise ValueError(
                "Invalid values for `list` [{0}], must be a subset of [{1}]"  # noqa: E501
                .format(", ".join(map(str, set(list) - set(allowed_values))),  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GeoRegion):
            return False
