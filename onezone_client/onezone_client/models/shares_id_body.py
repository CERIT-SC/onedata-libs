...
class SharesIdBody(object):
    ...
    def __init__(self, name=None, description=None):  # noqa: E501
        """SharesIdBody - a model defined in Swagger"""  # noqa: E501
        self._name = None
    ...
    @property
    def name(self):
        """Gets the name of this SharesIdBody.  # noqa: E501

        New name for the share.  # noqa: E501

        :return: The name of this SharesIdBody.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this SharesIdBody.

        New name for the share.  # noqa: E501

        :param name: The name of this SharesIdBody.  # noqa: E501
        :type: str
        """
    ...
    def description(self):
        """Gets the description of this SharesIdBody.  # noqa: E501

        New description of the share.  # noqa: E501

        :return: The description of this SharesIdBody.  # noqa: E501
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this SharesIdBody.

        New description of the share.  # noqa: E501

        :param description: The description of this SharesIdBody.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SharesIdBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SharesIdBody):
            return False
