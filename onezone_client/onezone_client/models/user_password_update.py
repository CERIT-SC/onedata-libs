...
class UserPasswordUpdate(object):
    ...
    def __init__(self, old_password=None, new_password=None):  # noqa: E501
        """UserPasswordUpdate - a model defined in Swagger"""  # noqa: E501
    ...
    def old_password(self):
        """Gets the old_password of this UserPasswordUpdate.  # noqa: E501

        The old user's password (in plaintext) or null if it was never set.  # noqa: E501

        :return: The old_password of this UserPasswordUpdate.  # noqa: E501
        :rtype: str
        """
    ...
    def old_password(self, old_password):
        """Sets the old_password of this UserPasswordUpdate.

        The old user's password (in plaintext) or null if it was never set.  # noqa: E501

        :param old_password: The old_password of this UserPasswordUpdate.  # noqa: E501
        :type: str
        """
    ...
    def new_password(self):
        """Gets the new_password of this UserPasswordUpdate.  # noqa: E501

        The new user's password (in plaintext).  # noqa: E501

        :return: The new_password of this UserPasswordUpdate.  # noqa: E501
        :rtype: str
        """
    ...
    def new_password(self, new_password):
        """Sets the new_password of this UserPasswordUpdate.

        The new user's password (in plaintext).  # noqa: E501

        :param new_password: The new_password of this UserPasswordUpdate.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(UserPasswordUpdate, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UserPasswordUpdate):
            return False
