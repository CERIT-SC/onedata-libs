...
class ConfigurationSupportedIdPs(object):
    ...
    def __init__(self, id=None, offline_access=None):  # noqa: E501
        """ConfigurationSupportedIdPs - a model defined in Swagger"""  # noqa: E501
        self._id = None
        self._offline_access = None
    ...
    @property
    def id(self):
        """Gets the id of this ConfigurationSupportedIdPs.  # noqa: E501

        The identifier of the IdP  # noqa: E501

        :return: The id of this ConfigurationSupportedIdPs.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this ConfigurationSupportedIdPs.

        The identifier of the IdP  # noqa: E501

        :param id: The id of this ConfigurationSupportedIdPs.  # noqa: E501
        :type: str
        """
    ...
    def offline_access(self):
        """Gets the offline_access of this ConfigurationSupportedIdPs.  # noqa: E501

        Determines whether given IdP can be used in the offline access flow, i.e. Onezone can acquire access tokens in the IdP without the user being logged in.  # noqa: E501

        :return: The offline_access of this ConfigurationSupportedIdPs.  # noqa: E501
        :rtype: bool
        """
        return self._offline_access

    @offline_access.setter
    def offline_access(self, offline_access):
        """Sets the offline_access of this ConfigurationSupportedIdPs.

        Determines whether given IdP can be used in the offline access flow, i.e. Onezone can acquire access tokens in the IdP without the user being logged in.  # noqa: E501

        :param offline_access: The offline_access of this ConfigurationSupportedIdPs.  # noqa: E501
        :type: bool
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ConfigurationSupportedIdPs, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ConfigurationSupportedIdPs):
            return False
