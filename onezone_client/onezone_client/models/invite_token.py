...
class InviteToken(object):
    ...
    discriminator_value_class_map = {
          'userJoinHarvester': 'UserJoinHarvester',
'userJoinGroup': 'UserJoinGroup',
'spaceJoinHarvester': 'SpaceJoinHarvester',
'groupJoinCluster': 'GroupJoinCluster',
'groupJoinSpace': 'GroupJoinSpace',
'groupJoinHarvester': 'GroupJoinHarvester',
'userJoinSpace': 'UserJoinSpace',
'harvesterJoinSpace': 'HarvesterJoinSpace',
'supportSpace': 'SupportSpace',
'userJoinCluster': 'UserJoinCluster',
'groupJoinGroup': 'GroupJoinGroup',
'registerOneprovider': 'RegisterOneprovider'    }

    def __init__(self, invite_type=None):  # noqa: E501
        """InviteToken - a model defined in Swagger"""  # noqa: E501
        self._invite_type = None
        self.discriminator = 'invite_type'
        self.invite_type = invite_type

    @property
    def invite_type(self):
        """Gets the invite_type of this InviteToken.  # noqa: E501

        Type of invitation  # noqa: E501

        :return: The invite_type of this InviteToken.  # noqa: E501
        :rtype: str
        """
    ...
    def invite_type(self, invite_type):
        """Sets the invite_type of this InviteToken.

        Type of invitation  # noqa: E501

        :param invite_type: The invite_type of this InviteToken.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(InviteToken, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, InviteToken):
            return False
