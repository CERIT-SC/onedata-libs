...
class TokensConfineBody(object):
    ...
    def __init__(self, token=None, caveats=None):  # noqa: E501
        """TokensConfineBody - a model defined in Swagger"""  # noqa: E501
        self._token = None
        self._caveats = None
    ...
    @property
    def token(self):
        """Gets the token of this TokensConfineBody.  # noqa: E501


        :return: The token of this TokensConfineBody.  # noqa: E501
    ...
    def token(self, token):
        """Sets the token of this TokensConfineBody.


        :param token: The token of this TokensConfineBody.  # noqa: E501
    ...
    @property
    def caveats(self):
        """Gets the caveats of this TokensConfineBody.  # noqa: E501


        :return: The caveats of this TokensConfineBody.  # noqa: E501
    ...
    def caveats(self, caveats):
        """Sets the caveats of this TokensConfineBody.


        :param caveats: The caveats of this TokensConfineBody.  # noqa: E501
        :type: TokenPropertyCaveats
        """
        if caveats is None:
            raise ValueError("Invalid value for `caveats`, must not be `None`")  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TokensConfineBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TokensConfineBody):
            return False
