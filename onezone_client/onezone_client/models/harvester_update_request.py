...
class HarvesterUpdateRequest(object):
    ...
    def __init__(self, name=None, harvesting_backend_type=None, harvesting_backend_endpoint=None, public=None):  # noqa: E501
        """HarvesterUpdateRequest - a model defined in Swagger"""  # noqa: E501
        self._name = None
        ...
        if name is not None:
            self.name = name
        if harvesting_backend_type is not None:
            self.harvesting_backend_type = harvesting_backend_type
        if harvesting_backend_endpoint is not None:
    ...
    @property
    def name(self):
        """Gets the name of this HarvesterUpdateRequest.  # noqa: E501

        The name of the harvester.  # noqa: E501

        :return: The name of this HarvesterUpdateRequest.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this HarvesterUpdateRequest.

        The name of the harvester.  # noqa: E501

        :param name: The name of this HarvesterUpdateRequest.  # noqa: E501
        :type: str
        """
    ...
    def harvesting_backend_type(self):
        """Gets the harvesting_backend_type of this HarvesterUpdateRequest.  # noqa: E501

        Type of external harvesting backend that will provide persistence and analytics for harvested metadata. Can be chosen from predefined backends and optionally custom ones configured by Onezone admins.  # noqa: E501

        :return: The harvesting_backend_type of this HarvesterUpdateRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def harvesting_backend_type(self, harvesting_backend_type):
        """Sets the harvesting_backend_type of this HarvesterUpdateRequest.

        Type of external harvesting backend that will provide persistence and analytics for harvested metadata. Can be chosen from predefined backends and optionally custom ones configured by Onezone admins.  # noqa: E501

        :param harvesting_backend_type: The harvesting_backend_type of this HarvesterUpdateRequest.  # noqa: E501
        :type: str
        """
    ...
    def harvesting_backend_endpoint(self):
        """Gets the harvesting_backend_endpoint of this HarvesterUpdateRequest.  # noqa: E501

        Endpoint where the specified harvesting backend can be reached by Onezone to feed incoming metadata and perform queries. Note that this option should be used only when changing to a new location of the same harvester backend. Otherwise [create a new harvester](#operation/create_harvester).  # noqa: E501

        :return: The harvesting_backend_endpoint of this HarvesterUpdateRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def harvesting_backend_endpoint(self, harvesting_backend_endpoint):
        """Sets the harvesting_backend_endpoint of this HarvesterUpdateRequest.

        Endpoint where the specified harvesting backend can be reached by Onezone to feed incoming metadata and perform queries. Note that this option should be used only when changing to a new location of the same harvester backend. Otherwise [create a new harvester](#operation/create_harvester).  # noqa: E501

        :param harvesting_backend_endpoint: The harvesting_backend_endpoint of this HarvesterUpdateRequest.  # noqa: E501
        :type: str
        """
    ...
    @property
    def public(self):
        """Gets the public of this HarvesterUpdateRequest.  # noqa: E501

        Public harvester allows any user to query its indices.  # noqa: E501

        :return: The public of this HarvesterUpdateRequest.  # noqa: E501
        :rtype: bool
        """
        return self._public
    ...
    def public(self, public):
        """Sets the public of this HarvesterUpdateRequest.

        Public harvester allows any user to query its indices.  # noqa: E501

        :param public: The public of this HarvesterUpdateRequest.  # noqa: E501
        :type: bool
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(HarvesterUpdateRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, HarvesterUpdateRequest):
            return False
