...
class HarvesterQuery(object):
    ...
    def __init__(self, method=None, path=None, body=None):  # noqa: E501
        """HarvesterQuery - a model defined in Swagger"""  # noqa: E501
        self._method = None
        self._path = None
        self._body = None
    ...
    @property
    def method(self):
        """Gets the method of this HarvesterQuery.  # noqa: E501

        Method of request to Elasticsearch.  # noqa: E501

        :return: The method of this HarvesterQuery.  # noqa: E501
        :rtype: str
        """
        return self._method
    ...
    def method(self, method):
        """Sets the method of this HarvesterQuery.

        Method of request to Elasticsearch.  # noqa: E501

        :param method: The method of this HarvesterQuery.  # noqa: E501
        :type: str
        """
        if method is None:
    ...
    @property
    def path(self):
        """Gets the path of this HarvesterQuery.  # noqa: E501

        Resource path relative to index  # noqa: E501

        :return: The path of this HarvesterQuery.  # noqa: E501
        :rtype: str
        """
        return self._path
    ...
    @path.setter
    def path(self, path):
        """Sets the path of this HarvesterQuery.

        Resource path relative to index  # noqa: E501

        :param path: The path of this HarvesterQuery.  # noqa: E501
        :type: str
        """
        if path is None:
    ...
    @property
    def body(self):
        """Gets the body of this HarvesterQuery.  # noqa: E501

        Body of request to Elasticsearch.  # noqa: E501

        :return: The body of this HarvesterQuery.  # noqa: E501
        :rtype: object
        """
        return self._body
    ...
    @body.setter
    def body(self, body):
        """Sets the body of this HarvesterQuery.

        Body of request to Elasticsearch.  # noqa: E501

        :param body: The body of this HarvesterQuery.  # noqa: E501
        :type: object
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(HarvesterQuery, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, HarvesterQuery):
            return False
