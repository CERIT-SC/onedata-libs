...
class HarvesterIndices(object):
    ...
    def __init__(self, harvesters=None):  # noqa: E501
        """HarvesterIndices - a model defined in Swagger"""  # noqa: E501
        self._harvesters = None
        self.discriminator = None
        if harvesters is not None:
            self.harvesters = harvesters

    @property
    def harvesters(self):
        """Gets the harvesters of this HarvesterIndices.  # noqa: E501

        The list of harvester indices Ids.  # noqa: E501

        :return: The harvesters of this HarvesterIndices.  # noqa: E501
        :rtype: list[str]
        """
        return self._harvesters

    @harvesters.setter
    def harvesters(self, harvesters):
        """Sets the harvesters of this HarvesterIndices.

        The list of harvester indices Ids.  # noqa: E501

        :param harvesters: The harvesters of this HarvesterIndices.  # noqa: E501
        :type: list[str]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(HarvesterIndices, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, HarvesterIndices):
            return False
