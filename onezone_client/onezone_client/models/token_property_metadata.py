...
class TokenPropertyMetadata(object):
    ...
    swagger_types = {
        ...
        'usage_count': 'int',
        'privileges': 'list[str]',
        'custom': 'TokenPropertyCustomMetadata'
    }
    ...
    def __init__(self, creation_time=None, usage_limit=None, usage_count=None, privileges=None, custom=None):  # noqa: E501
        """TokenPropertyMetadata - a model defined in Swagger"""  # noqa: E501
    ...
    def creation_time(self):
        """Gets the creation_time of this TokenPropertyMetadata.  # noqa: E501


        :return: The creation_time of this TokenPropertyMetadata.  # noqa: E501
        :rtype: Timestamp
        """
    ...
    def creation_time(self, creation_time):
        """Sets the creation_time of this TokenPropertyMetadata.


        :param creation_time: The creation_time of this TokenPropertyMetadata.  # noqa: E501
        :type: Timestamp
        """
    ...
    def usage_limit(self):
        """Gets the usage_limit of this TokenPropertyMetadata.  # noqa: E501

        (Invite tokens only) limits how many times the token can be consumed - can be a positive integer or the literal string \"infinity\"   # noqa: E501

        :return: The usage_limit of this TokenPropertyMetadata.  # noqa: E501
        :rtype: object
        """
    ...
    def usage_limit(self, usage_limit):
        """Sets the usage_limit of this TokenPropertyMetadata.

        (Invite tokens only) limits how many times the token can be consumed - can be a positive integer or the literal string \"infinity\"   # noqa: E501

        :param usage_limit: The usage_limit of this TokenPropertyMetadata.  # noqa: E501
        :type: object
        """
    ...
    def usage_count(self):
        """Gets the usage_count of this TokenPropertyMetadata.  # noqa: E501

        (Invite tokens only) informs how many times the token has been consumed so far   # noqa: E501

        :return: The usage_count of this TokenPropertyMetadata.  # noqa: E501
        :rtype: int
        """
    ...
    def usage_count(self, usage_count):
        """Sets the usage_count of this TokenPropertyMetadata.

        (Invite tokens only) informs how many times the token has been consumed so far   # noqa: E501

        :param usage_count: The usage_count of this TokenPropertyMetadata.  # noqa: E501
        :type: int
        """
    ...
    @property
    def privileges(self):
        """Gets the privileges of this TokenPropertyMetadata.  # noqa: E501

        (Invite tokens only) the list of privileges that will be granted to the joining user/group upon token consumption   # noqa: E501

        :return: The privileges of this TokenPropertyMetadata.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def privileges(self, privileges):
        """Sets the privileges of this TokenPropertyMetadata.

        (Invite tokens only) the list of privileges that will be granted to the joining user/group upon token consumption   # noqa: E501

        :param privileges: The privileges of this TokenPropertyMetadata.  # noqa: E501
        :type: list[str]
        """
    ...
    @property
    def custom(self):
        """Gets the custom of this TokenPropertyMetadata.  # noqa: E501


        :return: The custom of this TokenPropertyMetadata.  # noqa: E501
    ...
    def custom(self, custom):
        """Sets the custom of this TokenPropertyMetadata.


        :param custom: The custom of this TokenPropertyMetadata.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TokenPropertyMetadata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TokenPropertyMetadata):
            return False
