...
class HandleServicePropertiesUpdate(object):
    ...
    discriminator_value_class_map = {
          'DOIServicePropertiesUpdate': 'DOIServicePropertiesUpdate',
'PIDServicePropertiesUpdate': 'PIDServicePropertiesUpdate'    }

    def __init__(self, type=None):  # noqa: E501
        """HandleServicePropertiesUpdate - a model defined in Swagger"""  # noqa: E501
        self._type = None
    ...
    @property
    def type(self):
        """Gets the type of this HandleServicePropertiesUpdate.  # noqa: E501

        The type of handle service.  # noqa: E501

        :return: The type of this HandleServicePropertiesUpdate.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this HandleServicePropertiesUpdate.

        The type of handle service.  # noqa: E501

        :param type: The type of this HandleServicePropertiesUpdate.  # noqa: E501
        :type: str
        """
        if type is None:
            raise ValueError("Invalid value for `type`, must not be `None`")  # noqa: E501
        allowed_values = ["DOI", "PID"]  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(HandleServicePropertiesUpdate, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, HandleServicePropertiesUpdate):
            return False
