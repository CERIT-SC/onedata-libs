...
class HandleServiceCreateRequest(object):
    ...
    def __init__(self, name=None, proxy_endpoint=None, service_properties=None):  # noqa: E501
        """HandleServiceCreateRequest - a model defined in Swagger"""  # noqa: E501
        self._name = None
    ...
    @property
    def name(self):
        """Gets the name of this HandleServiceCreateRequest.  # noqa: E501

        The user defined name of the service.   # noqa: E501

        :return: The name of this HandleServiceCreateRequest.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this HandleServiceCreateRequest.

        The user defined name of the service.   # noqa: E501

        :param name: The name of this HandleServiceCreateRequest.  # noqa: E501
        :type: str
        """
        if name is None:
    ...
    def proxy_endpoint(self):
        """Gets the proxy_endpoint of this HandleServiceCreateRequest.  # noqa: E501
        ...
        :return: The proxy_endpoint of this HandleServiceCreateRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def proxy_endpoint(self, proxy_endpoint):
        """Sets the proxy_endpoint of this HandleServiceCreateRequest.

        The endpoint of the Handle service proxy, i.e. a service which implements logic specific for particular Handle service.   # noqa: E501

        :param proxy_endpoint: The proxy_endpoint of this HandleServiceCreateRequest.  # noqa: E501
        :type: str
        """
    ...
    def service_properties(self):
        """Gets the service_properties of this HandleServiceCreateRequest.  # noqa: E501


        :return: The service_properties of this HandleServiceCreateRequest.  # noqa: E501
    ...
    def service_properties(self, service_properties):
        """Sets the service_properties of this HandleServiceCreateRequest.


        :param service_properties: The service_properties of this HandleServiceCreateRequest.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(HandleServiceCreateRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, HandleServiceCreateRequest):
            return False
