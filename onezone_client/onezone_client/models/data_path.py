...
class DataPath(Caveat):
    ...
    def __init__(self, type=None, whitelist=None, *args, **kwargs):  # noqa: E501
        """DataPath - a model defined in Swagger"""  # noqa: E501
        self._type = None
    ...
    @property
    def type(self):
        """Gets the type of this DataPath.  # noqa: E501

        Data path caveat - limits the paths in which data can be accessed with the token. The paths must be canonical - starting with a slash + space id and without a trailing slash - and must be base64 encoded. If a directory path is given, the token allows to access all nested files and directories starting from the specified directory.  This is a **data access caveat** - if added to a token, it greatly limits its power in the system APIs, to the minimum required for data access - [see more](https://onedata.org/#/home/documentation/doc/using_onedata/tokens[data-access-caveats].html).  You can learn more about token caveats [here](https://onedata.org/#/home/documentation/doc/using_onedata/tokens[token-caveats].html).   # noqa: E501

        :return: The type of this DataPath.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this DataPath.

        Data path caveat - limits the paths in which data can be accessed with the token. The paths must be canonical - starting with a slash + space id and without a trailing slash - and must be base64 encoded. If a directory path is given, the token allows to access all nested files and directories starting from the specified directory.  This is a **data access caveat** - if added to a token, it greatly limits its power in the system APIs, to the minimum required for data access - [see more](https://onedata.org/#/home/documentation/doc/using_onedata/tokens[data-access-caveats].html).  You can learn more about token caveats [here](https://onedata.org/#/home/documentation/doc/using_onedata/tokens[token-caveats].html).   # noqa: E501

        :param type: The type of this DataPath.  # noqa: E501
        :type: str
        """
        allowed_values = ["data.path"]  # noqa: E501
    ...
    @property
    def whitelist(self):
        """Gets the whitelist of this DataPath.  # noqa: E501

        List of base64 encoded file paths in which data can be accessed using the token.  Example: ```json   {     \"type\": \"data.path\",     \"whitelist\": [       \"L2QxYjM4OGY3Yzc=\",   # /d1b388f7c7       \"L2QxYjM4OGY3YzcvZGlyL2ZpbGUudHh0\"    # /d1b388f7c7/dir/file.txt     ]   } ```   # noqa: E501

        :return: The whitelist of this DataPath.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def whitelist(self, whitelist):
        """Sets the whitelist of this DataPath.

        List of base64 encoded file paths in which data can be accessed using the token.  Example: ```json   {     \"type\": \"data.path\",     \"whitelist\": [       \"L2QxYjM4OGY3Yzc=\",   # /d1b388f7c7       \"L2QxYjM4OGY3YzcvZGlyL2ZpbGUudHh0\"    # /d1b388f7c7/dir/file.txt     ]   } ```   # noqa: E501

        :param whitelist: The whitelist of this DataPath.  # noqa: E501
        :type: list[str]
        """
