...
class IdSpacesBody(object):
    ...
    def __init__(self, name=None):  # noqa: E501
        """IdSpacesBody - a model defined in Swagger"""  # noqa: E501
        self._name = None
    ...
    @property
    def name(self):
        """Gets the name of this IdSpacesBody.  # noqa: E501

        Name of the new space.  # noqa: E501

        :return: The name of this IdSpacesBody.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this IdSpacesBody.

        Name of the new space.  # noqa: E501

        :param name: The name of this IdSpacesBody.  # noqa: E501
        :type: str
        """
        if name is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(IdSpacesBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, IdSpacesBody):
            return False
