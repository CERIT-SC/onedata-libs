...
class HarvesterCreateRequest(object):
    ...
    swagger_types = {
        ...
        'gui_plugin_config': 'HarvesterGuiPluginConfig'
    }
    ...
    def __init__(self, name=None, harvesting_backend_type=None, harvesting_backend_endpoint=None, gui_plugin_config=None):  # noqa: E501
        """HarvesterCreateRequest - a model defined in Swagger"""  # noqa: E501
        self._name = None
        self._harvesting_backend_type = None
        self._harvesting_backend_endpoint = None
        self._gui_plugin_config = None
        self.discriminator = None
        self.name = name
        self.harvesting_backend_type = harvesting_backend_type
        self.harvesting_backend_endpoint = harvesting_backend_endpoint
        if gui_plugin_config is not None:
            self.gui_plugin_config = gui_plugin_config

    @property
    def name(self):
        """Gets the name of this HarvesterCreateRequest.  # noqa: E501

        The name of the harvester.  # noqa: E501

        :return: The name of this HarvesterCreateRequest.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this HarvesterCreateRequest.

        The name of the harvester.  # noqa: E501

        :param name: The name of this HarvesterCreateRequest.  # noqa: E501
        :type: str
        """
        if name is None:
    ...
    def harvesting_backend_type(self):
        """Gets the harvesting_backend_type of this HarvesterCreateRequest.  # noqa: E501
        ...
        :return: The harvesting_backend_type of this HarvesterCreateRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def harvesting_backend_type(self, harvesting_backend_type):
        """Sets the harvesting_backend_type of this HarvesterCreateRequest.

        Type of external harvesting backend that will provide persistence and analytics for harvested metadata. Can be chosen from predefined backends and optionally custom ones configured by Onezone admins. Can be omitted if default harvester backend is set up in Onezone.  # noqa: E501

        :param harvesting_backend_type: The harvesting_backend_type of this HarvesterCreateRequest.  # noqa: E501
        :type: str
        """
    ...
    def harvesting_backend_endpoint(self):
        """Gets the harvesting_backend_endpoint of this HarvesterCreateRequest.  # noqa: E501
        ...
        :return: The harvesting_backend_endpoint of this HarvesterCreateRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def harvesting_backend_endpoint(self, harvesting_backend_endpoint):
        """Sets the harvesting_backend_endpoint of this HarvesterCreateRequest.

        Endpoint where the specified harvesting backend can be reached by Onezone to feed incoming metadata and perform queries. Can be omitted if default harvester backend is set up in Onezone.  # noqa: E501

        :param harvesting_backend_endpoint: The harvesting_backend_endpoint of this HarvesterCreateRequest.  # noqa: E501
        :type: str
        """
    ...
    @property
    def gui_plugin_config(self):
        """Gets the gui_plugin_config of this HarvesterCreateRequest.  # noqa: E501


        :return: The gui_plugin_config of this HarvesterCreateRequest.  # noqa: E501
        :rtype: HarvesterGuiPluginConfig
        """
        return self._gui_plugin_config

    @gui_plugin_config.setter
    def gui_plugin_config(self, gui_plugin_config):
        """Sets the gui_plugin_config of this HarvesterCreateRequest.


        :param gui_plugin_config: The gui_plugin_config of this HarvesterCreateRequest.  # noqa: E501
        :type: HarvesterGuiPluginConfig
        """

        self._gui_plugin_config = gui_plugin_config
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(HarvesterCreateRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, HarvesterCreateRequest):
            return False
