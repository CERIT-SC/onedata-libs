...
class IdPAccessToken(object):
    ...
    def __init__(self, token=None, ttl=None):  # noqa: E501
        """IdPAccessToken - a model defined in Swagger"""  # noqa: E501
        self._token = None
        self._ttl = None
    ...
    @property
    def token(self):
        """Gets the token of this IdPAccessToken.  # noqa: E501

        The access token.  # noqa: E501

        :return: The token of this IdPAccessToken.  # noqa: E501
        :rtype: str
        """
        return self._token
    ...
    def token(self, token):
        """Sets the token of this IdPAccessToken.

        The access token.  # noqa: E501

        :param token: The token of this IdPAccessToken.  # noqa: E501
        :type: str
        """
        if token is None:
    ...
    @property
    def ttl(self):
        """Gets the ttl of this IdPAccessToken.  # noqa: E501

        Time to live of the token (in seconds).  # noqa: E501

        :return: The ttl of this IdPAccessToken.  # noqa: E501
        :rtype: int
        """
        return self._ttl
    ...
    @ttl.setter
    def ttl(self, ttl):
        """Sets the ttl of this IdPAccessToken.

        Time to live of the token (in seconds).  # noqa: E501

        :param ttl: The ttl of this IdPAccessToken.  # noqa: E501
        :type: int
        """
        if ttl is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(IdPAccessToken, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, IdPAccessToken):
            return False
