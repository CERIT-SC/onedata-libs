...
from onepanel_client.api.storages_api import StoragesApi  # noqa: E501
...
class TestStoragesApi(unittest.TestCase):
    ...
    def test_get_storage_details(self):
        """Test case for get_storage_details
