...
**username** | **str** | The Keystone authentication username. | 
**password** | **str** | The Keystone authentication password. | 
**auth_url** | **str** | The URL to OpenStack Keystone identity service. | 
**tenant_name** | **str** | The name of the tenant to which the user belongs. | 
**container_name** | **str** | The name of the Swift storage container. | 
