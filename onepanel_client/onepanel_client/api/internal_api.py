...
class InternalApi(object):
    ...
    def get_remote_provider(self, id, **kwargs):  # noqa: E501
        """Get details of a remote Oneprovider  # noqa: E501

        Returns the details of given provider. Only users belonging to that Oneprovider's cluster can fetch its details.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_remote_provider(id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str id: Id of requested Oneprovider. (required)
        :return: RemoteProviderDetails
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_remote_provider_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_remote_provider_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def get_remote_provider_with_http_info(self, id, **kwargs):  # noqa: E501
        """Get details of a remote Oneprovider  # noqa: E501

        Returns the details of given provider. Only users belonging to that Oneprovider's cluster can fetch its details.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_remote_provider_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method get_remote_provider" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `get_remote_provider`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type='RemoteProviderDetails',  # noqa: E501
    ...
    def health(self, **kwargs):  # noqa: E501
        ...
        Returns status code indicating onepanel service health status. This endpoint does not require authentication.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
