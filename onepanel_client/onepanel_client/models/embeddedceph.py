...
class Embeddedceph(StorageGetDetails):
    ...
    def __init__(self, type=None, timeout=None, skip_storage_detection=False, luma_feed='auto', luma_feed_url=None, luma_feed_api_key=None, qos_parameters=None, imported_storage=False, archive_storage=False, readonly=False, name=None, copies_number=None, min_copies_number=None, block_size=None, storage_path_type='flat', *args, **kwargs):  # noqa: E501
        """Embeddedceph - a model defined in Swagger"""  # noqa: E501
        self._type = None
        self._timeout = None
    ...
    @property
    def type(self):
        """Gets the type of this Embeddedceph.  # noqa: E501
        ...
        :return: The type of this Embeddedceph.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this Embeddedceph.

        The type of storage.  `type = \"embeddedceph\"`  Embedded Ceph cluster that has been deployed during deployment of Oneprovider. For more information on embedded Ceph deployment please see [here](https://onedata.org/#/home/documentation/stable/doc/administering_onedata/ceph_cluster_deployment.html).   # noqa: E501

        :param type: The type of this Embeddedceph.  # noqa: E501
        :type: str
        """
    ...
    @property
    def timeout(self):
        """Gets the timeout of this Embeddedceph.  # noqa: E501

        Storage operation timeout in milliseconds.  # noqa: E501

        :return: The timeout of this Embeddedceph.  # noqa: E501
        :rtype: int
        """
    ...
    def timeout(self, timeout):
        """Sets the timeout of this Embeddedceph.

        Storage operation timeout in milliseconds.  # noqa: E501

        :param timeout: The timeout of this Embeddedceph.  # noqa: E501
        :type: int
        """
    ...
    def skip_storage_detection(self):
        """Gets the skip_storage_detection of this Embeddedceph.  # noqa: E501
        ...
        :return: The skip_storage_detection of this Embeddedceph.  # noqa: E501
        :rtype: bool
        """
    ...
    def skip_storage_detection(self, skip_storage_detection):
        """Sets the skip_storage_detection of this Embeddedceph.

        If true, detecting whether storage is directly accessible by the Oneclient will not be performed. This option should be set to true on readonly storages.   # noqa: E501

        :param skip_storage_detection: The skip_storage_detection of this Embeddedceph.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def luma_feed(self):
        """Gets the luma_feed of this Embeddedceph.  # noqa: E501
        ...
        :return: The luma_feed of this Embeddedceph.  # noqa: E501
        :rtype: str
        """
    ...
    def luma_feed(self, luma_feed):
        """Sets the luma_feed of this Embeddedceph.

        Type of feed for LUMA DB. Feed is a source of user/group mappings used to populate the LUMA DB. For more info please read: https://onedata.org/#/home/documentation/doc/administering_onedata/luma.html   # noqa: E501

        :param luma_feed: The luma_feed of this Embeddedceph.  # noqa: E501
        :type: str
        """
    ...
    def luma_feed_url(self):
        """Gets the luma_feed_url of this Embeddedceph.  # noqa: E501

        URL of external feed for LUMA DB. Relevant only if lumaFeed equals `external`.  # noqa: E501

        :return: The luma_feed_url of this Embeddedceph.  # noqa: E501
        :rtype: str
        """
    ...
    def luma_feed_url(self, luma_feed_url):
        """Sets the luma_feed_url of this Embeddedceph.

        URL of external feed for LUMA DB. Relevant only if lumaFeed equals `external`.  # noqa: E501

        :param luma_feed_url: The luma_feed_url of this Embeddedceph.  # noqa: E501
        :type: str
        """
    ...
    def luma_feed_api_key(self):
        """Gets the luma_feed_api_key of this Embeddedceph.  # noqa: E501

        API key checked by external service used as feed for LUMA DB. Relevant only if lumaFeed equals `external`.   # noqa: E501

        :return: The luma_feed_api_key of this Embeddedceph.  # noqa: E501
        :rtype: str
        """
    ...
    def luma_feed_api_key(self, luma_feed_api_key):
        """Sets the luma_feed_api_key of this Embeddedceph.

        API key checked by external service used as feed for LUMA DB. Relevant only if lumaFeed equals `external`.   # noqa: E501

        :param luma_feed_api_key: The luma_feed_api_key of this Embeddedceph.  # noqa: E501
        :type: str
        """
    ...
    def qos_parameters(self):
        """Gets the qos_parameters of this Embeddedceph.  # noqa: E501

        Map with key-value pairs used for describing storage QoS parameters.  # noqa: E501

        :return: The qos_parameters of this Embeddedceph.  # noqa: E501
        :rtype: dict(str, str)
        """
    ...
    def qos_parameters(self, qos_parameters):
        """Sets the qos_parameters of this Embeddedceph.

        Map with key-value pairs used for describing storage QoS parameters.  # noqa: E501

        :param qos_parameters: The qos_parameters of this Embeddedceph.  # noqa: E501
        :type: dict(str, str)
        """
    ...
    def imported_storage(self):
        """Gets the imported_storage of this Embeddedceph.  # noqa: E501

        Defines whether storage contains existing data to be imported.   # noqa: E501

        :return: The imported_storage of this Embeddedceph.  # noqa: E501
        :rtype: bool
        """
    ...
    def imported_storage(self, imported_storage):
        """Sets the imported_storage of this Embeddedceph.

        Defines whether storage contains existing data to be imported.   # noqa: E501

        :param imported_storage: The imported_storage of this Embeddedceph.  # noqa: E501
        :type: bool
        """
    ...
    def archive_storage(self):
        """Gets the archive_storage of this Embeddedceph.  # noqa: E501

        Defines whether storage supports long-term dataset archiving.   # noqa: E501

        :return: The archive_storage of this Embeddedceph.  # noqa: E501
        :rtype: bool
        """
    ...
    def archive_storage(self, archive_storage):
        """Sets the archive_storage of this Embeddedceph.

        Defines whether storage supports long-term dataset archiving.   # noqa: E501

        :param archive_storage: The archive_storage of this Embeddedceph.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def readonly(self):
        """Gets the readonly of this Embeddedceph.  # noqa: E501
        ...
        :return: The readonly of this Embeddedceph.  # noqa: E501
        :rtype: bool
        """
    ...
    def readonly(self, readonly):
        """Sets the readonly of this Embeddedceph.

        Defines whether the storage is readonly. If enabled, Oneprovider will block any operation that writes, modifies or deletes data on the storage. Such storage can only be used to import data into the space. Mandatory to ensure proper behaviour if the backend storage is actually configured as readonly. This option is available only for imported storages.   # noqa: E501

        :param readonly: The readonly of this Embeddedceph.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def name(self):
        """Gets the name of this Embeddedceph.  # noqa: E501

        Name of the pool.  # noqa: E501

        :return: The name of this Embeddedceph.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this Embeddedceph.

        Name of the pool.  # noqa: E501

        :param name: The name of this Embeddedceph.  # noqa: E501
        :type: str
        """
    ...
    def copies_number(self):
        """Gets the copies_number of this Embeddedceph.  # noqa: E501
        ...
        :return: The copies_number of this Embeddedceph.  # noqa: E501
        :rtype: int
        """
    ...
    def copies_number(self, copies_number):
        """Sets the copies_number of this Embeddedceph.

        Desired number of object replicas in the pool. When below this number the pool still may be used in 'degraded' mode. Defaults to `2` if there are at least 2 OSDs, `1` otherwise.  # noqa: E501

        :param copies_number: The copies_number of this Embeddedceph.  # noqa: E501
        :type: int
        """
    ...
    def min_copies_number(self):
        """Gets the min_copies_number of this Embeddedceph.  # noqa: E501
        ...
        :return: The min_copies_number of this Embeddedceph.  # noqa: E501
        :rtype: int
        """
    ...
    def min_copies_number(self, min_copies_number):
        """Sets the min_copies_number of this Embeddedceph.

        Minimum number of object replicas in the pool. Below this threshold any I/O for the pool is disabled. Must be lower or equal to 'copiesNumber'. Defaults to `min(2, copiesNumber)` if there are at least 2 OSDs, `1` otherwise.  # noqa: E501

        :param min_copies_number: The min_copies_number of this Embeddedceph.  # noqa: E501
        :type: int
        """
    ...
    @property
    def block_size(self):
        """Gets the block_size of this Embeddedceph.  # noqa: E501

        Storage block size in bytes.  # noqa: E501

        :return: The block_size of this Embeddedceph.  # noqa: E501
        :rtype: int
        """
    ...
    def block_size(self, block_size):
        """Sets the block_size of this Embeddedceph.

        Storage block size in bytes.  # noqa: E501

        :param block_size: The block_size of this Embeddedceph.  # noqa: E501
        :type: int
        """
    ...
    def storage_path_type(self):
        """Gets the storage_path_type of this Embeddedceph.  # noqa: E501
        ...
        :return: The storage_path_type of this Embeddedceph.  # noqa: E501
        :rtype: str
        """
    ...
    def storage_path_type(self, storage_path_type):
        """Sets the storage_path_type of this Embeddedceph.

        Determines how the logical file paths will be mapped on the storage. 'canonical' paths reflect the logical file names and directory structure, however each rename operation will require renaming the files on the storage. 'flat' paths are based on unique file UUID's and do not require on-storage rename when logical file name is changed.   # noqa: E501

        :param storage_path_type: The storage_path_type of this Embeddedceph.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(Embeddedceph, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, Embeddedceph):
            return False
