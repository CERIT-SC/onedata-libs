...
class CephCredentials(LumaStorageCredentials):
    ...
    def __init__(self, type=None, username=None, key=None, *args, **kwargs):  # noqa: E501
        """CephCredentials - a model defined in Swagger"""  # noqa: E501
        self._type = None
        self._username = None
        self._key = None
    ...
    @property
    def type(self):
        """Gets the type of this CephCredentials.  # noqa: E501
        ...
        :return: The type of this CephCredentials.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this CephCredentials.

        Type of the storage. Must be given explicitly and must match the actual type of subject storage - this redundancy is needed due to limitations of OpenAPI polymorphism.   # noqa: E501

        :param type: The type of this CephCredentials.  # noqa: E501
        :type: str
        """
        if type is None:
    ...
    @property
    def username(self):
        """Gets the username of this CephCredentials.  # noqa: E501
        ...
        :return: The username of this CephCredentials.  # noqa: E501
        :rtype: str
        """
    ...
    def username(self, username):
        """Sets the username of this CephCredentials.

        The username of the Ceph cluster user. In case of configuring storage, this field must be equal to name of the Ceph cluster admin.   # noqa: E501

        :param username: The username of this CephCredentials.  # noqa: E501
        :type: str
        """
        if username is None:
    ...
    @property
    def key(self):
        """Gets the key of this CephCredentials.  # noqa: E501
        ...
        :return: The key of this CephCredentials.  # noqa: E501
        :rtype: str
        """
        return self._key
    ...
    @key.setter
    def key(self, key):
        """Sets the key of this CephCredentials.

        The key to access the Ceph cluster. In case of configuring storage, the key must be the key of admin user passed in `username`.   # noqa: E501

        :param key: The key of this CephCredentials.  # noqa: E501
        :type: str
        """
        if key is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CephCredentials, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CephCredentials):
            return False
