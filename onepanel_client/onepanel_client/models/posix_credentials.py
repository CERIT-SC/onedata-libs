...
class PosixCredentials(LumaStorageCredentials):
    ...
    def __init__(self, uid=None, gid=None, type=None, *args, **kwargs):  # noqa: E501
        """PosixCredentials - a model defined in Swagger"""  # noqa: E501
        self._uid = None
        self._gid = None
        self._type = None
    ...
    @property
    def uid(self):
        """Gets the uid of this PosixCredentials.  # noqa: E501

        User identifier.  # noqa: E501

        :return: The uid of this PosixCredentials.  # noqa: E501
        :rtype: int
        """
        return self._uid
    ...
    @uid.setter
    def uid(self, uid):
        """Sets the uid of this PosixCredentials.

        User identifier.  # noqa: E501

        :param uid: The uid of this PosixCredentials.  # noqa: E501
        :type: int
        """
    ...
    @property
    def gid(self):
        """Gets the gid of this PosixCredentials.  # noqa: E501

        Group identifier.  # noqa: E501

        :return: The gid of this PosixCredentials.  # noqa: E501
        :rtype: int
        """
        return self._gid
    ...
    @gid.setter
    def gid(self, gid):
        """Sets the gid of this PosixCredentials.

        Group identifier.  # noqa: E501

        :param gid: The gid of this PosixCredentials.  # noqa: E501
        :type: int
        """
    ...
    @property
    def type(self):
        """Gets the type of this PosixCredentials.  # noqa: E501
        ...
        :return: The type of this PosixCredentials.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this PosixCredentials.

        Type of the storage. Must be given explicitly and must match the actual type of subject storage - this redundancy is needed due to limitations of OpenAPI polymorphism.   # noqa: E501

        :param type: The type of this PosixCredentials.  # noqa: E501
        :type: str
        """
        if type is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PosixCredentials, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PosixCredentials):
            return False
