...
class LumaConfig(object):
    ...
    def __init__(self, luma_feed=None, luma_feed_url=None, luma_feed_api_key=None):  # noqa: E501
        """LumaConfig - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def luma_feed(self):
        """Gets the luma_feed of this LumaConfig.  # noqa: E501
        ...
        :return: The luma_feed of this LumaConfig.  # noqa: E501
        :rtype: str
        """
    ...
    def luma_feed(self, luma_feed):
        """Sets the luma_feed of this LumaConfig.

        Type of feed for LUMA DB. Feed is a source of user/group mappings used to populate the LUMA DB. For more info please read: https://onedata.org/#/home/documentation/doc/administering_onedata/luma.html   # noqa: E501

        :param luma_feed: The luma_feed of this LumaConfig.  # noqa: E501
        :type: str
        """
        if luma_feed is None:
            raise ValueError("Invalid value for `luma_feed`, must not be `None`")  # noqa: E501
    ...
    def luma_feed_url(self):
        """Gets the luma_feed_url of this LumaConfig.  # noqa: E501

        URL of external feed for LUMA DB. Relevant only if lumaFeed equals `external`.   # noqa: E501

        :return: The luma_feed_url of this LumaConfig.  # noqa: E501
        :rtype: str
        """
    ...
    def luma_feed_url(self, luma_feed_url):
        """Sets the luma_feed_url of this LumaConfig.

        URL of external feed for LUMA DB. Relevant only if lumaFeed equals `external`.   # noqa: E501

        :param luma_feed_url: The luma_feed_url of this LumaConfig.  # noqa: E501
        :type: str
        """
    ...
    def luma_feed_api_key(self):
        """Gets the luma_feed_api_key of this LumaConfig.  # noqa: E501

        API key checked by external service used as feed for LUMA DB. Relevant only if lumaFeed equals `external`.   # noqa: E501

        :return: The luma_feed_api_key of this LumaConfig.  # noqa: E501
        :rtype: str
        """
    ...
    def luma_feed_api_key(self, luma_feed_api_key):
        """Sets the luma_feed_api_key of this LumaConfig.

        API key checked by external service used as feed for LUMA DB. Relevant only if lumaFeed equals `external`.   # noqa: E501

        :param luma_feed_api_key: The luma_feed_api_key of this LumaConfig.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, LumaConfig):
            return False
