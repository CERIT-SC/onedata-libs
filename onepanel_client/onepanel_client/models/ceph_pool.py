...
class CephPool(object):
    ...
    def __init__(self, name=None, copies_number=None, min_copies_number=None):  # noqa: E501
        """CephPool - a model defined in Swagger"""  # noqa: E501
        self._name = None
    ...
    @property
    def name(self):
        """Gets the name of this CephPool.  # noqa: E501

        Name of the pool.  # noqa: E501

        :return: The name of this CephPool.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this CephPool.

        Name of the pool.  # noqa: E501

        :param name: The name of this CephPool.  # noqa: E501
        :type: str
        """
    ...
    def copies_number(self):
        """Gets the copies_number of this CephPool.  # noqa: E501
        ...
        :return: The copies_number of this CephPool.  # noqa: E501
        :rtype: int
        """
    ...
    def copies_number(self, copies_number):
        """Sets the copies_number of this CephPool.

        Desired number of object replicas in the pool. When below this number the pool still may be used in 'degraded' mode. Defaults to `2` if there are at least 2 OSDs, `1` otherwise.  # noqa: E501

        :param copies_number: The copies_number of this CephPool.  # noqa: E501
        :type: int
        """
    ...
    def min_copies_number(self):
        """Gets the min_copies_number of this CephPool.  # noqa: E501
        ...
        :return: The min_copies_number of this CephPool.  # noqa: E501
        :rtype: int
        """
    ...
    def min_copies_number(self, min_copies_number):
        """Sets the min_copies_number of this CephPool.

        Minimum number of object replicas in the pool. Below this threshold any I/O for the pool is disabled. Must be lower or equal to 'copiesNumber'. Defaults to `min(2, copiesNumber)` if there are at least 2 OSDs, `1` otherwise.  # noqa: E501

        :param min_copies_number: The min_copies_number of this CephPool.  # noqa: E501
        :type: int
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CephPool):
            return False
