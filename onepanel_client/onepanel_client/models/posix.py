...
class Posix(StorageGetDetails):
    ...
    def __init__(self, type=None, timeout=None, skip_storage_detection=False, luma_feed='auto', luma_feed_url=None, luma_feed_api_key=None, qos_parameters=None, imported_storage=False, archive_storage=False, readonly=False, mount_point=None, storage_path_type='canonical', root_uid=None, root_gid=None, *args, **kwargs):  # noqa: E501
        """Posix - a model defined in Swagger"""  # noqa: E501
        self._type = None
        self._timeout = None
        ...
        if root_gid is not None:
            self.root_gid = root_gid
        StorageGetDetails.__init__(self, *args, **kwargs)

    @property
    def type(self):
        """Gets the type of this Posix.  # noqa: E501

        The type of storage.  `type = \"posix\"`  Any POSIX compatible storage, typically attached over high-throughput local network, such as NFS.   # noqa: E501

        :return: The type of this Posix.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this Posix.

        The type of storage.  `type = \"posix\"`  Any POSIX compatible storage, typically attached over high-throughput local network, such as NFS.   # noqa: E501

        :param type: The type of this Posix.  # noqa: E501
        :type: str
        """
        if type is None:
            raise ValueError("Invalid value for `type`, must not be `None`")  # noqa: E501
        allowed_values = ["posix"]  # noqa: E501
    ...
    @property
    def timeout(self):
        """Gets the timeout of this Posix.  # noqa: E501

        Storage operation timeout in milliseconds.  # noqa: E501

        :return: The timeout of this Posix.  # noqa: E501
        :rtype: int
        """
    ...
    def timeout(self, timeout):
        """Sets the timeout of this Posix.

        Storage operation timeout in milliseconds.  # noqa: E501

        :param timeout: The timeout of this Posix.  # noqa: E501
        :type: int
        """
    ...
    def skip_storage_detection(self):
        """Gets the skip_storage_detection of this Posix.  # noqa: E501
        ...
        :return: The skip_storage_detection of this Posix.  # noqa: E501
        :rtype: bool
        """
    ...
    def skip_storage_detection(self, skip_storage_detection):
        """Sets the skip_storage_detection of this Posix.

        If true, detecting whether storage is directly accessible by the Oneclient will not be performed. This option should be set to true on readonly storages.   # noqa: E501

        :param skip_storage_detection: The skip_storage_detection of this Posix.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def luma_feed(self):
        """Gets the luma_feed of this Posix.  # noqa: E501
        ...
        :return: The luma_feed of this Posix.  # noqa: E501
        :rtype: str
        """
    ...
    def luma_feed(self, luma_feed):
        """Sets the luma_feed of this Posix.

        Type of feed for LUMA DB. Feed is a source of user/group mappings used to populate the LUMA DB. For more info please read: https://onedata.org/#/home/documentation/doc/administering_onedata/luma.html   # noqa: E501

        :param luma_feed: The luma_feed of this Posix.  # noqa: E501
        :type: str
        """
    ...
    def luma_feed_url(self):
        """Gets the luma_feed_url of this Posix.  # noqa: E501

        URL of external feed for LUMA DB. Relevant only if lumaFeed equals `external`.  # noqa: E501

        :return: The luma_feed_url of this Posix.  # noqa: E501
        :rtype: str
        """
    ...
    def luma_feed_url(self, luma_feed_url):
        """Sets the luma_feed_url of this Posix.

        URL of external feed for LUMA DB. Relevant only if lumaFeed equals `external`.  # noqa: E501

        :param luma_feed_url: The luma_feed_url of this Posix.  # noqa: E501
        :type: str
        """
    ...
    def luma_feed_api_key(self, luma_feed_api_key):
        """Sets the luma_feed_api_key of this Posix.

        API key checked by external service used as feed for LUMA DB. Relevant only if lumaFeed equals `external`.   # noqa: E501

        :param luma_feed_api_key: The luma_feed_api_key of this Posix.  # noqa: E501
        :type: str
        """
    ...
    def qos_parameters(self):
        """Gets the qos_parameters of this Posix.  # noqa: E501

        Map with key-value pairs used for describing storage QoS parameters.  # noqa: E501

        :return: The qos_parameters of this Posix.  # noqa: E501
        :rtype: dict(str, str)
        """
    ...
    def qos_parameters(self, qos_parameters):
        """Sets the qos_parameters of this Posix.

        Map with key-value pairs used for describing storage QoS parameters.  # noqa: E501

        :param qos_parameters: The qos_parameters of this Posix.  # noqa: E501
        :type: dict(str, str)
        """
    ...
    def imported_storage(self):
        """Gets the imported_storage of this Posix.  # noqa: E501

        Defines whether storage contains existing data to be imported.   # noqa: E501

        :return: The imported_storage of this Posix.  # noqa: E501
        :rtype: bool
        """
    ...
    def imported_storage(self, imported_storage):
        """Sets the imported_storage of this Posix.

        Defines whether storage contains existing data to be imported.   # noqa: E501

        :param imported_storage: The imported_storage of this Posix.  # noqa: E501
        :type: bool
        """
    ...
    def archive_storage(self):
        """Gets the archive_storage of this Posix.  # noqa: E501

        Defines whether storage supports long-term dataset archiving.   # noqa: E501

        :return: The archive_storage of this Posix.  # noqa: E501
        :rtype: bool
        """
    ...
    def archive_storage(self, archive_storage):
        """Sets the archive_storage of this Posix.

        Defines whether storage supports long-term dataset archiving.   # noqa: E501

        :param archive_storage: The archive_storage of this Posix.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def readonly(self):
        """Gets the readonly of this Posix.  # noqa: E501
        ...
        :return: The readonly of this Posix.  # noqa: E501
        :rtype: bool
        """
    ...
    def readonly(self, readonly):
        """Sets the readonly of this Posix.

        Defines whether the storage is readonly. If enabled, Oneprovider will block any operation that writes, modifies or deletes data on the storage. Such storage can only be used to import data into the space. Mandatory to ensure proper behaviour if the backend storage is actually configured as readonly. This option is available only for imported storages.   # noqa: E501

        :param readonly: The readonly of this Posix.  # noqa: E501
        :type: bool
        """
    ...
    def mount_point(self):
        """Gets the mount_point of this Posix.  # noqa: E501

        The absolute path to the directory where the POSIX storage is mounted on the cluster nodes.   # noqa: E501

        :return: The mount_point of this Posix.  # noqa: E501
        :rtype: str
        """
    ...
    def mount_point(self, mount_point):
        """Sets the mount_point of this Posix.

        The absolute path to the directory where the POSIX storage is mounted on the cluster nodes.   # noqa: E501

        :param mount_point: The mount_point of this Posix.  # noqa: E501
        :type: str
        """
    ...
    def storage_path_type(self):
        """Gets the storage_path_type of this Posix.  # noqa: E501
        ...
        :return: The storage_path_type of this Posix.  # noqa: E501
        :rtype: str
        """
    ...
    def storage_path_type(self, storage_path_type):
        """Sets the storage_path_type of this Posix.

        Determines how the logical file paths will be mapped on the storage. 'canonical' paths reflect the logical file names and directory structure, however each rename operation will require renaming the files on the storage. 'flat' paths are based on unique file UUID's and do not require on-storage rename when logical file name is changed. **Note that 'flat' paths are not allowed on this type of storage.**   # noqa: E501

        :param storage_path_type: The storage_path_type of this Posix.  # noqa: E501
        :type: str
        """
    ...
    @property
    def root_uid(self):
        """Gets the root_uid of this Posix.  # noqa: E501

        UID of the user on whose behalf operations in the admin context will be performed on the storage.  # noqa: E501

        :return: The root_uid of this Posix.  # noqa: E501
        :rtype: int
        """
        return self._root_uid

    @root_uid.setter
    def root_uid(self, root_uid):
        """Sets the root_uid of this Posix.

        UID of the user on whose behalf operations in the admin context will be performed on the storage.  # noqa: E501

        :param root_uid: The root_uid of this Posix.  # noqa: E501
        :type: int
        """
    ...
    @property
    def root_gid(self):
        """Gets the root_gid of this Posix.  # noqa: E501

        GID of the group on whose behalf operations in the admin context will be performed on the storage.  # noqa: E501

        :return: The root_gid of this Posix.  # noqa: E501
        :rtype: int
        """
        return self._root_gid

    @root_gid.setter
    def root_gid(self, root_gid):
        """Sets the root_gid of this Posix.

        GID of the group on whose behalf operations in the admin context will be performed on the storage.  # noqa: E501

        :param root_gid: The root_gid of this Posix.  # noqa: E501
        :type: int
        """
