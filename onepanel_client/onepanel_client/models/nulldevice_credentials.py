...
class NulldeviceCredentials(LumaStorageCredentials):
    ...
    def __init__(self, uid=None, gid=None, type=None, *args, **kwargs):  # noqa: E501
        """NulldeviceCredentials - a model defined in Swagger"""  # noqa: E501
        self._uid = None
        self._gid = None
        self._type = None
    ...
    @property
    def uid(self):
        """Gets the uid of this NulldeviceCredentials.  # noqa: E501

        User identifier.  # noqa: E501

        :return: The uid of this NulldeviceCredentials.  # noqa: E501
        :rtype: int
        """
        return self._uid
    ...
    @uid.setter
    def uid(self, uid):
        """Sets the uid of this NulldeviceCredentials.

        User identifier.  # noqa: E501

        :param uid: The uid of this NulldeviceCredentials.  # noqa: E501
        :type: int
        """
    ...
    @property
    def gid(self):
        """Gets the gid of this NulldeviceCredentials.  # noqa: E501

        Group identifier.  # noqa: E501

        :return: The gid of this NulldeviceCredentials.  # noqa: E501
        :rtype: int
        """
        return self._gid
    ...
    @gid.setter
    def gid(self, gid):
        """Sets the gid of this NulldeviceCredentials.

        Group identifier.  # noqa: E501

        :param gid: The gid of this NulldeviceCredentials.  # noqa: E501
        :type: int
        """
    ...
    @property
    def type(self):
        """Gets the type of this NulldeviceCredentials.  # noqa: E501
        ...
        :return: The type of this NulldeviceCredentials.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this NulldeviceCredentials.

        Type of the storage. Must be given explicitly and must match the actual type of subject storage - this redundancy is needed due to limitations of OpenAPI polymorphism.   # noqa: E501

        :param type: The type of this NulldeviceCredentials.  # noqa: E501
        :type: str
        """
        if type is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(NulldeviceCredentials, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, NulldeviceCredentials):
            return False
