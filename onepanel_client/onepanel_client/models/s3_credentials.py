...
class S3Credentials(LumaStorageCredentials):
    ...
    def __init__(self, type=None, access_key='', secret_key='', *args, **kwargs):  # noqa: E501
        """S3Credentials - a model defined in Swagger"""  # noqa: E501
        self._type = None
    ...
    @property
    def type(self):
        """Gets the type of this S3Credentials.  # noqa: E501
        ...
        :return: The type of this S3Credentials.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this S3Credentials.

        Type of the storage. Must be given explicitly and must match the actual type of subject storage - this redundancy is needed due to limitations of OpenAPI polymorphism.   # noqa: E501

        :param type: The type of this S3Credentials.  # noqa: E501
        :type: str
        """
        if type is None:
    ...
    @property
    def access_key(self):
        """Gets the access_key of this S3Credentials.  # noqa: E501

        The access key to the S3 storage.  # noqa: E501

        :return: The access_key of this S3Credentials.  # noqa: E501
        :rtype: str
        """
    ...
    def access_key(self, access_key):
        """Sets the access_key of this S3Credentials.

        The access key to the S3 storage.  # noqa: E501

        :param access_key: The access_key of this S3Credentials.  # noqa: E501
        :type: str
        """
    ...
    @property
    def secret_key(self):
        """Gets the secret_key of this S3Credentials.  # noqa: E501

        The secret key to the S3 storage.  # noqa: E501

        :return: The secret_key of this S3Credentials.  # noqa: E501
        :rtype: str
        """
    ...
    def secret_key(self, secret_key):
        """Sets the secret_key of this S3Credentials.

        The secret key to the S3 storage.  # noqa: E501

        :param secret_key: The secret_key of this S3Credentials.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(S3Credentials, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, S3Credentials):
            return False
