...
class HTTP(StorageGetDetails):
    ...
    @property
    def timeout(self):
        """Gets the timeout of this HTTP.  # noqa: E501

        Storage operation timeout in milliseconds.  # noqa: E501

        :return: The timeout of this HTTP.  # noqa: E501
        :rtype: int
        """
    ...
    def timeout(self, timeout):
        """Sets the timeout of this HTTP.

        Storage operation timeout in milliseconds.  # noqa: E501

        :param timeout: The timeout of this HTTP.  # noqa: E501
        :type: int
        """
    ...
    def skip_storage_detection(self):
        """Gets the skip_storage_detection of this HTTP.  # noqa: E501
        ...
        :return: The skip_storage_detection of this HTTP.  # noqa: E501
        :rtype: bool
        """
    ...
    def skip_storage_detection(self, skip_storage_detection):
        """Sets the skip_storage_detection of this HTTP.

        If true, detecting whether storage is directly accessible by the Oneclient will not be performed. This option should be set to true on readonly storages.   # noqa: E501

        :param skip_storage_detection: The skip_storage_detection of this HTTP.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def luma_feed(self):
        """Gets the luma_feed of this HTTP.  # noqa: E501
        ...
        :return: The luma_feed of this HTTP.  # noqa: E501
        :rtype: str
        """
    ...
    def luma_feed(self, luma_feed):
        """Sets the luma_feed of this HTTP.

        Type of feed for LUMA DB. Feed is a source of user/group mappings used to populate the LUMA DB. For more info please read: https://onedata.org/#/home/documentation/doc/administering_onedata/luma.html   # noqa: E501

        :param luma_feed: The luma_feed of this HTTP.  # noqa: E501
        :type: str
        """
    ...
    def luma_feed_url(self):
        """Gets the luma_feed_url of this HTTP.  # noqa: E501

        URL of external feed for LUMA DB. Relevant only if lumaFeed equals `external`.  # noqa: E501

        :return: The luma_feed_url of this HTTP.  # noqa: E501
        :rtype: str
        """
    ...
    def luma_feed_url(self, luma_feed_url):
        """Sets the luma_feed_url of this HTTP.

        URL of external feed for LUMA DB. Relevant only if lumaFeed equals `external`.  # noqa: E501

        :param luma_feed_url: The luma_feed_url of this HTTP.  # noqa: E501
        :type: str
        """
    ...
    def luma_feed_api_key(self, luma_feed_api_key):
        """Sets the luma_feed_api_key of this HTTP.

        API key checked by external service used as feed for LUMA DB. Relevant only if lumaFeed equals `external`.   # noqa: E501

        :param luma_feed_api_key: The luma_feed_api_key of this HTTP.  # noqa: E501
        :type: str
        """
    ...
    def qos_parameters(self):
        """Gets the qos_parameters of this HTTP.  # noqa: E501

        Map with key-value pairs used for describing storage QoS parameters.  # noqa: E501

        :return: The qos_parameters of this HTTP.  # noqa: E501
        :rtype: dict(str, str)
        """
    ...
    def qos_parameters(self, qos_parameters):
        """Sets the qos_parameters of this HTTP.

        Map with key-value pairs used for describing storage QoS parameters.  # noqa: E501

        :param qos_parameters: The qos_parameters of this HTTP.  # noqa: E501
        :type: dict(str, str)
        """
    ...
    def imported_storage(self):
        """Gets the imported_storage of this HTTP.  # noqa: E501

        Defines whether storage contains existing data to be imported.   # noqa: E501

        :return: The imported_storage of this HTTP.  # noqa: E501
        :rtype: bool
        """
    ...
    def imported_storage(self, imported_storage):
        """Sets the imported_storage of this HTTP.

        Defines whether storage contains existing data to be imported.   # noqa: E501

        :param imported_storage: The imported_storage of this HTTP.  # noqa: E501
        :type: bool
        """
    ...
    def archive_storage(self):
        """Gets the archive_storage of this HTTP.  # noqa: E501

        Defines whether storage supports long-term dataset archiving.   # noqa: E501

        :return: The archive_storage of this HTTP.  # noqa: E501
        :rtype: bool
        """
    ...
    def archive_storage(self, archive_storage):
        """Sets the archive_storage of this HTTP.

        Defines whether storage supports long-term dataset archiving.   # noqa: E501

        :param archive_storage: The archive_storage of this HTTP.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def readonly(self):
        """Gets the readonly of this HTTP.  # noqa: E501
        ...
        :return: The readonly of this HTTP.  # noqa: E501
        :rtype: bool
        """
    ...
    def readonly(self, readonly):
        """Sets the readonly of this HTTP.

        Defines whether the storage is readonly. If enabled, Oneprovider will block any operation that writes, modifies or deletes data on the storage. Such storage can only be used to import data into the space. Mandatory to ensure proper behaviour if the backend storage is actually configured as readonly. This option is available only for imported storages.   # noqa: E501

        :param readonly: The readonly of this HTTP.  # noqa: E501
        :type: bool
        """
    ...
    def credentials_type(self):
        """Gets the credentials_type of this HTTP.  # noqa: E501

        Determines the types of credentials provided in the credentials field.   # noqa: E501

        :return: The credentials_type of this HTTP.  # noqa: E501
        :rtype: str
        """
    ...
    def credentials_type(self, credentials_type):
        """Sets the credentials_type of this HTTP.

        Determines the types of credentials provided in the credentials field.   # noqa: E501

        :param credentials_type: The credentials_type of this HTTP.  # noqa: E501
        :type: str
        """
    ...
    def credentials(self):
        """Gets the credentials of this HTTP.  # noqa: E501

        The credentials to authenticate with the HTTP server. `basic` credentials should be provided in the form `username:password`, for `token` just the token. In case of `oauth2`, this field should contain the username for the HTTP, while the token will be obtained and refreshed automatically in the background. For `none` this field is ignored.   # noqa: E501

        :return: The credentials of this HTTP.  # noqa: E501
        :rtype: str
        """
    ...
    def credentials(self, credentials):
        """Sets the credentials of this HTTP.

        The credentials to authenticate with the HTTP server. `basic` credentials should be provided in the form `username:password`, for `token` just the token. In case of `oauth2`, this field should contain the username for the HTTP, while the token will be obtained and refreshed automatically in the background. For `none` this field is ignored.   # noqa: E501

        :param credentials: The credentials of this HTTP.  # noqa: E501
        :type: str
        """
    ...
    def oauth2_id_p(self):
        """Gets the oauth2_id_p of this HTTP.  # noqa: E501

        In case `oauth2` credential type is selected and Onezone is configured with support for multiple external IdP's, this field must contain the name of the IdP which authenticates requests to the HTTP endpoint. If Onezone has only one external IdP, it will be selected automatically.   # noqa: E501

        :return: The oauth2_id_p of this HTTP.  # noqa: E501
        :rtype: str
        """
    ...
    def oauth2_id_p(self, oauth2_id_p):
        """Sets the oauth2_id_p of this HTTP.

        In case `oauth2` credential type is selected and Onezone is configured with support for multiple external IdP's, this field must contain the name of the IdP which authenticates requests to the HTTP endpoint. If Onezone has only one external IdP, it will be selected automatically.   # noqa: E501

        :param oauth2_id_p: The oauth2_id_p of this HTTP.  # noqa: E501
        :type: str
        """
    ...
    def onedata_access_token(self):
        """Gets the onedata_access_token of this HTTP.  # noqa: E501

        When registering storage with feed of LUMA DB set to`auto` and with `oauth2` external IdP, this field must contain a valid Onedata access token of the user on whose behalf the HTTP storage will be accessed by all users with access to any space supported by this storage.   # noqa: E501

        :return: The onedata_access_token of this HTTP.  # noqa: E501
        :rtype: str
        """
    ...
    def onedata_access_token(self, onedata_access_token):
        """Sets the onedata_access_token of this HTTP.

        When registering storage with feed of LUMA DB set to`auto` and with `oauth2` external IdP, this field must contain a valid Onedata access token of the user on whose behalf the HTTP storage will be accessed by all users with access to any space supported by this storage.   # noqa: E501

        :param onedata_access_token: The onedata_access_token of this HTTP.  # noqa: E501
        :type: str
        """
    ...
    @property
    def endpoint(self):
        """Gets the endpoint of this HTTP.  # noqa: E501

        Full URL of the HTTP server, including scheme (http or https) and path.   # noqa: E501

        :return: The endpoint of this HTTP.  # noqa: E501
        :rtype: str
        """
    ...
    def endpoint(self, endpoint):
        """Sets the endpoint of this HTTP.

        Full URL of the HTTP server, including scheme (http or https) and path.   # noqa: E501

        :param endpoint: The endpoint of this HTTP.  # noqa: E501
        :type: str
        """
        if endpoint is None:
    ...
    def verify_server_certificate(self):
        """Gets the verify_server_certificate of this HTTP.  # noqa: E501

        Determines whether Oneprovider should verify the certificate of the HTTP server.   # noqa: E501

        :return: The verify_server_certificate of this HTTP.  # noqa: E501
        :rtype: bool
        """
    ...
    def verify_server_certificate(self, verify_server_certificate):
        """Sets the verify_server_certificate of this HTTP.

        Determines whether Oneprovider should verify the certificate of the HTTP server.   # noqa: E501

        :param verify_server_certificate: The verify_server_certificate of this HTTP.  # noqa: E501
        :type: bool
        """
    ...
    def authorization_header(self):
        """Gets the authorization_header of this HTTP.  # noqa: E501
        ...
        :return: The authorization_header of this HTTP.  # noqa: E501
        :rtype: str
        """
    ...
    def authorization_header(self, authorization_header):
        """Sets the authorization_header of this HTTP.

        The authorization header to be used for passing the access token. This field can contain any prefix that should be added to the header value. Default is `Authorization: Bearer {}`. The token will placed where `{}` is provided.   # noqa: E501

        :param authorization_header: The authorization_header of this HTTP.  # noqa: E501
        :type: str
        """
    ...
    def connection_pool_size(self):
        """Gets the connection_pool_size of this HTTP.  # noqa: E501

        Defines the maximum number of parallel connections for a single HTTP storage.   # noqa: E501

        :return: The connection_pool_size of this HTTP.  # noqa: E501
        :rtype: int
        """
    ...
    def connection_pool_size(self, connection_pool_size):
        """Sets the connection_pool_size of this HTTP.

        Defines the maximum number of parallel connections for a single HTTP storage.   # noqa: E501

        :param connection_pool_size: The connection_pool_size of this HTTP.  # noqa: E501
        :type: int
        """
    ...
    def max_requests_per_session(self):
        """Gets the max_requests_per_session of this HTTP.  # noqa: E501
        ...
        :return: The max_requests_per_session of this HTTP.  # noqa: E501
        :rtype: int
        """
    ...
    def max_requests_per_session(self, max_requests_per_session):
        """Sets the max_requests_per_session of this HTTP.

        Defines the maximum number of requests performed in a single HTTP session. After the limit is reached, 'Connection: close' header is sent to the server. When set to 0 (default), number of requests per session is unlimited, unless imposed by the server.   # noqa: E501

        :param max_requests_per_session: The max_requests_per_session of this HTTP.  # noqa: E501
        :type: int
        """
    ...
    @property
    def file_mode(self):
        """Gets the file_mode of this HTTP.  # noqa: E501
        ...
        :return: The file_mode of this HTTP.  # noqa: E501
        :rtype: str
        """
    ...
    def file_mode(self, file_mode):
        """Sets the file_mode of this HTTP.

        Defines the file permissions, which files imported from HTTP storage will have in Onedata. Values should be provided in octal format e.g. `0664`.   # noqa: E501

        :param file_mode: The file_mode of this HTTP.  # noqa: E501
        :type: str
        """
    ...
    def storage_path_type(self):
        """Gets the storage_path_type of this HTTP.  # noqa: E501
        ...
        :return: The storage_path_type of this HTTP.  # noqa: E501
        :rtype: str
        """
    ...
    def storage_path_type(self, storage_path_type):
        """Sets the storage_path_type of this HTTP.

        Determines how the logical file paths will be mapped on the storage. 'canonical' paths reflect the logical file names and directory structure, however each rename operation will require renaming the files on the storage. 'flat' paths are based on unique file UUID's and do not require on-storage rename when logical file name is changed.   # noqa: E501

        :param storage_path_type: The storage_path_type of this HTTP.  # noqa: E501
        :type: str
        """
