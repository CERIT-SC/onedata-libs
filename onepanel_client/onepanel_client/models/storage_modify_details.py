...
class StorageModifyDetails(object):
...
'PosixModify': 'PosixModify'    }
    ...
    def __init__(self, name=None, timeout=None, skip_storage_detection=None, luma_feed=None, luma_feed_url=None, luma_feed_api_key=None, qos_parameters=None, imported_storage=None, archive_storage=None, readonly=None):  # noqa: E501
        """StorageModifyDetails - a model defined in Swagger"""  # noqa: E501
        self._name = None
        self._timeout = None
    ...
    @property
    def name(self):
        """Gets the name of this StorageModifyDetails.  # noqa: E501

        The name of storage.  # noqa: E501

        :return: The name of this StorageModifyDetails.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this StorageModifyDetails.

        The name of storage.  # noqa: E501

        :param name: The name of this StorageModifyDetails.  # noqa: E501
        :type: str
        """
    ...
    @property
    def timeout(self):
        """Gets the timeout of this StorageModifyDetails.  # noqa: E501

        Storage operation timeout in milliseconds.  # noqa: E501

        :return: The timeout of this StorageModifyDetails.  # noqa: E501
        :rtype: int
        """
    ...
    def timeout(self, timeout):
        """Sets the timeout of this StorageModifyDetails.

        Storage operation timeout in milliseconds.  # noqa: E501

        :param timeout: The timeout of this StorageModifyDetails.  # noqa: E501
        :type: int
        """
    ...
    def skip_storage_detection(self):
        """Gets the skip_storage_detection of this StorageModifyDetails.  # noqa: E501
        ...
        :return: The skip_storage_detection of this StorageModifyDetails.  # noqa: E501
        :rtype: bool
        """
    ...
    def skip_storage_detection(self, skip_storage_detection):
        """Sets the skip_storage_detection of this StorageModifyDetails.

        If true, detecting whether storage is directly accessible by the Oneclient will not be performed. This option should be set to true on readonly storages.   # noqa: E501

        :param skip_storage_detection: The skip_storage_detection of this StorageModifyDetails.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def luma_feed(self):
        """Gets the luma_feed of this StorageModifyDetails.  # noqa: E501
        ...
        :return: The luma_feed of this StorageModifyDetails.  # noqa: E501
        :rtype: str
        """
    ...
    def luma_feed(self, luma_feed):
        """Sets the luma_feed of this StorageModifyDetails.

        Type of feed for LUMA DB. Feed is a source of user/group mappings used to populate the LUMA DB. For more info please read: https://onedata.org/#/home/documentation/doc/administering_onedata/luma.html   # noqa: E501

        :param luma_feed: The luma_feed of this StorageModifyDetails.  # noqa: E501
        :type: str
        """
    ...
    def luma_feed_url(self):
        """Gets the luma_feed_url of this StorageModifyDetails.  # noqa: E501

        URL of external feed for LUMA DB. Relevant only if lumaFeed equals `external`.  # noqa: E501

        :return: The luma_feed_url of this StorageModifyDetails.  # noqa: E501
        :rtype: str
        """
    ...
    def luma_feed_url(self, luma_feed_url):
        """Sets the luma_feed_url of this StorageModifyDetails.

        URL of external feed for LUMA DB. Relevant only if lumaFeed equals `external`.  # noqa: E501

        :param luma_feed_url: The luma_feed_url of this StorageModifyDetails.  # noqa: E501
        :type: str
        """
    ...
    def luma_feed_api_key(self):
        """Gets the luma_feed_api_key of this StorageModifyDetails.  # noqa: E501

        API key checked by external service used as feed for LUMA DB. Relevant only if lumaFeed equals `external`.   # noqa: E501

        :return: The luma_feed_api_key of this StorageModifyDetails.  # noqa: E501
        :rtype: str
        """
    ...
    def luma_feed_api_key(self, luma_feed_api_key):
        """Sets the luma_feed_api_key of this StorageModifyDetails.

        API key checked by external service used as feed for LUMA DB. Relevant only if lumaFeed equals `external`.   # noqa: E501

        :param luma_feed_api_key: The luma_feed_api_key of this StorageModifyDetails.  # noqa: E501
        :type: str
        """
    ...
    def qos_parameters(self):
        """Gets the qos_parameters of this StorageModifyDetails.  # noqa: E501

        Map with key-value pairs used for describing storage QoS parameters. Overrides all previously set parameters.  # noqa: E501

        :return: The qos_parameters of this StorageModifyDetails.  # noqa: E501
        :rtype: dict(str, str)
        """
    ...
    def qos_parameters(self, qos_parameters):
        """Sets the qos_parameters of this StorageModifyDetails.

        Map with key-value pairs used for describing storage QoS parameters. Overrides all previously set parameters.  # noqa: E501

        :param qos_parameters: The qos_parameters of this StorageModifyDetails.  # noqa: E501
        :type: dict(str, str)
        """
    ...
    def imported_storage(self):
        """Gets the imported_storage of this StorageModifyDetails.  # noqa: E501

        Defines whether storage contains existing data to be imported.   # noqa: E501

        :return: The imported_storage of this StorageModifyDetails.  # noqa: E501
        :rtype: bool
        """
    ...
    def imported_storage(self, imported_storage):
        """Sets the imported_storage of this StorageModifyDetails.

        Defines whether storage contains existing data to be imported.   # noqa: E501

        :param imported_storage: The imported_storage of this StorageModifyDetails.  # noqa: E501
        :type: bool
        """
    ...
    def archive_storage(self):
        """Gets the archive_storage of this StorageModifyDetails.  # noqa: E501

        Defines whether storage supports long-term dataset archiving.   # noqa: E501

        :return: The archive_storage of this StorageModifyDetails.  # noqa: E501
        :rtype: bool
        """
    ...
    def archive_storage(self, archive_storage):
        """Sets the archive_storage of this StorageModifyDetails.

        Defines whether storage supports long-term dataset archiving.   # noqa: E501

        :param archive_storage: The archive_storage of this StorageModifyDetails.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def readonly(self):
        """Gets the readonly of this StorageModifyDetails.  # noqa: E501
        ...
        :return: The readonly of this StorageModifyDetails.  # noqa: E501
        :rtype: bool
        """
    ...
    def readonly(self, readonly):
        """Sets the readonly of this StorageModifyDetails.

        Defines whether the storage is readonly. If enabled, Oneprovider will block any operation that writes, modifies or deletes data on the storage. Such storage can only be used to import data into the space. Mandatory to ensure proper behaviour if the backend storage is actually configured as readonly. This option is available only for imported storages.   # noqa: E501

        :param readonly: The readonly of this StorageModifyDetails.  # noqa: E501
        :type: bool
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(StorageModifyDetails, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, StorageModifyDetails):
            return False
