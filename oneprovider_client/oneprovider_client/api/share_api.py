...
class ShareApi(object):
    ...
    def create_share(self, body, **kwargs):  # noqa: E501
        ...
        :param ShareCreateRequest body: Share properties. (required)
        ...
        if kwargs.get('async_req'):
            return self.create_share_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.create_share_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def create_share_with_http_info(self, body, **kwargs):  # noqa: E501
        """Create share  # noqa: E501

        Shares a file or a directory. Shared files can be viewed by everyone through public URL. This operation assigns a share Id that can be used to manage share, see:   * [Get basic information about share](#operation/get_share)   * [List shares associated with file or directory](#operation/list_file_shares_by_id)   * [Change name of the share](#operation/update_share)   * [Remove share](#operation/remove_share)  Any number of shares can be associated with each file or directory.  This operation requires `space_manage_share` privilege.  ***Example cURL requests***  **Create share** ```bash curl -H \"X-Auth-Token: $TOKEN\" -X POST \"https://$PROVIDER_HOST/api/v3/oneprovider/shares\" \\ -H \"Content-Type: application/json\" -d '{\"name\": \"MyShare\", \"rootFileId\": \"'$FILE_ID'\"}' ```   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_share_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `create_share`")  # noqa: E501
    ...
    def get_share(self, shid, **kwargs):  # noqa: E501
        """Get share info  # noqa: E501

        Returns the basic information about share.  ***Example cURL requests***  **Get the basic information about share** ```bash curl -H \"X-Auth-Token: $TOKEN\" -X GET \"https://$PROVIDER_HOST/api/v3/oneprovider/shares/$SHARE_ID\"  {     \"shareId\": \"1f4b762b1380946e73aeca574c77f14c\",     \"name\": \"Experiment XYZ\",     \"description\": \"# Experiment XYZ\\nThis collection contains results from Experiment XYZ.\",     \"publicUrl\": \"https://onedata.org/shares/1f4b762b1380946e73aeca574c77f14c\",     \"rootFileType\": \"DIR\",     \"rootFileId\": \"00000000006CB663736861726547756964233339643236366165646365...\",     \"spaceId\": \"6ec1a5413b6f4e2b01a5c85a8fd797e2\",     \"handleId\" \"doi:10.15911/MyShares.726855\" } ```   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_share(shid, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str shid: Share Id (required)
        :return: Share
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_share_with_http_info(shid, **kwargs)  # noqa: E501
        else:
            (data) = self.get_share_with_http_info(shid, **kwargs)  # noqa: E501
            return data

    def get_share_with_http_info(self, shid, **kwargs):  # noqa: E501
        """Get share info  # noqa: E501

        Returns the basic information about share.  ***Example cURL requests***  **Get the basic information about share** ```bash curl -H \"X-Auth-Token: $TOKEN\" -X GET \"https://$PROVIDER_HOST/api/v3/oneprovider/shares/$SHARE_ID\"  {     \"shareId\": \"1f4b762b1380946e73aeca574c77f14c\",     \"name\": \"Experiment XYZ\",     \"description\": \"# Experiment XYZ\\nThis collection contains results from Experiment XYZ.\",     \"publicUrl\": \"https://onedata.org/shares/1f4b762b1380946e73aeca574c77f14c\",     \"rootFileType\": \"DIR\",     \"rootFileId\": \"00000000006CB663736861726547756964233339643236366165646365...\",     \"spaceId\": \"6ec1a5413b6f4e2b01a5c85a8fd797e2\",     \"handleId\" \"doi:10.15911/MyShares.726855\" } ```   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_share_with_http_info(shid, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            ...
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'shid' is set
        if ('shid' not in params or
                params['shid'] is None):
            raise ValueError("Missing the required parameter `shid` when calling `get_share`")  # noqa: E501

        collection_formats = {}

        path_params = {}
        if 'shid' in params:
            path_params['shid'] = params['shid']  # noqa: E501
    ...
    def remove_share(self, shid, **kwargs):  # noqa: E501
        """Remove share  # noqa: E501

        Removes a specific share. This operation will not remove data from shared file or directory but it will not be accessible through public url anymore.  This operation requires `space_manage_share` privilege.  ***Example cURL requests***  **Remove share** ```bash curl -H \"X-Auth-Token: $TOKEN\" \\ -X DELETE \"https://$PROVIDER_HOST/api/v3/oneprovider/shares/$SHARE_ID\" ```   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.remove_share(shid, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.remove_share_with_http_info(shid, **kwargs)  # noqa: E501
        else:
            (data) = self.remove_share_with_http_info(shid, **kwargs)  # noqa: E501
            return data

    def remove_share_with_http_info(self, shid, **kwargs):  # noqa: E501
        """Remove share  # noqa: E501

        Removes a specific share. This operation will not remove data from shared file or directory but it will not be accessible through public url anymore.  This operation requires `space_manage_share` privilege.  ***Example cURL requests***  **Remove share** ```bash curl -H \"X-Auth-Token: $TOKEN\" \\ -X DELETE \"https://$PROVIDER_HOST/api/v3/oneprovider/shares/$SHARE_ID\" ```   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.remove_share_with_http_info(shid, async_req=True)
        >>> result = thread.get()
        ...
        if ('shid' not in params or
                params['shid'] is None):
            raise ValueError("Missing the required parameter `shid` when calling `remove_share`")  # noqa: E501
    ...
    def update_share(self, body, shid, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_share(body, shid, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param SharesShidBody body: New share details (required)
        :param str shid: Share Id (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_share_with_http_info(body, shid, **kwargs)  # noqa: E501
        else:
            (data) = self.update_share_with_http_info(body, shid, **kwargs)  # noqa: E501
            return data

    def update_share_with_http_info(self, body, shid, **kwargs):  # noqa: E501
        """Update share  # noqa: E501

        Changes name and/or description of the share.  This operation requires `space_manage_share` privilege.  ***Example cURL requests***  **Change name of the share** ```bash curl -H \"X-Auth-Token: $TOKEN\" -X PATCH \"https://$PROVIDER_HOST/api/v3/oneprovider/shares/$SHARE_ID\" \\ -H \"Content-Type: application/json\" -d '{     \"name\": \"NewShareName\",     \"description\": \"# New description\" }' ```   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_share_with_http_info(body, shid, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['body', 'shid']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `update_share`")  # noqa: E501
        # verify the required parameter 'shid' is set
        if ('shid' not in params or
                params['shid'] is None):
            raise ValueError("Missing the required parameter `shid` when calling `update_share`")  # noqa: E501
