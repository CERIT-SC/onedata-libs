...
class FileDistributionApi(object):
    ...
    def get_file_distribution(self, id, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            return self.get_file_distribution_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_file_distribution_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def get_file_distribution_with_http_info(self, id, **kwargs):  # noqa: E501
        """Get file distribution  # noqa: E501

        Returns information about distribution of a specific file among different storage providers.  ***Example cURL requests***  **Get file distribution** ```bash curl -H \"X-Auth-Token: $TOKEN\" -X GET \"https://$PROVIDER_HOST/api/v3/oneprovider/data/$FILE_ID/distribution\"  {   \"type\": \"REG\"   \"distributionPerProvider\": {     \"$PROVIDER_ID1\": {       \"success\": true       \"logicalSize\": 8       \"distributionPerStorage\": {         \"$STORAGE_ID\": {           \"blocks\": [[0, 4], [6, 2]]           \"physicalSize\": 6         }       }     }     \"$PROVIDER_ID2\": {       \"success\": false       \"distributionPerStorage\": {         \"$STORAGE_ID\": {           \"error\": {             \"description\": \"Operation failed with POSIX error: enoent.\"             \"details\": {               \"errno\": \"enoent\"             }           }         }       }     }   } } ```   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_file_distribution_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method get_file_distribution" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `get_file_distribution`")  # noqa: E501
    ...
    def get_file_storage_locations(self, id, **kwargs):  # noqa: E501
        """Get file storage locations  # noqa: E501

        Returns information about regular file location on each storage. `null` value for a storage  means that there is no file replica on this storage.  ***Example cURL requests***  **Get file storage locations** ```bash curl -H \"X-Auth-Token: $TOKEN\" -X GET \"https://$PROVIDER_HOST/api/v3/oneprovider/data/$FILE_ID/storage_locations\"  {   \"locationsPerProvider\": {     \"$PROVIDER_ID1\": {       \"locationsPerStorage\": {         \"$STORAGE_ID1\": \"path/to/file\"       }     },     \"$PROVIDER_ID2\": {       \"locationsPerStorage\": {         \"$STORAGE_ID2\": null       }     }   } } ```   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_file_storage_locations(id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str id: The Id of the file (required)
        :return: StorageFileLocations
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_file_storage_locations_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_file_storage_locations_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def get_file_storage_locations_with_http_info(self, id, **kwargs):  # noqa: E501
        """Get file storage locations  # noqa: E501

        Returns information about regular file location on each storage. `null` value for a storage  means that there is no file replica on this storage.  ***Example cURL requests***  **Get file storage locations** ```bash curl -H \"X-Auth-Token: $TOKEN\" -X GET \"https://$PROVIDER_HOST/api/v3/oneprovider/data/$FILE_ID/storage_locations\"  {   \"locationsPerProvider\": {     \"$PROVIDER_ID1\": {       \"locationsPerStorage\": {         \"$STORAGE_ID1\": \"path/to/file\"       }     },     \"$PROVIDER_ID2\": {       \"locationsPerStorage\": {         \"$STORAGE_ID2\": null       }     }   } } ```   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_file_storage_locations_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_file_storage_locations" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `get_file_storage_locations`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='StorageFileLocations',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
