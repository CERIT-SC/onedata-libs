...
class MonitoringApi(object):
    ...
    def get_space_changes(self, body, sid, **kwargs):  # noqa: E501
        """Subscribe to file events  # noqa: E501

        This method subscribes through HTTP streaming on events of specific type for a given space.  Until the connection is kept alive, the events will be streamed to subscribers as soon as they are occur. The optional `timeout` parameter can be used to automatically disconnect  when no events occur in a given time window.  This operation requires `space_view_changes_stream` privilege.  ***Example cURL requests***  **Listen to space change events** ```bash curl -N -H \"X-Auth-Token: $TOKEN\" \\ -X POST \"https://$PROVIDER_HOST/api/v3/oneprovider/changes/metadata/$SPACE_ID\" \\ -H \"Content-Type: application/json\" -d \"@./changes_req.json\" ```   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_space_changes(body, sid, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param MetadataChangesStreamRequest body: Specification of metadata changes to observe. (required)
        :param str sid: Space Id. (required)
        :param int timeout: Optional timeout in milliseconds, which allows to automatically break connection when no event occured in specified time. By default the timeout is unlimited. 
        :param int last_seq: Last known file metadata sequence number 
        :return: MetadataChangesEvent
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_space_changes_with_http_info(body, sid, **kwargs)  # noqa: E501
        else:
            (data) = self.get_space_changes_with_http_info(body, sid, **kwargs)  # noqa: E501
            return data

    def get_space_changes_with_http_info(self, body, sid, **kwargs):  # noqa: E501
        """Subscribe to file events  # noqa: E501

        This method subscribes through HTTP streaming on events of specific type for a given space.  Until the connection is kept alive, the events will be streamed to subscribers as soon as they are occur. The optional `timeout` parameter can be used to automatically disconnect  when no events occur in a given time window.  This operation requires `space_view_changes_stream` privilege.  ***Example cURL requests***  **Listen to space change events** ```bash curl -N -H \"X-Auth-Token: $TOKEN\" \\ -X POST \"https://$PROVIDER_HOST/api/v3/oneprovider/changes/metadata/$SPACE_ID\" \\ -H \"Content-Type: application/json\" -d \"@./changes_req.json\" ```   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_space_changes_with_http_info(body, sid, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['body', 'sid', 'timeout', 'last_seq']  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method get_space_changes" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `get_space_changes`")  # noqa: E501
        # verify the required parameter 'sid' is set
        if ('sid' not in params or
                params['sid'] is None):
            raise ValueError("Missing the required parameter `sid` when calling `get_space_changes`")  # noqa: E501
        ...
        if 'last_seq' in params:
            query_params.append(('last_seq', params['last_seq']))  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type='MetadataChangesEvent',  # noqa: E501
