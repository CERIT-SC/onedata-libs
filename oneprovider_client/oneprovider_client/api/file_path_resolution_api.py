...
class FilePathResolutionApi(object):
    ...
    def lookup_file_id(self, path, **kwargs):  # noqa: E501
        """Lookup file id  # noqa: E501

        Returns Id of file or directory specified by path.  ***Example cURL requests***  **Lookup file id** ```bash curl -H \"X-Auth-Token: $TOKEN\" \\ -X POST \"https://$PROVIDER_HOST/api/v3/oneprovider/lookup-file-id/MySpace/dir/readme.txt\"  {   \"fileId\": \"094576776E667431723230677767776C6B497031394E445F6E3868677873...\" } ```   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.lookup_file_id(path, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str path: File path (e.g. '/MySpace/dir/readme.txt') (required)
        ...
        if kwargs.get('async_req'):
            return self.lookup_file_id_with_http_info(path, **kwargs)  # noqa: E501
        else:
            (data) = self.lookup_file_id_with_http_info(path, **kwargs)  # noqa: E501
            return data

    def lookup_file_id_with_http_info(self, path, **kwargs):  # noqa: E501
        """Lookup file id  # noqa: E501

        Returns Id of file or directory specified by path.  ***Example cURL requests***  **Lookup file id** ```bash curl -H \"X-Auth-Token: $TOKEN\" \\ -X POST \"https://$PROVIDER_HOST/api/v3/oneprovider/lookup-file-id/MySpace/dir/readme.txt\"  {   \"fileId\": \"094576776E667431723230677767776C6B497031394E445F6E3868677873...\" } ```   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.lookup_file_id_with_http_info(path, async_req=True)
        >>> result = thread.get()
        ...
        if ('path' not in params or
                params['path'] is None):
            raise ValueError("Missing the required parameter `path` when calling `lookup_file_id`")  # noqa: E501
