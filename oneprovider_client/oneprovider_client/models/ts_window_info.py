...
class TSWindowInfo(object):
    ...
    swagger_types = {
        'timestamp': 'int',
        'value': 'float',
        'first_measurement_timestamp': 'int',
        'last_measurement_timestamp': 'int'
    }
    ...
    def __init__(self, timestamp=None, value=None, first_measurement_timestamp=None, last_measurement_timestamp=None):  # noqa: E501
        """TSWindowInfo - a model defined in Swagger"""  # noqa: E501
        self._timestamp = None
        self._value = None
        self._first_measurement_timestamp = None
        self._last_measurement_timestamp = None
        self.discriminator = None
        self.timestamp = timestamp
        self.value = value
        if first_measurement_timestamp is not None:
            self.first_measurement_timestamp = first_measurement_timestamp
        if last_measurement_timestamp is not None:
            self.last_measurement_timestamp = last_measurement_timestamp

    @property
    def timestamp(self):
        """Gets the timestamp of this TSWindowInfo.  # noqa: E501

        Timestamp of the beginning of the time window, treated as the ID of the window.  # noqa: E501

        :return: The timestamp of this TSWindowInfo.  # noqa: E501
        :rtype: int
        """
    ...
    def timestamp(self, timestamp):
        """Sets the timestamp of this TSWindowInfo.

        Timestamp of the beginning of the time window, treated as the ID of the window.  # noqa: E501

        :param timestamp: The timestamp of this TSWindowInfo.  # noqa: E501
        :type: int
        """
    ...
    @property
    def value(self):
        """Gets the value of this TSWindowInfo.  # noqa: E501

        Value of the window, representing aggregated measurements.  # noqa: E501

        :return: The value of this TSWindowInfo.  # noqa: E501
        :rtype: float
        """
        return self._value
    ...
    def value(self, value):
        """Sets the value of this TSWindowInfo.

        Value of the window, representing aggregated measurements.  # noqa: E501

        :param value: The value of this TSWindowInfo.  # noqa: E501
        :type: float
        """
        if value is None:
    ...
    @property
    def first_measurement_timestamp(self):
        """Gets the first_measurement_timestamp of this TSWindowInfo.  # noqa: E501

        The timestamp of the first measurement falling within this time window.  # noqa: E501

        :return: The first_measurement_timestamp of this TSWindowInfo.  # noqa: E501
        :rtype: int
        """
        return self._first_measurement_timestamp

    @first_measurement_timestamp.setter
    def first_measurement_timestamp(self, first_measurement_timestamp):
        """Sets the first_measurement_timestamp of this TSWindowInfo.

        The timestamp of the first measurement falling within this time window.  # noqa: E501

        :param first_measurement_timestamp: The first_measurement_timestamp of this TSWindowInfo.  # noqa: E501
        :type: int
        """

        self._first_measurement_timestamp = first_measurement_timestamp

    @property
    def last_measurement_timestamp(self):
        """Gets the last_measurement_timestamp of this TSWindowInfo.  # noqa: E501

        The timestamp of the last measurement falling within this time window.  # noqa: E501

        :return: The last_measurement_timestamp of this TSWindowInfo.  # noqa: E501
        :rtype: int
        """
        return self._last_measurement_timestamp

    @last_measurement_timestamp.setter
    def last_measurement_timestamp(self, last_measurement_timestamp):
        """Sets the last_measurement_timestamp of this TSWindowInfo.

        The timestamp of the last measurement falling within this time window.  # noqa: E501

        :param last_measurement_timestamp: The last_measurement_timestamp of this TSWindowInfo.  # noqa: E501
        :type: int
        """

        self._last_measurement_timestamp = last_measurement_timestamp
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TSWindowInfo, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TSWindowInfo):
            return False
