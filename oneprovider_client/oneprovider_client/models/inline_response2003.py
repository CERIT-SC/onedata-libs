...
class InlineResponse2003(object):
    ...
    """
    swagger_types = {
        'matching_storages': 'list[StorageDetails]'
    }

    attribute_map = {
        'matching_storages': 'matchingStorages'
    }

    def __init__(self, matching_storages=None):  # noqa: E501
        """InlineResponse2003 - a model defined in Swagger"""  # noqa: E501
        self._matching_storages = None
        self.discriminator = None
        if matching_storages is not None:
            self.matching_storages = matching_storages

    @property
    def matching_storages(self):
        """Gets the matching_storages of this InlineResponse2003.  # noqa: E501


        :return: The matching_storages of this InlineResponse2003.  # noqa: E501
        :rtype: list[StorageDetails]
        """
        return self._matching_storages

    @matching_storages.setter
    def matching_storages(self, matching_storages):
        """Sets the matching_storages of this InlineResponse2003.


        :param matching_storages: The matching_storages of this InlineResponse2003.  # noqa: E501
        :type: list[StorageDetails]
        """

        self._matching_storages = matching_storages
