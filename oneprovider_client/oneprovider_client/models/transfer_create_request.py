...
class TransferCreateRequest(object):
...
'view': 'View'    }
    ...
    def __init__(self, type=None, replicating_provider_id=None, evicting_provider_id=None, callback=None, data_source_type=None):  # noqa: E501
        """TransferCreateRequest - a model defined in Swagger"""  # noqa: E501
        self._type = None
        self._replicating_provider_id = None
        self._evicting_provider_id = None
        self._callback = None
        self._data_source_type = None
        self.discriminator = 'data_source_type'
        self.type = type
    ...
    @property
    def type(self):
        """Gets the type of this TransferCreateRequest.  # noqa: E501

        Requested type of transfer. Depending on selected type specifying also `replicatingProviderId`, `evictingProviderId` or both may be required.   # noqa: E501

        :return: The type of this TransferCreateRequest.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this TransferCreateRequest.

        Requested type of transfer. Depending on selected type specifying also `replicatingProviderId`, `evictingProviderId` or both may be required.   # noqa: E501

        :param type: The type of this TransferCreateRequest.  # noqa: E501
        :type: str
        """
        if type is None:
    ...
    def replicating_provider_id(self):
        """Gets the replicating_provider_id of this TransferCreateRequest.  # noqa: E501

        Id of provider to which data will be copied, ensuring that the provider has a complete replica at the end of the process. The data will be copied from one or more providers in the space that hold replicas or some fragments.   # noqa: E501

        :return: The replicating_provider_id of this TransferCreateRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def replicating_provider_id(self, replicating_provider_id):
        """Sets the replicating_provider_id of this TransferCreateRequest.

        Id of provider to which data will be copied, ensuring that the provider has a complete replica at the end of the process. The data will be copied from one or more providers in the space that hold replicas or some fragments.   # noqa: E501

        :param replicating_provider_id: The replicating_provider_id of this TransferCreateRequest.  # noqa: E501
        :type: str
        """
    ...
    def evicting_provider_id(self):
        """Gets the evicting_provider_id of this TransferCreateRequest.  # noqa: E501

        Id of provider from which replica(s) are to be removed. Eviction is safe - will succeed only if there is at least one complete replica (accumulated) on other providers in the space.   # noqa: E501

        :return: The evicting_provider_id of this TransferCreateRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def evicting_provider_id(self, evicting_provider_id):
        """Sets the evicting_provider_id of this TransferCreateRequest.

        Id of provider from which replica(s) are to be removed. Eviction is safe - will succeed only if there is at least one complete replica (accumulated) on other providers in the space.   # noqa: E501

        :param evicting_provider_id: The evicting_provider_id of this TransferCreateRequest.  # noqa: E501
        :type: str
        """
    ...
    @property
    def callback(self):
        """Gets the callback of this TransferCreateRequest.  # noqa: E501

        This parameter allows the user to specify a REST callback URL which will be called (http `POST` request with transfer Id in body) when the transfer is complete.   # noqa: E501

        :return: The callback of this TransferCreateRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def callback(self, callback):
        """Sets the callback of this TransferCreateRequest.

        This parameter allows the user to specify a REST callback URL which will be called (http `POST` request with transfer Id in body) when the transfer is complete.   # noqa: E501

        :param callback: The callback of this TransferCreateRequest.  # noqa: E501
        :type: str
        """
    ...
    def data_source_type(self):
        """Gets the data_source_type of this TransferCreateRequest.  # noqa: E501


        :return: The data_source_type of this TransferCreateRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def data_source_type(self, data_source_type):
        """Sets the data_source_type of this TransferCreateRequest.


        :param data_source_type: The data_source_type of this TransferCreateRequest.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TransferCreateRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TransferCreateRequest):
            return False
