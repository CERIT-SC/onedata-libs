...
class AtmWorkflowExecutionDetailsLanes(object):
    ...
    swagger_types = {
        'schema_id': 'str',
        'runs': 'list[AtmWorkflowExecutionLaneRunDetails]'
    }
    ...
    def __init__(self, schema_id=None, runs=None):  # noqa: E501
        """AtmWorkflowExecutionDetailsLanes - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def schema_id(self):
        """Gets the schema_id of this AtmWorkflowExecutionDetailsLanes.  # noqa: E501

        Id of the lane schema used for this execution.  # noqa: E501

        :return: The schema_id of this AtmWorkflowExecutionDetailsLanes.  # noqa: E501
        :rtype: str
        """
    ...
    def schema_id(self, schema_id):
        """Sets the schema_id of this AtmWorkflowExecutionDetailsLanes.

        Id of the lane schema used for this execution.  # noqa: E501

        :param schema_id: The schema_id of this AtmWorkflowExecutionDetailsLanes.  # noqa: E501
        :type: str
        """
    ...
    @property
    def runs(self):
        """Gets the runs of this AtmWorkflowExecutionDetailsLanes.  # noqa: E501

        Basic information about lane's runs.  # noqa: E501

        :return: The runs of this AtmWorkflowExecutionDetailsLanes.  # noqa: E501
        :rtype: list[AtmWorkflowExecutionLaneRunDetails]
        """
        return self._runs

    @runs.setter
    def runs(self, runs):
        """Sets the runs of this AtmWorkflowExecutionDetailsLanes.

        Basic information about lane's runs.  # noqa: E501

        :param runs: The runs of this AtmWorkflowExecutionDetailsLanes.  # noqa: E501
        :type: list[AtmWorkflowExecutionLaneRunDetails]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AtmWorkflowExecutionDetailsLanes, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AtmWorkflowExecutionDetailsLanes):
            return False
