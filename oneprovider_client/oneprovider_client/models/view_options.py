...
class ViewOptions(object):
    ...
    """
    swagger_types = {
        'update_min_changes': 'int',
        'replica_update_min_changes': 'int'
    }

    attribute_map = {
        'update_min_changes': 'update_min_changes',
        'replica_update_min_changes': 'replica_update_min_changes'
    }

    def __init__(self, update_min_changes=None, replica_update_min_changes=None):  # noqa: E501
        """ViewOptions - a model defined in Swagger"""  # noqa: E501
        self._update_min_changes = None
        self._replica_update_min_changes = None
        self.discriminator = None
        if update_min_changes is not None:
            self.update_min_changes = update_min_changes
        if replica_update_min_changes is not None:
            self.replica_update_min_changes = replica_update_min_changes

    @property
    def update_min_changes(self):
        """Gets the update_min_changes of this ViewOptions.  # noqa: E501

        Minimum number of document changes to trigger re-viewing.  # noqa: E501

        :return: The update_min_changes of this ViewOptions.  # noqa: E501
        :rtype: int
        """
        return self._update_min_changes

    @update_min_changes.setter
    def update_min_changes(self, update_min_changes):
        """Sets the update_min_changes of this ViewOptions.

        Minimum number of document changes to trigger re-viewing.  # noqa: E501

        :param update_min_changes: The update_min_changes of this ViewOptions.  # noqa: E501
        :type: int
        """

        self._update_min_changes = update_min_changes

    @property
    def replica_update_min_changes(self):
        """Gets the replica_update_min_changes of this ViewOptions.  # noqa: E501

        Minimum number of document changes to trigger re-viewing of a replica index.  # noqa: E501

        :return: The replica_update_min_changes of this ViewOptions.  # noqa: E501
        :rtype: int
        """
        return self._replica_update_min_changes

    @replica_update_min_changes.setter
    def replica_update_min_changes(self, replica_update_min_changes):
        """Sets the replica_update_min_changes of this ViewOptions.

        Minimum number of document changes to trigger re-viewing of a replica index.  # noqa: E501

        :param replica_update_min_changes: The replica_update_min_changes of this ViewOptions.  # noqa: E501
        :type: int
        """

        self._replica_update_min_changes = replica_update_min_changes
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ViewOptions, dict):
