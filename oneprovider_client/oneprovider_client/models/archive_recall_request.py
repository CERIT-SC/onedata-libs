...
class ArchiveRecallRequest(object):
    ...
    def __init__(self, parent_directory_id=None, target_file_name=None):  # noqa: E501
        """ArchiveRecallRequest - a model defined in Swagger"""  # noqa: E501
    ...
    def parent_directory_id(self):
        """Gets the parent_directory_id of this ArchiveRecallRequest.  # noqa: E501

        Id of a parent directory where the target directory will be created.  # noqa: E501

        :return: The parent_directory_id of this ArchiveRecallRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def parent_directory_id(self, parent_directory_id):
        """Sets the parent_directory_id of this ArchiveRecallRequest.

        Id of a parent directory where the target directory will be created.  # noqa: E501

        :param parent_directory_id: The parent_directory_id of this ArchiveRecallRequest.  # noqa: E501
        :type: str
        """
    ...
    def target_file_name(self):
        """Gets the target_file_name of this ArchiveRecallRequest.  # noqa: E501

        Name of the file/directory that will be created as the root of the recalled archive. If not specified, defaults to the dataset's name.   # noqa: E501

        :return: The target_file_name of this ArchiveRecallRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def target_file_name(self, target_file_name):
        """Sets the target_file_name of this ArchiveRecallRequest.

        Name of the file/directory that will be created as the root of the recalled archive. If not specified, defaults to the dataset's name.   # noqa: E501

        :param target_file_name: The target_file_name of this ArchiveRecallRequest.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ArchiveRecallRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ArchiveRecallRequest):
            return False
