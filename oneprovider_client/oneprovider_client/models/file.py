...
class File(TransferCreateRequest):
    ...
    def __init__(self, data_source_type=None, file_id=None, *args, **kwargs):  # noqa: E501
    ...
    def data_source_type(self):
        """Gets the data_source_type of this File.  # noqa: E501

        Indicates the method of determining files to be transferred.  `type = \"file\"` - this transfer covers a single file or a whole directory (recursively). When scheduling such transfer, the user must have permissions to access the file/directory.   # noqa: E501

        :return: The data_source_type of this File.  # noqa: E501
        :rtype: str
        """
    ...
    def data_source_type(self, data_source_type):
        """Sets the data_source_type of this File.

        Indicates the method of determining files to be transferred.  `type = \"file\"` - this transfer covers a single file or a whole directory (recursively). When scheduling such transfer, the user must have permissions to access the file/directory.   # noqa: E501

        :param data_source_type: The data_source_type of this File.  # noqa: E501
        :type: str
        """
    ...
    def file_id(self):
        ...
        Id of file to be transferred.  # noqa: E501
