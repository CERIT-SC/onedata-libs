...
class DatasetUpdateRequest(object):
    ...
    swagger_types = {
        'state': 'DatasetState',
        'set_protection_flags': 'DatasetProtectionFlags',
        'unset_protection_flags': 'DatasetProtectionFlags'
    }

    attribute_map = {
        'state': 'state',
        'set_protection_flags': 'setProtectionFlags',
        'unset_protection_flags': 'unsetProtectionFlags'
    }

    def __init__(self, state=None, set_protection_flags=None, unset_protection_flags=None):  # noqa: E501
        """DatasetUpdateRequest - a model defined in Swagger"""  # noqa: E501
        self._state = None
        self._set_protection_flags = None
        self._unset_protection_flags = None
        self.discriminator = None
        if state is not None:
            self.state = state
        if set_protection_flags is not None:
            self.set_protection_flags = set_protection_flags
        if unset_protection_flags is not None:
            self.unset_protection_flags = unset_protection_flags

    @property
    def state(self):
        """Gets the state of this DatasetUpdateRequest.  # noqa: E501


        :return: The state of this DatasetUpdateRequest.  # noqa: E501
        :rtype: DatasetState
        """
        return self._state
    ...
    def state(self, state):
        """Sets the state of this DatasetUpdateRequest.


        :param state: The state of this DatasetUpdateRequest.  # noqa: E501
        :type: DatasetState
        """
    ...
    @property
    def set_protection_flags(self):
        """Gets the set_protection_flags of this DatasetUpdateRequest.  # noqa: E501


        :return: The set_protection_flags of this DatasetUpdateRequest.  # noqa: E501
        :rtype: DatasetProtectionFlags
        """
        return self._set_protection_flags

    @set_protection_flags.setter
    def set_protection_flags(self, set_protection_flags):
        """Sets the set_protection_flags of this DatasetUpdateRequest.


        :param set_protection_flags: The set_protection_flags of this DatasetUpdateRequest.  # noqa: E501
        :type: DatasetProtectionFlags
        """

        self._set_protection_flags = set_protection_flags

    @property
    def unset_protection_flags(self):
        """Gets the unset_protection_flags of this DatasetUpdateRequest.  # noqa: E501


        :return: The unset_protection_flags of this DatasetUpdateRequest.  # noqa: E501
        :rtype: DatasetProtectionFlags
        """
        return self._unset_protection_flags

    @unset_protection_flags.setter
    def unset_protection_flags(self, unset_protection_flags):
        """Sets the unset_protection_flags of this DatasetUpdateRequest.


        :param unset_protection_flags: The unset_protection_flags of this DatasetUpdateRequest.  # noqa: E501
        :type: DatasetProtectionFlags
        """

        self._unset_protection_flags = unset_protection_flags
