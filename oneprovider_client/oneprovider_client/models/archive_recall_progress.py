...
class ArchiveRecallProgress(object):
    ...
    def __init__(self, files_copied=None, bytes_copied=None, files_failed=None):  # noqa: E501
        """ArchiveRecallProgress - a model defined in Swagger"""  # noqa: E501
        self._files_copied = None
    ...
    def files_copied(self):
        """Gets the files_copied of this ArchiveRecallProgress.  # noqa: E501

        Number of files copied so far.  # noqa: E501

        :return: The files_copied of this ArchiveRecallProgress.  # noqa: E501
        :rtype: int
        """
        return self._files_copied

    @files_copied.setter
    def files_copied(self, files_copied):
        """Sets the files_copied of this ArchiveRecallProgress.

        Number of files copied so far.  # noqa: E501

        :param files_copied: The files_copied of this ArchiveRecallProgress.  # noqa: E501
        :type: int
        """
        if files_copied is None:
            raise ValueError("Invalid value for `files_copied`, must not be `None`")  # noqa: E501

        self._files_copied = files_copied

    @property
    def bytes_copied(self):
        """Gets the bytes_copied of this ArchiveRecallProgress.  # noqa: E501

        Number of bytes copied so far.  # noqa: E501

        :return: The bytes_copied of this ArchiveRecallProgress.  # noqa: E501
        :rtype: int
        """
    ...
    def bytes_copied(self, bytes_copied):
        """Sets the bytes_copied of this ArchiveRecallProgress.

        Number of bytes copied so far.  # noqa: E501

        :param bytes_copied: The bytes_copied of this ArchiveRecallProgress.  # noqa: E501
        :type: int
        """
    ...
    def files_failed(self):
        """Gets the files_failed of this ArchiveRecallProgress.  # noqa: E501

        Number of failed files.  # noqa: E501

        :return: The files_failed of this ArchiveRecallProgress.  # noqa: E501
        :rtype: int
        """
    ...
    def files_failed(self, files_failed):
        """Sets the files_failed of this ArchiveRecallProgress.

        Number of failed files.  # noqa: E501

        :param files_failed: The files_failed of this ArchiveRecallProgress.  # noqa: E501
        :type: int
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ArchiveRecallProgress, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ArchiveRecallProgress):
            return False
