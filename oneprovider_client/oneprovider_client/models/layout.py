...
class Layout(DirSizeStatsQuery):
    ...
    def __init__(self, mode=None, *args, **kwargs):  # noqa: E501
    ...
    @property
    def mode(self):
        """Gets the mode of this Layout.  # noqa: E501

        Indicates the mode of the query. The `layout` mode returns information about the structure of stats  collection, i.e. the names of the available time series and metrics within them.   # noqa: E501

        :return: The mode of this Layout.  # noqa: E501
        :rtype: str
        """
        return self._mode
    ...
    def mode(self, mode):
        ...
        :param mode: The mode of this Layout.  # noqa: E501
        :type: str
        """
        allowed_values = ["layout"]  # noqa: E501
