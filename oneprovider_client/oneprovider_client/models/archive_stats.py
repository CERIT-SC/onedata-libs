...
class ArchiveStats(object):
    ...
    def __init__(self, files_archived=None, files_failed=None, bytes_archived=None):  # noqa: E501
        """ArchiveStats - a model defined in Swagger"""  # noqa: E501
        self._files_archived = None
        self._files_failed = None
        self._bytes_archived = None
        self.discriminator = None
        self.files_archived = files_archived
        self.files_failed = files_failed
        self.bytes_archived = bytes_archived

    @property
    def files_archived(self):
        """Gets the files_archived of this ArchiveStats.  # noqa: E501

        Counter of successfully archived files.  # noqa: E501

        :return: The files_archived of this ArchiveStats.  # noqa: E501
        :rtype: int
        """
        return self._files_archived

    @files_archived.setter
    def files_archived(self, files_archived):
        """Sets the files_archived of this ArchiveStats.

        Counter of successfully archived files.  # noqa: E501

        :param files_archived: The files_archived of this ArchiveStats.  # noqa: E501
        :type: int
        """
        if files_archived is None:
            raise ValueError("Invalid value for `files_archived`, must not be `None`")  # noqa: E501

        self._files_archived = files_archived

    @property
    def files_failed(self):
        """Gets the files_failed of this ArchiveStats.  # noqa: E501

        Counter of files for which archiving process has failed.  # noqa: E501

        :return: The files_failed of this ArchiveStats.  # noqa: E501
        :rtype: int
        """
    ...
    def files_failed(self, files_failed):
        """Sets the files_failed of this ArchiveStats.

        Counter of files for which archiving process has failed.  # noqa: E501

        :param files_failed: The files_failed of this ArchiveStats.  # noqa: E501
        :type: int
        """
    ...
    @property
    def bytes_archived(self):
        """Gets the bytes_archived of this ArchiveStats.  # noqa: E501

        Total size of already archived files in bytes.  # noqa: E501

        :return: The bytes_archived of this ArchiveStats.  # noqa: E501
        :rtype: int
        """
        return self._bytes_archived

    @bytes_archived.setter
    def bytes_archived(self, bytes_archived):
        """Sets the bytes_archived of this ArchiveStats.

        Total size of already archived files in bytes.  # noqa: E501

        :param bytes_archived: The bytes_archived of this ArchiveStats.  # noqa: E501
        :type: int
        """
        if bytes_archived is None:
            raise ValueError("Invalid value for `bytes_archived`, must not be `None`")  # noqa: E501

        self._bytes_archived = bytes_archived
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ArchiveStats, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ArchiveStats):
            return False
