...
class FileDistributionDistributionPerProvider(object):
    ...
    swagger_types = {
        'success': 'bool',
        'logical_size': 'int',
        'distribution_per_storage': 'dict(str, FileDistributionDistributionPerStorage)'
    }
    ...
    def __init__(self, success=None, logical_size=None, distribution_per_storage=None):  # noqa: E501
        """FileDistributionDistributionPerProvider - a model defined in Swagger"""  # noqa: E501
        self._success = None
        self._logical_size = None
        self._distribution_per_storage = None
        self.discriminator = None
        if success is not None:
            self.success = success
        if logical_size is not None:
            self.logical_size = logical_size
        if distribution_per_storage is not None:
            self.distribution_per_storage = distribution_per_storage

    @property
    def success(self):
        """Gets the success of this FileDistributionDistributionPerProvider.  # noqa: E501

        Indicates whether fetching file distribution for this provider was successful.  # noqa: E501

        :return: The success of this FileDistributionDistributionPerProvider.  # noqa: E501
        :rtype: bool
        """
    ...
    def success(self, success):
        """Sets the success of this FileDistributionDistributionPerProvider.

        Indicates whether fetching file distribution for this provider was successful.  # noqa: E501

        :param success: The success of this FileDistributionDistributionPerProvider.  # noqa: E501
        :type: bool
        """
    ...
    def logical_size(self):
        """Gets the logical_size of this FileDistributionDistributionPerProvider.  # noqa: E501

        Logical size of file/dir as seen by this provider (only if `success` = true).  # noqa: E501

        :return: The logical_size of this FileDistributionDistributionPerProvider.  # noqa: E501
        :rtype: int
        """
    ...
    def logical_size(self, logical_size):
        """Sets the logical_size of this FileDistributionDistributionPerProvider.

        Logical size of file/dir as seen by this provider (only if `success` = true).  # noqa: E501

        :param logical_size: The logical_size of this FileDistributionDistributionPerProvider.  # noqa: E501
        :type: int
        """
    ...
    @property
    def distribution_per_storage(self):
        """Gets the distribution_per_storage of this FileDistributionDistributionPerProvider.  # noqa: E501

        Map with file distribution per storage.   # noqa: E501

        :return: The distribution_per_storage of this FileDistributionDistributionPerProvider.  # noqa: E501
        :rtype: dict(str, FileDistributionDistributionPerStorage)
        """
        return self._distribution_per_storage

    @distribution_per_storage.setter
    def distribution_per_storage(self, distribution_per_storage):
        """Sets the distribution_per_storage of this FileDistributionDistributionPerProvider.

        Map with file distribution per storage.   # noqa: E501

        :param distribution_per_storage: The distribution_per_storage of this FileDistributionDistributionPerProvider.  # noqa: E501
        :type: dict(str, FileDistributionDistributionPerStorage)
        """

        self._distribution_per_storage = distribution_per_storage
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(FileDistributionDistributionPerProvider, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, FileDistributionDistributionPerProvider):
            return False
