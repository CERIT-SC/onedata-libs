...
class AtmWorkflowExecutionLaneRunDetailsParallelBoxes(object):
    ...
    def __init__(self, schema_id=None, task_registry=None):  # noqa: E501
        """AtmWorkflowExecutionLaneRunDetailsParallelBoxes - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def schema_id(self):
        """Gets the schema_id of this AtmWorkflowExecutionLaneRunDetailsParallelBoxes.  # noqa: E501

        Id of the parallel box schema used for this execution.  # noqa: E501

        :return: The schema_id of this AtmWorkflowExecutionLaneRunDetailsParallelBoxes.  # noqa: E501
        :rtype: str
        """
    ...
    def schema_id(self, schema_id):
        """Sets the schema_id of this AtmWorkflowExecutionLaneRunDetailsParallelBoxes.

        Id of the parallel box schema used for this execution.  # noqa: E501

        :param schema_id: The schema_id of this AtmWorkflowExecutionLaneRunDetailsParallelBoxes.  # noqa: E501
        :type: str
        """
    ...
    def task_registry(self):
        """Gets the task_registry of this AtmWorkflowExecutionLaneRunDetailsParallelBoxes.  # noqa: E501

        Map with task schema Ids (keys) and corresponding task execution Ids.   # noqa: E501

        :return: The task_registry of this AtmWorkflowExecutionLaneRunDetailsParallelBoxes.  # noqa: E501
        :rtype: dict(str, str)
        """
        return self._task_registry

    @task_registry.setter
    def task_registry(self, task_registry):
        """Sets the task_registry of this AtmWorkflowExecutionLaneRunDetailsParallelBoxes.

        Map with task schema Ids (keys) and corresponding task execution Ids.   # noqa: E501

        :param task_registry: The task_registry of this AtmWorkflowExecutionLaneRunDetailsParallelBoxes.  # noqa: E501
        :type: dict(str, str)
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AtmWorkflowExecutionLaneRunDetailsParallelBoxes, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AtmWorkflowExecutionLaneRunDetailsParallelBoxes):
            return False
