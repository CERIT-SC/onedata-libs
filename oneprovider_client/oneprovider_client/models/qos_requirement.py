...
class QosRequirement(object):
    ...
    def __init__(self, file_id=None, expression=None, replicas_num=None, status=None):  # noqa: E501
        """QosRequirement - a model defined in Swagger"""  # noqa: E501
        self._file_id = None
    ...
    @property
    def file_id(self):
        """Gets the file_id of this QosRequirement.  # noqa: E501

        Id of file that requirement was created for.  # noqa: E501

        :return: The file_id of this QosRequirement.  # noqa: E501
        :rtype: str
        """
    ...
    def file_id(self, file_id):
        """Sets the file_id of this QosRequirement.

        Id of file that requirement was created for.  # noqa: E501

        :param file_id: The file_id of this QosRequirement.  # noqa: E501
        :type: str
        """
    ...
    @property
    def expression(self):
        """Gets the expression of this QosRequirement.  # noqa: E501

        Expression used to select storages on which file should be replicated.  # noqa: E501

        :return: The expression of this QosRequirement.  # noqa: E501
        :rtype: str
        """
    ...
    def expression(self, expression):
        """Sets the expression of this QosRequirement.

        Expression used to select storages on which file should be replicated.  # noqa: E501

        :param expression: The expression of this QosRequirement.  # noqa: E501
        :type: str
        """
    ...
    def replicas_num(self):
        """Gets the replicas_num of this QosRequirement.  # noqa: E501

        Number of required file replicas.  # noqa: E501

        :return: The replicas_num of this QosRequirement.  # noqa: E501
        :rtype: int
        """
    ...
    def replicas_num(self, replicas_num):
        """Sets the replicas_num of this QosRequirement.

        Number of required file replicas.  # noqa: E501

        :param replicas_num: The replicas_num of this QosRequirement.  # noqa: E501
        :type: int
        """
    ...
    @property
    def status(self):
        """Gets the status of this QosRequirement.  # noqa: E501

        Indicates fulfillment status of QoS requirement.    # noqa: E501

        :return: The status of this QosRequirement.  # noqa: E501
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this QosRequirement.

        Indicates fulfillment status of QoS requirement.    # noqa: E501

        :param status: The status of this QosRequirement.  # noqa: E501
        :type: str
        """
        allowed_values = ["fulfilled", "pending", "impossible"]  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(QosRequirement, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, QosRequirement):
            return False
