...
class ShareCreateRequest(object):
    ...
    def __init__(self, name=None, description=None, root_file_id=None, file_id=None):  # noqa: E501
        """ShareCreateRequest - a model defined in Swagger"""  # noqa: E501
        self._name = None
    ...
    @property
    def name(self):
        """Gets the name of this ShareCreateRequest.  # noqa: E501

        The name of the share.  # noqa: E501

        :return: The name of this ShareCreateRequest.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this ShareCreateRequest.

        The name of the share.  # noqa: E501

        :param name: The name of this ShareCreateRequest.  # noqa: E501
        :type: str
        """
        if name is None:
    ...
    def description(self):
        """Gets the description of this ShareCreateRequest.  # noqa: E501

        Description of the share contents, interpreted as markdown format when displayed in GUI.  # noqa: E501

        :return: The description of this ShareCreateRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this ShareCreateRequest.

        Description of the share contents, interpreted as markdown format when displayed in GUI.  # noqa: E501

        :param description: The description of this ShareCreateRequest.  # noqa: E501
        :type: str
        """
    ...
    def root_file_id(self):
        """Gets the root_file_id of this ShareCreateRequest.  # noqa: E501

        Id of file or directory to be shared. The whole space can also be shared.  # noqa: E501

        :return: The root_file_id of this ShareCreateRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def root_file_id(self, root_file_id):
        """Sets the root_file_id of this ShareCreateRequest.

        Id of file or directory to be shared. The whole space can also be shared.  # noqa: E501

        :param root_file_id: The root_file_id of this ShareCreateRequest.  # noqa: E501
        :type: str
        """
    ...
    @property
    def file_id(self):
        """Gets the file_id of this ShareCreateRequest.  # noqa: E501

        (deprecated) Id of file or directory to be shared. The whole space can also be shared.  # noqa: E501

        :return: The file_id of this ShareCreateRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def file_id(self, file_id):
        """Sets the file_id of this ShareCreateRequest.

        (deprecated) Id of file or directory to be shared. The whole space can also be shared.  # noqa: E501

        :param file_id: The file_id of this ShareCreateRequest.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ShareCreateRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShareCreateRequest):
            return False
