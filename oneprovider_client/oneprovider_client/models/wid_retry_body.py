...
class WidRetryBody(object):
    ...
    attribute_map = {
        ...
        'lane_run_number': 'laneRunNumber'
    }

    def __init__(self, lane_index=None, lane_run_number=None):  # noqa: E501
        """WidRetryBody - a model defined in Swagger"""  # noqa: E501
        self._lane_index = None
        self._lane_run_number = None
        self.discriminator = None
        self.lane_index = lane_index
        self.lane_run_number = lane_run_number

    @property
    def lane_index(self):
        """Gets the lane_index of this WidRetryBody.  # noqa: E501

        Lane index  # noqa: E501

        :return: The lane_index of this WidRetryBody.  # noqa: E501
        :rtype: int
        """
        return self._lane_index

    @lane_index.setter
    def lane_index(self, lane_index):
        """Sets the lane_index of this WidRetryBody.

        Lane index  # noqa: E501

        :param lane_index: The lane_index of this WidRetryBody.  # noqa: E501
        :type: int
        """
        if lane_index is None:
            raise ValueError("Invalid value for `lane_index`, must not be `None`")  # noqa: E501

        self._lane_index = lane_index

    @property
    def lane_run_number(self):
        """Gets the lane_run_number of this WidRetryBody.  # noqa: E501

        Lane run `runNumber`  # noqa: E501

        :return: The lane_run_number of this WidRetryBody.  # noqa: E501
        :rtype: int
        """
        return self._lane_run_number

    @lane_run_number.setter
    def lane_run_number(self, lane_run_number):
        """Sets the lane_run_number of this WidRetryBody.

        Lane run `runNumber`  # noqa: E501

        :param lane_run_number: The lane_run_number of this WidRetryBody.  # noqa: E501
        :type: int
        """
        if lane_run_number is None:
            raise ValueError("Invalid value for `lane_run_number`, must not be `None`")  # noqa: E501

        self._lane_run_number = lane_run_number
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(WidRetryBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, WidRetryBody):
            return False
