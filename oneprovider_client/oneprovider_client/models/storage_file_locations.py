...
class StorageFileLocations(object):
    ...
    """
    swagger_types = {
        'locations_per_provider': 'dict(str, StorageFileLocationsLocationsPerProvider)'
    }

    attribute_map = {
        'locations_per_provider': 'locationsPerProvider'
    }

    def __init__(self, locations_per_provider=None):  # noqa: E501
        """StorageFileLocations - a model defined in Swagger"""  # noqa: E501
        self._locations_per_provider = None
        self.discriminator = None
        if locations_per_provider is not None:
            self.locations_per_provider = locations_per_provider

    @property
    def locations_per_provider(self):
        """Gets the locations_per_provider of this StorageFileLocations.  # noqa: E501


        :return: The locations_per_provider of this StorageFileLocations.  # noqa: E501
        :rtype: dict(str, StorageFileLocationsLocationsPerProvider)
        """
        return self._locations_per_provider

    @locations_per_provider.setter
    def locations_per_provider(self, locations_per_provider):
        """Sets the locations_per_provider of this StorageFileLocations.


        :param locations_per_provider: The locations_per_provider of this StorageFileLocations.  # noqa: E501
        :type: dict(str, StorageFileLocationsLocationsPerProvider)
        """

        self._locations_per_provider = locations_per_provider
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(StorageFileLocations, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, StorageFileLocations):
            return False
