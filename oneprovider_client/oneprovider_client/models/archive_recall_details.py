...
class ArchiveRecallDetails(object):
    ...
    swagger_types = {
        ...
        'total_byte_size': 'int',
        'last_error': 'ArchiveRecallDetailsLastError'
    }
    ...
    def __init__(self, archive_id=None, dataset_id=None, start_time=None, finish_time=None, total_file_count=None, total_byte_size=None, last_error=None):  # noqa: E501
        """ArchiveRecallDetails - a model defined in Swagger"""  # noqa: E501
        self._archive_id = None
        self._dataset_id = None
        self._start_time = None
        self._finish_time = None
        self._total_file_count = None
        self._total_byte_size = None
    ...
    @property
    def archive_id(self):
        """Gets the archive_id of this ArchiveRecallDetails.  # noqa: E501

        Id of the archive that is being recalled.  # noqa: E501

        :return: The archive_id of this ArchiveRecallDetails.  # noqa: E501
        :rtype: str
        """
    ...
    def archive_id(self, archive_id):
        """Sets the archive_id of this ArchiveRecallDetails.

        Id of the archive that is being recalled.  # noqa: E501

        :param archive_id: The archive_id of this ArchiveRecallDetails.  # noqa: E501
        :type: str
        """
    ...
    @property
    def dataset_id(self):
        """Gets the dataset_id of this ArchiveRecallDetails.  # noqa: E501

        Id of the dataset from which the archive was created.  # noqa: E501

        :return: The dataset_id of this ArchiveRecallDetails.  # noqa: E501
        :rtype: str
        """
    ...
    def dataset_id(self, dataset_id):
        """Sets the dataset_id of this ArchiveRecallDetails.

        Id of the dataset from which the archive was created.  # noqa: E501

        :param dataset_id: The dataset_id of this ArchiveRecallDetails.  # noqa: E501
        :type: str
        """
    ...
    @property
    def start_time(self):
        """Gets the start_time of this ArchiveRecallDetails.  # noqa: E501

        Timestamp in milliseconds (UNIX epoch) when the recall started (null if not started yet).  # noqa: E501

        :return: The start_time of this ArchiveRecallDetails.  # noqa: E501
        :rtype: int
        """
    ...
    def start_time(self, start_time):
        """Sets the start_time of this ArchiveRecallDetails.

        Timestamp in milliseconds (UNIX epoch) when the recall started (null if not started yet).  # noqa: E501

        :param start_time: The start_time of this ArchiveRecallDetails.  # noqa: E501
        :type: int
        """
    ...
    def finish_time(self):
        """Gets the finish_time of this ArchiveRecallDetails.  # noqa: E501

        Timestamp in milliseconds (UNIX epoch) when the recall finished (null if not finished yet).  # noqa: E501

        :return: The finish_time of this ArchiveRecallDetails.  # noqa: E501
        :rtype: int
        """
    ...
    def finish_time(self, finish_time):
        """Sets the finish_time of this ArchiveRecallDetails.

        Timestamp in milliseconds (UNIX epoch) when the recall finished (null if not finished yet).  # noqa: E501

        :param finish_time: The finish_time of this ArchiveRecallDetails.  # noqa: E501
        :type: int
        """
    ...
    def total_file_count(self):
        """Gets the total_file_count of this ArchiveRecallDetails.  # noqa: E501

        Number of files in source archive (number of files that is to be copied by recall).  # noqa: E501

        :return: The total_file_count of this ArchiveRecallDetails.  # noqa: E501
        :rtype: int
        """
    ...
    def total_file_count(self, total_file_count):
        """Sets the total_file_count of this ArchiveRecallDetails.

        Number of files in source archive (number of files that is to be copied by recall).  # noqa: E501

        :param total_file_count: The total_file_count of this ArchiveRecallDetails.  # noqa: E501
        :type: int
        """
    ...
    def total_byte_size(self):
        """Gets the total_byte_size of this ArchiveRecallDetails.  # noqa: E501

        Number of bytes in source archive (number of bytes that is to be copied by recall).  # noqa: E501

        :return: The total_byte_size of this ArchiveRecallDetails.  # noqa: E501
        :rtype: int
        """
        return self._total_byte_size

    @total_byte_size.setter
    def total_byte_size(self, total_byte_size):
        """Sets the total_byte_size of this ArchiveRecallDetails.

        Number of bytes in source archive (number of bytes that is to be copied by recall).  # noqa: E501

        :param total_byte_size: The total_byte_size of this ArchiveRecallDetails.  # noqa: E501
        :type: int
        """
        if total_byte_size is None:
            raise ValueError("Invalid value for `total_byte_size`, must not be `None`")  # noqa: E501

        self._total_byte_size = total_byte_size

    @property
    def last_error(self):
        """Gets the last_error of this ArchiveRecallDetails.  # noqa: E501


        :return: The last_error of this ArchiveRecallDetails.  # noqa: E501
        :rtype: ArchiveRecallDetailsLastError
        """
        return self._last_error

    @last_error.setter
    def last_error(self, last_error):
        """Sets the last_error of this ArchiveRecallDetails.


        :param last_error: The last_error of this ArchiveRecallDetails.  # noqa: E501
        :type: ArchiveRecallDetailsLastError
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ArchiveRecallDetails, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ArchiveRecallDetails):
            return False
