...
class StorageFileLocationsLocationsPerProvider(object):
    ...
    """
    swagger_types = {
        'locations_per_storage': 'dict(str, str)'
    }
    ...
    def __init__(self, locations_per_storage=None):  # noqa: E501
        """StorageFileLocationsLocationsPerProvider - a model defined in Swagger"""  # noqa: E501
        self._locations_per_storage = None
        self.discriminator = None
        if locations_per_storage is not None:
            self.locations_per_storage = locations_per_storage

    @property
    def locations_per_storage(self):
        """Gets the locations_per_storage of this StorageFileLocationsLocationsPerProvider.  # noqa: E501

        Map with file storage location per storage.   # noqa: E501

        :return: The locations_per_storage of this StorageFileLocationsLocationsPerProvider.  # noqa: E501
        :rtype: dict(str, str)
        """
        return self._locations_per_storage

    @locations_per_storage.setter
    def locations_per_storage(self, locations_per_storage):
        """Sets the locations_per_storage of this StorageFileLocationsLocationsPerProvider.

        Map with file storage location per storage.   # noqa: E501

        :param locations_per_storage: The locations_per_storage of this StorageFileLocationsLocationsPerProvider.  # noqa: E501
        :type: dict(str, str)
        """

        self._locations_per_storage = locations_per_storage
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(StorageFileLocationsLocationsPerProvider, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, StorageFileLocationsLocationsPerProvider):
            return False
