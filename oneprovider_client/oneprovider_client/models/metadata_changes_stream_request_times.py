...
class MetadataChangesStreamRequestTimes(object):
    ...
    def __init__(self, always=False, fields=None):  # noqa: E501
        """MetadataChangesStreamRequestTimes - a model defined in Swagger"""  # noqa: E501
        self._always = None
        self._fields = None
    ...
    @property
    def always(self):
        """Gets the always of this MetadataChangesStreamRequestTimes.  # noqa: E501

        Indicates whether specified times fields should be sent on other metadata changes.  # noqa: E501

        :return: The always of this MetadataChangesStreamRequestTimes.  # noqa: E501
        :rtype: bool
        """
        return self._always
    ...
    def always(self, always):
        """Sets the always of this MetadataChangesStreamRequestTimes.

        Indicates whether specified times fields should be sent on other metadata changes.  # noqa: E501

        :param always: The always of this MetadataChangesStreamRequestTimes.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def fields(self):
        """Gets the fields of this MetadataChangesStreamRequestTimes.  # noqa: E501


        :return: The fields of this MetadataChangesStreamRequestTimes.  # noqa: E501
        :rtype: list[str]
        """
        return self._fields
    ...
    def fields(self, fields):
        """Sets the fields of this MetadataChangesStreamRequestTimes.


        :param fields: The fields of this MetadataChangesStreamRequestTimes.  # noqa: E501
        :type: list[str]
        """
        allowed_values = ["atime", "mtime", "ctime"]  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(MetadataChangesStreamRequestTimes, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MetadataChangesStreamRequestTimes):
            return False
