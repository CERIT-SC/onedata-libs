...
class MetadataChangesStreamRequestFileLocation(object):
    ...
    def __init__(self, always=False, fields=None):  # noqa: E501
        """MetadataChangesStreamRequestFileLocation - a model defined in Swagger"""  # noqa: E501
        self._always = None
        self._fields = None
    ...
    @property
    def always(self):
        """Gets the always of this MetadataChangesStreamRequestFileLocation.  # noqa: E501

        Indicates whether specified fileLocation fields should be sent on other metadata changes.  # noqa: E501

        :return: The always of this MetadataChangesStreamRequestFileLocation.  # noqa: E501
        :rtype: bool
        """
        return self._always
    ...
    def always(self, always):
        """Sets the always of this MetadataChangesStreamRequestFileLocation.

        Indicates whether specified fileLocation fields should be sent on other metadata changes.  # noqa: E501

        :param always: The always of this MetadataChangesStreamRequestFileLocation.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def fields(self):
        """Gets the fields of this MetadataChangesStreamRequestFileLocation.  # noqa: E501


        :return: The fields of this MetadataChangesStreamRequestFileLocation.  # noqa: E501
        :rtype: list[str]
        """
        return self._fields
    ...
    def fields(self, fields):
        """Sets the fields of this MetadataChangesStreamRequestFileLocation.


        :param fields: The fields of this MetadataChangesStreamRequestFileLocation.  # noqa: E501
        :type: list[str]
        """
        allowed_values = ["provider_id", "storage_id", "size", "space_id", "storage_file_created"]  # noqa: E501
        if not set(fields).issubset(set(allowed_values)):
            raise ValueError(
                "Invalid values for `fields` [{0}], must be a subset of [{1}]"  # noqa: E501
                .format(", ".join(map(str, set(fields) - set(allowed_values))),  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(MetadataChangesStreamRequestFileLocation, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MetadataChangesStreamRequestFileLocation):
            return False
