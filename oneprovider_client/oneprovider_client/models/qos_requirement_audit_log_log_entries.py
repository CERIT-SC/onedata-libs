...
class QosRequirementAuditLogLogEntries(object):
    ...
    swagger_types = {
        'index': 'int',
        'timestamp': 'int',
        'content': 'QosRequirementAuditLogContent'
    }
    ...
    def __init__(self, index=None, timestamp=None, content=None):  # noqa: E501
        """QosRequirementAuditLogLogEntries - a model defined in Swagger"""  # noqa: E501
        self._index = None
    ...
    @property
    def index(self):
        """Gets the index of this QosRequirementAuditLogLogEntries.  # noqa: E501

        Index of this log entry, used to identify the position of this log in a series of logs.   # noqa: E501

        :return: The index of this QosRequirementAuditLogLogEntries.  # noqa: E501
        :rtype: int
        """
        return self._index
    ...
    def index(self, index):
        """Sets the index of this QosRequirementAuditLogLogEntries.

        Index of this log entry, used to identify the position of this log in a series of logs.   # noqa: E501

        :param index: The index of this QosRequirementAuditLogLogEntries.  # noqa: E501
        :type: int
        """
        if index is None:
    ...
    @property
    def timestamp(self):
        """Gets the timestamp of this QosRequirementAuditLogLogEntries.  # noqa: E501

        UNIX epoch timestamp in seconds of event described by entry.  # noqa: E501

        :return: The timestamp of this QosRequirementAuditLogLogEntries.  # noqa: E501
        :rtype: int
        """
    ...
    def timestamp(self, timestamp):
        """Sets the timestamp of this QosRequirementAuditLogLogEntries.

        UNIX epoch timestamp in seconds of event described by entry.  # noqa: E501

        :param timestamp: The timestamp of this QosRequirementAuditLogLogEntries.  # noqa: E501
        :type: int
        """
    ...
    @property
    def content(self):
        """Gets the content of this QosRequirementAuditLogLogEntries.  # noqa: E501


        :return: The content of this QosRequirementAuditLogLogEntries.  # noqa: E501
        :rtype: QosRequirementAuditLogContent
        """
        return self._content

    @content.setter
    def content(self, content):
        """Sets the content of this QosRequirementAuditLogLogEntries.


        :param content: The content of this QosRequirementAuditLogLogEntries.  # noqa: E501
        :type: QosRequirementAuditLogContent
        """
        if content is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(QosRequirementAuditLogLogEntries, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, QosRequirementAuditLogLogEntries):
            return False
