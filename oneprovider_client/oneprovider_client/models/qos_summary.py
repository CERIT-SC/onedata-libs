...
class QosSummary(object):
    ...
    def __init__(self, requirements=None, status=None):  # noqa: E501
        """QosSummary - a model defined in Swagger"""  # noqa: E501
    ...
    def requirements(self):
        """Gets the requirements of this QosSummary.  # noqa: E501

        Mapping including all QoS requirements (Ids) that influence given file/directory and corresponding  information of fulfillment status for this file/directory (fulfilled/pending/impossible).   # noqa: E501

        :return: The requirements of this QosSummary.  # noqa: E501
        :rtype: object
        """
    ...
    def requirements(self, requirements):
        """Sets the requirements of this QosSummary.

        Mapping including all QoS requirements (Ids) that influence given file/directory and corresponding  information of fulfillment status for this file/directory (fulfilled/pending/impossible).   # noqa: E501

        :param requirements: The requirements of this QosSummary.  # noqa: E501
        :type: object
        """
    ...
    @property
    def status(self):
        """Gets the status of this QosSummary.  # noqa: E501

        Aggregated status of all QoS requirements for given file or directory.     # noqa: E501

        :return: The status of this QosSummary.  # noqa: E501
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this QosSummary.

        Aggregated status of all QoS requirements for given file or directory.     # noqa: E501

        :param status: The status of this QosSummary.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, QosSummary):
            return False
