...
class QosRequirementAuditLog(object):
    ...
    swagger_types = {
        'is_last': 'bool',
        'log_entries': 'list[QosRequirementAuditLogLogEntries]'
    }
    ...
    def __init__(self, is_last=None, log_entries=None):  # noqa: E501
        """QosRequirementAuditLog - a model defined in Swagger"""  # noqa: E501
        self._is_last = None
    ...
    @property
    def is_last(self):
        """Gets the is_last of this QosRequirementAuditLog.  # noqa: E501

        Flag indicating whether last entry in audit log was listed.   # noqa: E501

        :return: The is_last of this QosRequirementAuditLog.  # noqa: E501
        :rtype: bool
        """
    ...
    def is_last(self, is_last):
        """Sets the is_last of this QosRequirementAuditLog.

        Flag indicating whether last entry in audit log was listed.   # noqa: E501

        :param is_last: The is_last of this QosRequirementAuditLog.  # noqa: E501
        :type: bool
        """
        if is_last is None:
    ...
    def log_entries(self):
        """Gets the log_entries of this QosRequirementAuditLog.  # noqa: E501


        :return: The log_entries of this QosRequirementAuditLog.  # noqa: E501
        :rtype: list[QosRequirementAuditLogLogEntries]
        """
        return self._log_entries

    @log_entries.setter
    def log_entries(self, log_entries):
        """Sets the log_entries of this QosRequirementAuditLog.


        :param log_entries: The log_entries of this QosRequirementAuditLog.  # noqa: E501
        :type: list[QosRequirementAuditLogLogEntries]
        """
        if log_entries is None:
            raise ValueError("Invalid value for `log_entries`, must not be `None`")  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(QosRequirementAuditLog, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, QosRequirementAuditLog):
            return False
