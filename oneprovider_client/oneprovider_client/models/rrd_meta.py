...
class RRDMeta(object):
    ...
    def __init__(self, start=None, end=None, step=None, legend=None):  # noqa: E501
        """RRDMeta - a model defined in Swagger"""  # noqa: E501
        self._start = None
        self._end = None
        self._step = None
        self._legend = None
    ...
    @property
    def start(self):
        """Gets the start of this RRDMeta.  # noqa: E501

        Start timestamp of the metrics.  # noqa: E501

        :return: The start of this RRDMeta.  # noqa: E501
        :rtype: float
        """
        return self._start
    ...
    def start(self, start):
        """Sets the start of this RRDMeta.

        Start timestamp of the metrics.  # noqa: E501

        :param start: The start of this RRDMeta.  # noqa: E501
        :type: float
        """
    ...
    @property
    def end(self):
        """Gets the end of this RRDMeta.  # noqa: E501

        End timestamp of the metrics.  # noqa: E501

        :return: The end of this RRDMeta.  # noqa: E501
        :rtype: float
        """
        return self._end
    ...
    @end.setter
    def end(self, end):
        """Sets the end of this RRDMeta.

        End timestamp of the metrics.  # noqa: E501

        :param end: The end of this RRDMeta.  # noqa: E501
        :type: float
        """
    ...
    @property
    def step(self):
        """Gets the step of this RRDMeta.  # noqa: E501

        Step of the metrics.  # noqa: E501

        :return: The step of this RRDMeta.  # noqa: E501
        :rtype: float
        """
        return self._step
    ...
    @step.setter
    def step(self, step):
        """Sets the step of this RRDMeta.

        Step of the metrics.  # noqa: E501

        :param step: The step of this RRDMeta.  # noqa: E501
        :type: float
        """
    ...
    @property
    def legend(self):
        """Gets the legend of this RRDMeta.  # noqa: E501

        Names of the columns in the exported array  # noqa: E501

        :return: The legend of this RRDMeta.  # noqa: E501
        :rtype: list[str]
        """
        return self._legend
    ...
    def legend(self, legend):
        """Sets the legend of this RRDMeta.

        Names of the columns in the exported array  # noqa: E501

        :param legend: The legend of this RRDMeta.  # noqa: E501
        :type: list[str]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RRDMeta):
            return False
