...
class DirSizeStatsQuery(object):
...
'slice': 'Slice'    }
    ...
    def __init__(self, mode='layout'):  # noqa: E501
        """DirSizeStatsQuery - a model defined in Swagger"""  # noqa: E501
        self._mode = None
        self.discriminator = 'mode'
        self.mode = mode

    @property
    def mode(self):
        """Gets the mode of this DirSizeStatsQuery.  # noqa: E501


        :return: The mode of this DirSizeStatsQuery.  # noqa: E501
        :rtype: str
        """
        return self._mode
    ...
    @mode.setter
    def mode(self, mode):
        """Sets the mode of this DirSizeStatsQuery.


        :param mode: The mode of this DirSizeStatsQuery.  # noqa: E501
        :type: str
        """
        if mode is None:
            raise ValueError("Invalid value for `mode`, must not be `None`")  # noqa: E501
        allowed_values = ["layout", "slice"]  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DirSizeStatsQuery, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DirSizeStatsQuery):
            return False
