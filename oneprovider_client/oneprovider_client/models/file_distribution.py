...
class FileDistribution(object):
    ...
    swagger_types = {
        'type': 'FileType',
        'distribution_per_provider': 'dict(str, FileDistributionDistributionPerProvider)'
    }
    ...
    def __init__(self, type=None, distribution_per_provider=None):  # noqa: E501
        """FileDistribution - a model defined in Swagger"""  # noqa: E501
        self._type = None
        self._distribution_per_provider = None
        self.discriminator = None
        if type is not None:
            self.type = type
        if distribution_per_provider is not None:
            self.distribution_per_provider = distribution_per_provider

    @property
    def type(self):
        """Gets the type of this FileDistribution.  # noqa: E501


        :return: The type of this FileDistribution.  # noqa: E501
        :rtype: FileType
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this FileDistribution.


        :param type: The type of this FileDistribution.  # noqa: E501
        :type: FileType
        """
    ...
    @property
    def distribution_per_provider(self):
        """Gets the distribution_per_provider of this FileDistribution.  # noqa: E501


        :return: The distribution_per_provider of this FileDistribution.  # noqa: E501
        :rtype: dict(str, FileDistributionDistributionPerProvider)
        """
        return self._distribution_per_provider

    @distribution_per_provider.setter
    def distribution_per_provider(self, distribution_per_provider):
        """Sets the distribution_per_provider of this FileDistribution.


        :param distribution_per_provider: The distribution_per_provider of this FileDistribution.  # noqa: E501
        :type: dict(str, FileDistributionDistributionPerProvider)
        """

        self._distribution_per_provider = distribution_per_provider
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(FileDistribution, dict):
