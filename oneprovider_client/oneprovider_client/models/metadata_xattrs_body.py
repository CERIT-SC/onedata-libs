...
class MetadataXattrsBody(object):
    ...
    def __init__(self, keys=None):  # noqa: E501
        """MetadataXattrsBody - a model defined in Swagger"""  # noqa: E501
        self._keys = None
    ...
    @property
    def keys(self):
        """Gets the keys of this MetadataXattrsBody.  # noqa: E501

        List of xattrs to remove.  # noqa: E501

        :return: The keys of this MetadataXattrsBody.  # noqa: E501
        :rtype: list[str]
        """
        return self._keys
    ...
    @keys.setter
    def keys(self, keys):
        """Sets the keys of this MetadataXattrsBody.

        List of xattrs to remove.  # noqa: E501

        :param keys: The keys of this MetadataXattrsBody.  # noqa: E501
        :type: list[str]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(MetadataXattrsBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MetadataXattrsBody):
            return False
