...
class FileDistributionDistributionPerStorage(object):
    ...
    def __init__(self, blocks=None, physical_size=None, error=None):  # noqa: E501
        """FileDistributionDistributionPerStorage - a model defined in Swagger"""  # noqa: E501
        self._blocks = None
    ...
    @property
    def blocks(self):
        """Gets the blocks of this FileDistributionDistributionPerStorage.  # noqa: E501

        A list of blocks in byte ranges stored on this storage (only for REG file type and `success` = true).   # noqa: E501

        :return: The blocks of this FileDistributionDistributionPerStorage.  # noqa: E501
        :rtype: list[list[int]]
        """
        return self._blocks
    ...
    def blocks(self, blocks):
        """Sets the blocks of this FileDistributionDistributionPerStorage.

        A list of blocks in byte ranges stored on this storage (only for REG file type and `success` = true).   # noqa: E501

        :param blocks: The blocks of this FileDistributionDistributionPerStorage.  # noqa: E501
        :type: list[list[int]]
        """
    ...
    def physical_size(self):
        """Gets the physical_size of this FileDistributionDistributionPerStorage.  # noqa: E501

        Physical size of the file on this storage (only when `success` = true).  # noqa: E501

        :return: The physical_size of this FileDistributionDistributionPerStorage.  # noqa: E501
        :rtype: int
        """
    ...
    def physical_size(self, physical_size):
        """Sets the physical_size of this FileDistributionDistributionPerStorage.

        Physical size of the file on this storage (only when `success` = true).  # noqa: E501

        :param physical_size: The physical_size of this FileDistributionDistributionPerStorage.  # noqa: E501
        :type: int
        """
    ...
    @property
    def error(self):
        """Gets the error of this FileDistributionDistributionPerStorage.  # noqa: E501


        :return: The error of this FileDistributionDistributionPerStorage.  # noqa: E501
        :rtype: FileDistributionError
        """
        return self._error

    @error.setter
    def error(self, error):
        """Sets the error of this FileDistributionDistributionPerStorage.


        :param error: The error of this FileDistributionDistributionPerStorage.  # noqa: E501
        :type: FileDistributionError
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(FileDistributionDistributionPerStorage, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, FileDistributionDistributionPerStorage):
            return False
