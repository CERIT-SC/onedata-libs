...
from oneprovider_client.api.miscellaneous_api import MiscellaneousApi  # noqa: E501
...
class TestMiscellaneousApi(unittest.TestCase):
    ...
    def test_get_directory_size_stats(self):
        """Test case for get_directory_size_stats
