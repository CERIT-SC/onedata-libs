...
from oneprovider_client.api.archive_api import ArchiveApi  # noqa: E501
...
class TestArchiveApi(unittest.TestCase):
    ...
    def test_cancel_archive_recall(self):
        """Test case for cancel_archive_recall
    ...
    def test_get_archive_recall_details(self):
        """Test case for get_archive_recall_details

        Get details of an archive recall  # noqa: E501
        """
        pass

    def test_get_archive_recall_progress(self):
        """Test case for get_archive_recall_progress

        Get progress of an archive recall  # noqa: E501
        """
        pass

    def test_list_dataset_archives(self):
        """Test case for list_dataset_archives

        List archives of a dataset  # noqa: E501
        """
        pass

    def test_recall_archive(self):
        """Test case for recall_archive
