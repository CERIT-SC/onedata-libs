...
from oneprovider_client.api.transfer_api import TransferApi  # noqa: E501
...
class TestTransferApi(unittest.TestCase):
    ...
    def test_get_transfer_status(self):
        """Test case for get_transfer_status

        Get transfer status  # noqa: E501
        """
        pass

    def test_rerun_transfer(self):
        """Test case for rerun_transfer
